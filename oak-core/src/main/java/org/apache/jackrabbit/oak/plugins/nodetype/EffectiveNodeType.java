...
throw|;
block|}
comment|/**      *      * @param propertyName The internal oak name of the property.      * @param isMultiple      * @param type      * @param exactTypeMatch      * @return      * @throws ConstraintViolationException      */
specifier|public
name|PropertyDefinition
