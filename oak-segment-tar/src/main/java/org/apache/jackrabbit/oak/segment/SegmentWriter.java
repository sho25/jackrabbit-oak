...
return|;
block|}
comment|/**      * Write a node state, unless cancelled using a dedicated write operation handler      * @param state   node state to write      * @param writeOperationHandler  the write operation handler through which all write calls      *                               induced by by this call are routed.      * @param cancel  supplier to signal cancellation of this write operation      * @return segment node state equal to {@code state} or {@code null} if cancelled.      * @throws IOException      */
annotation|@
name|CheckForNull
specifier|public
name|SegmentNodeState
