...
return|;
block|}
comment|/**      * Creates a proxy ServletContext which delegates the resource loading to Spring Resource support      * Without this default embedded server ServletContext based resource loading was failing      */
specifier|private
name|ServletContext
name|getServletContext
parameter_list|()
