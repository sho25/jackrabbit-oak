...
block|}
block|}
comment|/**      * FileLineDifferenceIterator class which iterates over the difference of 2 files line by line.      *      * If there is a scope for lines in files containing line break characters it should be      * ensured that both the file are written with      * {@link #writeAsLine(BufferedWriter, String, boolean)} with true to escape line break      * characters.      */
specifier|public
specifier|static
class|class
