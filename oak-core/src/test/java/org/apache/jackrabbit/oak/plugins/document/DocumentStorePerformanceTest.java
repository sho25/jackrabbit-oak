...
specifier|public
name|void
name|testConcurrentUpdatePerf1DS
parameter_list|()
throws|throws
...
argument_list|()
operator|+
literal|".testConcurrentUpdatePerf1DS"
decl_stmt|;
name|concurrentUpdatePerf
argument_list|(
name|id
argument_list|,
literal|1
...
specifier|public
name|void
name|testConcurrentUpdatePerf2DS
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
condition|)
block|{                 }
comment|// operation that requires fetching the previous state
name|UpdateOp
name|up
init|=
operator|new
...
literal|0
decl_stmt|;
comment|// operation that does not require fetching the previous state
name|UpdateOp
name|up
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// reading uncached because for some reason MongoDS doesn't see the
comment|// changes made in ds2
name|NodeDocument
name|nd
init|=
name|ds1
...
name|format
argument_list|(
literal|"Concurrent updates %s on %s cond. updates: %d (failures: %s), uncond. updates: %d (failures: %s), _modCount: %d, ops/sec: %d, %% of cond. updates: %d"
argument_list|,
name|stores
operator|==
literal|1
