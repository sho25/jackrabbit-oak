...
return|;
block|}
comment|// remember userID as we need this so often
specifier|final
name|String
name|userId
init|=
...
argument_list|)
expr_stmt|;
comment|// if there exists an authorizable with the given userid but is not an external one or if it belongs to
comment|// another IDP, we just ignore it.
if|if
condition|(
name|sId
operator|!=
