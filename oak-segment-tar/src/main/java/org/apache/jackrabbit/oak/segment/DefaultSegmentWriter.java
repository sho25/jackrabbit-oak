...
argument_list|)
decl_stmt|;
comment|/**      * Default threshold of the number of modified child nodes of a node after which to      * log a warning.      */
specifier|public
specifier|static
specifier|final
name|int
name|CHILD_NODE_COUNT_WARN_THRESHOLD_DEFAULT
init|=
literal|1000000
decl_stmt|;
comment|/**      * Threshold of the number of modified child nodes of a node after which to log      * a warning.      */
specifier|private
specifier|static
specifier|final
name|int
name|CHILD_NODE_COUNT_WARN_THRESHOLD
init|=
name|getInteger
argument_list|(
literal|"oak.segment.childNodeCountWarnThreshold"
argument_list|,
name|CHILD_NODE_COUNT_WARN_THRESHOLD_DEFAULT
argument_list|)
decl_stmt|;
...
specifier|private
name|int
name|childNodeCountWarnThreshold
init|=
name|CHILD_NODE_COUNT_WARN_THRESHOLD
decl_stmt|;
name|SegmentWriteOperation
...
name|warn
argument_list|(
literal|"Large number of modified child nodes: {} @ {}"
argument_list|,
name|map
operator|.
name|size
