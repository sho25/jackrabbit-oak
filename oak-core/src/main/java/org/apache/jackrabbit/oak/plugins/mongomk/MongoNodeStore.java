...
argument_list|)
argument_list|,
literal|"MongoNodeStore background thread"
argument_list|)
expr_stmt|;
name|backgroundThread
operator|.
...
name|info
argument_list|(
literal|"Initialized MongoNodeStore with clusterNodeId: {}"
argument_list|,
name|clusterId
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Disposed MongoNodeStore with clusterNodeId: {}"
argument_list|,
name|clusterId
argument_list|)
expr_stmt|;
