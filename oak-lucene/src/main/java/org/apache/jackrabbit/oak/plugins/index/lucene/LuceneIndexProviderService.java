...
specifier|final
name|int
name|LUCENE_INDEX_STATS_UPDATE_INTERVAL_DEFAULT
init|=
literal|300
decl_stmt|;
annotation|@
...
name|label
operator|=
literal|"Lucene index stats update interval (seconds)"
argument_list|,
name|description
operator|=
literal|"Delay in seconds after which Lucene stats are updated in async index update cycle."
argument_list|)
specifier|private
specifier|static
specifier|final
name|String
name|LUCENE_INDEX_STATS_UPDATE_INTERVAL
init|=
literal|"luceneIndexStatsUpdateInterval"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
specifier|final
name|long
name|PROP_INDEX_FILESYSTEM_STATS_INTERVAL_DEFAULT
init|=
literal|300
decl_stmt|;
annotation|@
...
name|label
operator|=
literal|"Lucene Index File System Stats Interval (seconds)"
argument_list|,
name|description
operator|=
literal|"Interval (in seconds) for calculation of File System metrics for Lucene Index such as Local Index Directory Size"
argument_list|)
specifier|private
specifier|static
specifier|final
name|String
name|PROP_INDEX_FILESYSTEM_STATS_INTERVAL
init|=
literal|"propIndexFSStatsIntervalInSecs"
decl_stmt|;
specifier|private
specifier|final
name|Clock
...
argument_list|)
expr_stmt|;
comment|// convert seconds to millis
name|boolean
name|disabled
init|=
name|PropertiesUtil
...
argument_list|)
decl_stmt|;
name|registerLuceneFileSystemStats
argument_list|(
name|luceneIndexFSStats
argument_list|,
name|PropertiesUtil
...
name|info
argument_list|(
literal|"Lucene FileSystem Statistics calculator configured to run every [{}] seconds"
argument_list|,
name|delayInSeconds
argument_list|)
expr_stmt|;
