...
specifier|public
name|void
name|testRepSimilarWithBinaryFeatureVectors
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResource
argument_list|(
literal|"/org/apache/jackrabbit/oak/query/fvs.csv"
argument_list|)
operator|.
name|toURI
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// check that similarity changes across different feature vectors
name|List
argument_list|<
name|String
argument_list|>
...
name|query
init|=
literal|"select [jcr:path] from [nt:base] where similar(., '"
operator|+
name|similarPath
operator|+
literal|"')"
...
specifier|public
name|void
name|testRepSimilarWithStringFeatureVectors
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testRepSimilarWithBinaryFeatureVectorsAndRerank
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testRepSimilarWithStringFeatureVectorsAndRerank
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|injectRandomSeedDuringReindex
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Push a change to get another indexing cycle run
name|root
operator|.
name|getTree
argument_list|(
...
specifier|public
name|void
name|injectRandomSeedDuringRefresh
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"Random seed not updated"
argument_list|,
name|seed
argument_list|,
name|defSeed
...
specifier|public
name|void
name|injectRandomSeedDuringUpdate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertNotEquals
argument_list|(
literal|"Random seed updated to garbage"
argument_list|,
literal|"garbage"
argument_list|,
name|defSeed
...
name|assertEquals
argument_list|(
literal|"Random seed udpated to garbage"
argument_list|,
operator|-
literal|12312
argument_list|,
...
specifier|public
name|void
name|pathTransformationWithWildcardInRelativePathFragment
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//a document which doesn't have 2 levels above the property
name|rootTree
operator|.
name|addChild
argument_list|(
...
expr_stmt|;
comment|// XPaths
name|assertPlanAndQueryXPath
argument_list|(
literal|"//*[j:c/*/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
argument_list|(
literal|"/a"
...
name|assertPlanAndQuery
argument_list|(
literal|"SELECT * FROM [nt:base] WHERE [j:c/*/foo] = 'bar'"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQuery
argument_list|(
literal|"SELECT * FROM [nt:base] WHERE [e/j:c/*/foo] = 'bar'"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQuery
argument_list|(
literal|"SELECT * FROM [nt:base] WHERE [*/foo1/foo] = 'bar'"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQuery
argument_list|(
literal|"SELECT * FROM [nt:base] WHERE [*/*/foo3/foo] = 'bar'"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
specifier|public
name|void
name|pathTransformationWithEvaluatePathRestriction
parameter_list|()
throws|throws
name|Exception
block|{
comment|// This test might feel redundant in presence of LuceneIndexPathRestrictionTest, BUT, this test
comment|// gets result via query engine so the results is exactly correct. While in LuceneIndexPathRestrictionTest
comment|// we're interested in how many constraint could the index resolve.. so those results would be super-set of
comment|// what we see here
name|IndexDefinitionBuilder
name|idxBuilder
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// any descendant
name|assertPlanAndQueryXPath
argument_list|(
literal|"/jcr:root/test//*[j:c/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQueryXPath
argument_list|(
literal|"/jcr:root/test//*[d/*/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQueryXPath
argument_list|(
literal|"/jcr:root/test/a[j:c/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQueryXPath
argument_list|(
literal|"/jcr:root/test/a[*/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
...
name|assertPlanAndQueryXPath
argument_list|(
literal|"/jcr:root/test/c[d/*/@foo = 'bar']"
argument_list|,
literal|"lucene:fooIndex(/oak:index/fooIndex)"
argument_list|,
name|asList
