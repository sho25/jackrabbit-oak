...
condition|)
block|{
comment|// either clusterId does not match
comment|// or range is newer than read revision
continue|continue;
block|}
comment|// check if it overlaps with previous ranges
if|if
condition|(
name|range
operator|.
...
condition|)
block|{
comment|// there are previous ranges
comment|// get and merge sort overlapping ranges
name|revs
operator|.
name|add
argument_list|(
...
argument_list|()
decl_stmt|;
comment|// check if this even has elements
if|if
condition|(
name|next
operator|.
