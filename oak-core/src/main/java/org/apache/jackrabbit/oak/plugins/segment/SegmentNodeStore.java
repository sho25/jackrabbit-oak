...
name|head
decl_stmt|;
comment|/**      * Whether a thread is currently processing a local commit.      */
specifier|private
name|boolean
name|inLocalCommit
init|=
literal|false
decl_stmt|;
comment|/**      * Number of threads waiting to make a local commit.      * Used to avoid extra {@link #notifyAll()} calls when nobody is waiting.      */
specifier|private
name|long
name|waitingToCommit
init|=
literal|0
decl_stmt|;
specifier|private
