...
specifier|public
name|void
name|statisticalFacetsWithHitCountLessThanSampleSize
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Since the hit count is less than sample size -> flow should have switched to secure facet count instead of statistical
comment|// and thus the count should be exactly equal
name|assertEquals
argument_list|(
name|actualAclLabelCount
argument_list|,
