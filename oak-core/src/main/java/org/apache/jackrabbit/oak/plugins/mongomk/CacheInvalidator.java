...
operator|++
expr_stmt|;
comment|//Note that this is a partial document
name|NodeDocument
name|latestDoc
init|=
name|documentStore
...
return|;
block|}
comment|//TODO This is a brute force check. Check if we need to compare for rev which are
comment|// visible to current cluster node only etc
return|return
name|Objects
operator|.
name|equal
