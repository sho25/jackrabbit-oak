...
block|}
block|}
comment|/**      * Creates and returns a MarkSweepGarbageCollector if the current BlobStore      * supports garbage collection      *      * @param blobStore the blobStore used by DocumentNodeStore      *      * @return garbage collector of the BlobStore supports GC otherwise null      */
annotation|@
name|Nullable
specifier|private
name|MarkSweepGarbageCollector
