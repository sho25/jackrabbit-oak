...
block|}
block|}
comment|// TODO: move to user related oak-spi that is used both by JCR usermanagement
comment|// and oak-level functionality.
specifier|private
specifier|static
name|String
name|getUserPath
...
name|statement
init|=
literal|"SELECT * FROM [rep:User] WHERE [jcr:uuid] = $id"
decl_stmt|;
name|Result
name|result
init|=
