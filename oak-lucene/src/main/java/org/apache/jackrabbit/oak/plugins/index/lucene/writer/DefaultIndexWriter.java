...
decl_stmt|;
name|boolean
name|isPropertyRegexMatchingEnabled
init|=
name|definition
operator|.
...
block|{
comment|// if the new document only contains path field, we don't add it to index. Instead we delete existing
comment|// document of the same path.
if|if
condition|(
name|containsOnlyPath
operator|&&
