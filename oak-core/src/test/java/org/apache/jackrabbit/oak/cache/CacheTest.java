...
name|test
argument_list|,
literal|"mem: 4 stack: 1 5 4 3 cold: 2 non-resident: 5"
argument_list|)
expr_stmt|;
name|assertFalse
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 18 is a non-resident entry, so should become hot
name|test
operator|.
name|put
argument_list|(
...
name|test
argument_list|,
literal|"mem: 4 stack: 18 19 17 16 3 2 cold: 1 non-resident: 19 17 16"
argument_list|)
expr_stmt|;
comment|// 28 was never seen before, so should become cold
name|test
operator|.
name|put
argument_list|(
...
name|test
argument_list|,
literal|"mem: 4 stack: 28 18 19 3 2 cold: 28 non-resident: 1 19"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|assertEquals
argument_list|(
literal|"Callback hasn't been called for "
operator|+
name|key
argument_list|,
name|RemovalCause
...
specifier|public
name|void
name|evictionCallbackRandomized
parameter_list|()
throws|throws
name|ExecutionException
block|{
...
condition|)
block|{
comment|// the same key was inserted just now
block|}
else|else
block|{
name|assertFalse
