...
name|StringReader
argument_list|(
literal|"<test = 'http://jackrabbit.apache.org/ns/test'>\n"
operator|+
literal|"[test:Versionable]> nt:unstructured, mix:versionable"
argument_list|)
argument_list|,
name|session
argument_list|)
