...
begin_comment
comment|/**  * Timing tests for {@link PerfLogger} using {@code Thread.sleep} because  * virtual clock requires currentTimeMillis (OAK-3877)  */
end_comment
...
specifier|public
name|void
name|logAtInfoInfoTimeoutNotHit
parameter_list|()
throws|throws
name|InterruptedException
block|{
