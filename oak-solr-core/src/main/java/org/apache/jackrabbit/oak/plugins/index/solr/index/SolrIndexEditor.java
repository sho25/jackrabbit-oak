...
block|{
comment|//        switch (tag) {
comment|//            case PropertyType.LONG:
comment|//                return s+"_long_sort";
comment|//            case PropertyType.DATE:
comment|//                return s+"_date_sort";
comment|//            case PropertyType.DOUBLE:
comment|//                return s+"_double_sort";
comment|//            case PropertyType.STRING:
comment|//                return s+"_string_sort";
comment|//            default:
return|return
name|s
operator|+
