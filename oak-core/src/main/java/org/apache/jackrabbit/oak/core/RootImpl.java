...
function_decl|;
block|}
comment|/**      * New instance bases on a given {@link NodeStore} and a workspace      * @param store  node store      * @param workspaceName  name of the workspace      * @param accessControlContext      * TODO: add support for multiple workspaces. See OAK-118      */
annotation|@
...
argument_list|)
expr_stmt|;
comment|// TODO: define how permissions are bound to the current branch
name|permissions
operator|=
name|accessControlContext
operator|.
