...
decl_stmt|;
comment|/**      * Optional conflict revisions list.      */
specifier|private
specifier|final
name|Set
argument_list|<
...
decl_stmt|;
comment|/**      * @param message the exception / conflict message.      * @param conflictRevision the conflict revision      */
name|ConflictException
parameter_list|(
annotation|@
name|Nonnull
...
expr_stmt|;
block|}
comment|/**      * @param message the exception / conflict message.      * @param conflictRevisions the conflict revision list      */
name|ConflictException
parameter_list|(
annotation|@
name|Nonnull
...
expr_stmt|;
block|}
comment|/**      * @param message the exception / conflict message.      */
name|ConflictException
parameter_list|(
annotation|@
name|Nonnull
