...
name|accepts
argument_list|(
literal|"queryMaxCount"
argument_list|,
literal|"Max number of query results."
argument_list|)
operator|.
name|withOptionalArg
argument_list|()
...
name|accepts
argument_list|(
literal|"declaredMembership"
argument_list|,
literal|"Only look for declared membership."
argument_list|)
operator|.
name|withOptionalArg
argument_list|()
...
name|accepts
argument_list|(
literal|"entriesForEachPrincipal"
argument_list|,
literal|"Create ACEs for each principal (vs rotating)."
argument_list|)
operator|.
name|withOptionalArg
argument_list|()
...
name|accepts
argument_list|(
literal|"compositionType"
argument_list|,
literal|"Defines composition type for benchmarks with multiple authorization models."
argument_list|)
operator|.
name|withOptionalArg
argument_list|()
...
name|accepts
argument_list|(
literal|"useAggregationFilter"
argument_list|,
literal|"Run principal-based tests with 'AggregationFilter'"
argument_list|)
operator|.
name|withOptionalArg
argument_list|()
