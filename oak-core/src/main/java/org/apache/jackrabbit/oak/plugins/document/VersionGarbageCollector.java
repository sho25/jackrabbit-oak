...
argument_list|()
expr_stmt|;
name|createSettingDocIfNotExist
argument_list|()
expr_stmt|;
block|}
specifier|public
...
name|collectDeletedDocs
operator|+
literal|", timeToCheckDeletedDocs="
operator|+
name|checkDeletedDocs
operator|+
...
name|info
argument_list|(
literal|"Starting revision garbage collection. Revisions older than [{}] and newer than [{}] will be removed"
argument_list|,
name|Utils
operator|.
