...
argument_list|)
expr_stmt|;
comment|/*         now try to import the 'g' group that has a circular group membership references.         expected:         - group is imported         - circular membership is not spotted due to best-effort optimization         - circular membership is spotted upon resolution of members         */
name|doImport
argument_list|(
name|getTargetPath
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// circular membership created during import -> must be spotted upon member-access
name|assertEquals
argument_list|(
literal|1
argument_list|,
