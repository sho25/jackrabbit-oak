...
name|cloneBinaries
decl_stmt|;
comment|/**      * In the case of large inlined binaries, compaction will verify if all      * referenced segments exist in order to determine if a full clone is      * necessary, or just a shallow copy of the RecordId list is enough      * (Used in Backup scenario)      */
specifier|private
name|boolean
