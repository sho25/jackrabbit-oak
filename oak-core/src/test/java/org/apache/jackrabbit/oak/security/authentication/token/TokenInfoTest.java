...
specifier|public
name|void
name|testMatchesCredentialsWithUnsupportedToken
parameter_list|()
block|{
name|TokenInfo
name|info
...
specifier|public
name|void
name|testRemoveTokenTreeRemoved
parameter_list|()
block|{
name|TokenInfo
name|info
...
argument_list|()
expr_stmt|;
comment|// resetting expiration on a token tree that no longer exists should not success
name|assertFalse
argument_list|(
name|info
operator|.
...
specifier|public
name|void
name|testResetTokenTreeRemoved
parameter_list|()
block|{
name|TokenInfo
name|info
