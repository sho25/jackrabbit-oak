...
parameter_list|)
function_decl|;
comment|/**      * Returns the boolean value of the named property. The implementation      * is equivalent to the following code, but may be optimized.      *<pre>      * {@code      * PropertyState property = builder.getProperty(name);      * return property != null      *&& property.getType() == Type.BOOLEAN      *&& property.getValue(Type.BOOLEAN);      * }      *</pre>      *      * @param name property name      * @return boolean value of the named property, or {@code false}      */
name|boolean
name|getBoolean
parameter_list|(
annotation|@
