...
block|}
comment|//    @Test
comment|//    public void testCanHandleItemBasedSystemUserPrincipalSupportedPath() {
comment|//        Principal principal = new TestPrincipal("name", PathUtils.concat(supportedPath, "oak:path/to/oak:principal"));
comment|//        assertTrue(filter.canHandle(Collections.singleton(principal)));
comment|//    }
annotation|@
name|Test
specifier|public
