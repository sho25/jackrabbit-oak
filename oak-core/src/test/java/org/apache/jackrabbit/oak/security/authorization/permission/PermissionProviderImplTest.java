...
specifier|public
name|void
name|testTreePermissionsForReadPaths
parameter_list|()
block|{
name|Root
name|r
...
specifier|public
name|void
name|testIsGrantedPathForReadPaths
parameter_list|()
block|{
for|for
control|(
...
specifier|public
name|void
name|testIsGrantedTreeForReadPaths
parameter_list|()
block|{
for|for
control|(
...
argument_list|)
expr_stmt|;
comment|// parent is not readable
name|location
operator|=
name|TreeLocation
operator|.
...
specifier|public
name|void
name|testAdministrativePrincipalSet
parameter_list|()
block|{
name|PermissionProviderImpl
name|pp
