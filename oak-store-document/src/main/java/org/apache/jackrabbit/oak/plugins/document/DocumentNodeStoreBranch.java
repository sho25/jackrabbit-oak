...
condition|)
block|{
comment|// the branch state transitioned to persisted while
comment|// processing the commit hook and then failed.
comment|// remember the persisted branch state
name|BranchState
name|currentState
init|=
name|branchState
decl_stmt|;
comment|// reset branch state back to in-memory
name|branchState
operator|=
name|this
expr_stmt|;
comment|// reset the entire persisted branch state
name|reset
argument_list|(
name|currentState
operator|.
...
block|}
block|}
comment|/**          * Reset the entire persisted branch.          *          * @param p the persisted branch.          */
specifier|private
name|void
name|reset
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// get the branch that belongs to this persisted branch state
name|Branch
name|b
init|=
name|store
...
name|warn
argument_list|(
literal|"Resetting persisted branch failed"
argument_list|,
name|e
argument_list|)
expr_stmt|;
