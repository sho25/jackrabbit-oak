...
block|}
block|}
comment|/**      * eventually update suggest dictionary      * @throws IOException if suggest dictionary update fails      * @param analyzer the analyzer used to update the suggester      * @return {@link Calendar} object representing the lastUpdated value written by suggestions      */
specifier|private
name|Calendar
name|updateSuggester
parameter_list|(
