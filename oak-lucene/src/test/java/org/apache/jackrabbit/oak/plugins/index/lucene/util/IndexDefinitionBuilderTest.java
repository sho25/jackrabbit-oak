...
specifier|public
name|void
name|unnamedPropertyRuleInExistingIndex
parameter_list|()
block|{
comment|// create an initial index with property rule for "foo"
name|builder
operator|.
name|indexRule
argument_list|(
...
literal|"foo"
argument_list|)
comment|//  remove "name" property explicitly
operator|.
name|getBuilderTree
argument_list|()
operator|.
...
argument_list|()
decl_stmt|;
comment|// Use initial index def to add some other property rule - this should work
operator|new
name|IndexDefinitionBuilder
argument_list|(
name|initialIndexState
