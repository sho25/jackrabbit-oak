...
name|target
decl_stmt|;
comment|/**      * the set of oak built-in nodetypes      * todo: load from file or from repo      */
specifier|private
specifier|static
specifier|final
name|Set
...
block|}
block|}
comment|/**      * Copies the registered namespaces to the target repository, and returns      * the internal namespace index mapping used in bundle serialization.      *      * @param root root builder      * @return index to prefix mapping      * @throws RepositoryException      */
specifier|private
name|Map
argument_list|<
name|Integer
...
name|info
argument_list|(
literal|"skipping built-on nodetype: {}"
argument_list|,
name|name
argument_list|)
expr_stmt|;
