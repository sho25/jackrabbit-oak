...
expr_stmt|;
block|}
comment|/**      * Set the property to the given String value.      *      * @param property the property name      * @param value the value      */
specifier|public
name|void
name|set
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Checks if the property or map entry is equal to the given value.      *      * @param property the name of the property or map.      * @param revision the revision within the map or {@code null} if this check      *                 is for a property.      * @param value the value to compare to.      */
name|void
name|equals
parameter_list|(
annotation|@
