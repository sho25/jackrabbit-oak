...
literal|false
decl_stmt|;
comment|// FIXME filter.getNoInternal(); once JCR-3759 is resolved
name|List
argument_list|<
name|String
argument_list|>
...
block|}
comment|//------------------------------------------------------------< private>---
comment|/**      * Create a new permission provider instance for the current revision of the      * {@code Root} associated with the {@code sessionDelegate}.      *      * @return a new permission provider.      */
specifier|private
name|PermissionProvider
name|createPermissionProvider
parameter_list|()
