...
init|=
literal|"refresh-interval"
decl_stmt|;
comment|/**      * Name of the session attribute value determining works space name.      */
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
comment|/**      * Default value for {@link #REFRESH_INTERVAL}.      */
specifier|private
specifier|static
specifier|final
name|long
...
return|;
block|}
comment|// TODO make this method available through JackrabbitRepository. See OAK-803, JCR-3634
specifier|public
name|Session
name|login
parameter_list|(
...
name|REFRESH_INTERVAL
operator|+
literal|". Expected long. Defaulting to '"
operator|+
name|DEFAULT_REFRESH_INTERVAL
operator|+
literal|"' seconds ."
