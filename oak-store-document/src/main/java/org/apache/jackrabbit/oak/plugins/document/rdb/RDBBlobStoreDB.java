...
block|{
return|return
literal|"Default server collation is: '"
operator|+
name|collation
operator|+
literal|"'. There's a risk of performance degradation; see https://issues.apache.org/jira/browse/OAK-8908 for more information."
return|;
block|}
else|else
block|{
