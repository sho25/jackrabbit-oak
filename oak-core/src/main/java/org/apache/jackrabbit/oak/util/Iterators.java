...
return|;
block|}
comment|/**      * Spools the values of an iterator into a list.      * @param values  the values to spool      * @param list  the target list to receive the values      * @param<T>      * @return  {@code list}      */
annotation|@
name|Nonnull
specifier|public
specifier|static
