...
name|clusterId
expr_stmt|;
comment|// ensure the MK can be garbage collected
specifier|final
name|WeakReference
argument_list|<
name|MongoMK
...
argument_list|)
expr_stmt|;
comment|//TODO Would cause issue with large number of children. Need to be
comment|//relooked
name|Node
operator|.
name|Children
...
control|)
block|{
comment|//TODO What if multiple revisions are there?. Should we sort them and then
