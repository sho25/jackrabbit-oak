...
specifier|public
name|void
name|testSyncUserDisableMissingEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSyncGroupDisableMissingEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// mark a regular repo group as external user from the test IDP
name|Group
name|gr
init|=
name|userManager
...
specifier|public
name|void
name|testCreateUserWithApplyRFC7613
parameter_list|()
throws|throws
name|Exception
block|{
