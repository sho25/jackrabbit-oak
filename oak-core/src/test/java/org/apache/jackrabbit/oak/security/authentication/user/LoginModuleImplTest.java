...
argument_list|)
expr_stmt|;
comment|// verify subject has been updated with test-user principals
name|Set
argument_list|<
name|Principal
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// verify logout only removes credentials/principals associated with this very login module
name|assertTrue
argument_list|(
name|lm
operator|.
...
specifier|public
name|void
name|testLoginWithReadOnlySubject
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testLoginLogoutPreexistingReadonlySubject
parameter_list|()
throws|throws
name|Exception
block|{
...
name|forLogger
argument_list|(
literal|"org.apache.jackrabbit.oak.core.ContentSessionImpl"
argument_list|)
operator|.
name|enable
argument_list|(
...
block|{
comment|//verify that ContentSessionImpl.close() did not log anything
name|assertEquals
argument_list|(
literal|0
argument_list|,
