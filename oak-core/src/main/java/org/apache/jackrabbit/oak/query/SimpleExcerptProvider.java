...
specifier|final
name|boolean
name|CASE_SENSITIVE_HIGHLIGHT
init|=
name|Boolean
operator|.
name|getBoolean
argument_list|(
literal|"oak.query.caseSensitiveHighlight"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
parameter_list|)
block|{
comment|// This is not very efficient, specially as we create the pattern each time.
comment|// An alternative is to use apache commons lang StringUtils.indexOfIgnoreCase,
comment|// but that would require a new dependency
name|String
name|quotedSearchStr
init|=
name|Pattern
operator|.
name|quote
