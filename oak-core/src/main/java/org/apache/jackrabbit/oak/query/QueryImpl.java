...
specifier|final
name|String
name|INDEX_UNAVAILABLE
init|=
literal|"INDEX-UNAVAILABLE"
decl_stmt|;
specifier|private
specifier|final
name|QueryExecutionStats
...
argument_list|()
decl_stmt|;
comment|/**      * The map of indexes (each selector uses one index)      */
specifier|final
name|HashMap
argument_list|<
name|String
...
argument_list|()
decl_stmt|;
comment|/**      * The list of selectors of this query. For a join, there can be multiple selectors.      */
specifier|final
name|ArrayList
argument_list|<
name|SelectorImpl
...
return|;
block|}
comment|/**      * If one of the indexes wants a warning to be logged due to path mismatch,      * then get the warning message. Otherwise, return null.      *       * @return null (in the normal case) or the list of index plan names (if      *         some index wants a warning to be logged)      */
specifier|private
name|String
name|getWarningForPathFilterMismatch
parameter_list|()
block|{
name|StringBuilder
name|buff
...
operator|+
literal|"those restricted paths; query={}, plan={}"
argument_list|,
name|statement
argument_list|,
name|warn
...
argument_list|)
block|,
comment|// remove "explain" keyword from query statement to produce explained statement
name|PropertyValues
operator|.
name|newString
argument_list|(
...
literal|null
decl_stmt|;
comment|// track similar costs
name|QueryIndex
name|almostBestIndex
init|=
literal|null
decl_stmt|;
name|double
...
name|format
argument_list|(
literal|"selected index %s with plan %s and %s with plan %s have similar costs %s and %s for query %s - "
operator|+
literal|"check query explanation / index definitions"
argument_list|,
name|bestIndex
argument_list|,
name|bestPlan
...
name|format
argument_list|(
literal|"selected index %s and %s have similar costs %s and %s for query %s - check query explanation / index definitions"
argument_list|,
name|bestIndex
argument_list|,
name|almostBestIndex
...
name|debug
argument_list|(
literal|"no proper index was found for filter {}"
argument_list|,
name|filter
argument_list|)
expr_stmt|;
