...
expr_stmt|;
block|}
comment|/**      * Removes paths from {@code includePaths} that are completely excluded      * and only retains paths in {@code excludedPaths} that are included.      * @param includePaths      * @param excludedPaths      */
specifier|private
specifier|static
name|void
name|optimise
