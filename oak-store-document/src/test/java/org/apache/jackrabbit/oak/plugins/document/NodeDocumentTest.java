...
specifier|public
name|void
name|getNewestRevisionAfterGCWithBranchCommit
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|getNodeAtRevisionAfterGCWithBranchRevision
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// perform changes that move the commit information
comment|// to split documents
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|// trigger revision gc until split doc is removed
while|while
condition|(
operator|!
name|rootDoc
