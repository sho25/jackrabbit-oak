...
condition|)
block|{
comment|// collision with another authorizable node or some other node type.
name|int
name|i
init|=
literal|1
...
condition|)
block|{
comment|// convert absolute paths into relative paths wrt the authRoot
if|if
condition|(
name|intermediatePath
operator|.
