...
expr_stmt|;
block|}
comment|/**          * Set the given property {@code state}          * @param state          */
specifier|public
name|void
name|setProperty
parameter_list|(
...
expr_stmt|;
block|}
comment|/**          * Remove the property with the given {@code name}          * @param name          */
specifier|public
name|void
name|removeProperty
parameter_list|(
...
condition|)
block|{
comment|// remove transiently added property
name|properties
operator|.
name|remove
argument_list|(
...
block|{
comment|// mark property as removed
name|properties
operator|.
name|put
argument_list|(
