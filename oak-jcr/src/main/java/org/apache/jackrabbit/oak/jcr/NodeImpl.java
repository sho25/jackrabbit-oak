...
return|;
block|}
comment|/**      * Checks whether this node holds a lock by looking for the      * {@code jcr:lockIsDeep} property.      */
annotation|@
name|Override
specifier|public
name|boolean
...
block|}
comment|//------------------------------------------------------------< internal>---
comment|/**      * Checks if this node is lockable; otherwise throws a LockException.      * @throws LockException if the node is not lockable.      */
specifier|private
name|void
name|checkLockable
parameter_list|()
...
name|msg
init|=
literal|"Unable to perform a locking operation on a non-lockable node: "
operator|+
name|getPath
argument_list|()
decl_stmt|;
...
name|UnsupportedRepositoryOperationException
argument_list|(
literal|"TODO: JackrabbitNode.rename (OAK-770"
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedRepositoryOperationException
argument_list|(
literal|"TODO: JackrabbitNode.setMixins (OAK-770"
argument_list|)
throw|;
block|}
block|}
