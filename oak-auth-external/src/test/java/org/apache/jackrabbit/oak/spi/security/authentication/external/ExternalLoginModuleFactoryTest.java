...
begin_comment
comment|/**  * This test uses quite a bit of logic from ExternalLoginModuleTestBase  * As we need to create very specific scenario it would be easier to control  * the whole scenario  */
end_comment
