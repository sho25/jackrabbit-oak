...
specifier|public
class|class
name|LuceneStrictPathRestrictionEnableTest
extends|extends
name|AbstractQueryTest
block|{
specifier|private
...
specifier|public
name|void
name|pathIncludeWithPathRestrictionsEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|pathExcludeWithPathRestrictionsEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
name|explain
argument_list|(
literal|"select [jcr:path] from [nt:base] where [propa] = 10 and isDescendantNode('/test/c') and not(isDescendantNode('/test/c/e'))"
argument_list|)
argument_list|,
name|containsString
argument_list|(
