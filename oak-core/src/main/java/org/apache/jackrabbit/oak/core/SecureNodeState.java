...
condition|)
block|{
comment|// The SecureNodeState wrapper is needed if the child node
comment|// 1) exists, 2) has access restrictions, or 3) contains
comment|// descendants whose access control status isn't yet known
name|child
operator|=
name|secure
expr_stmt|;
