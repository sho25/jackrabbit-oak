...
name|init
decl_stmt|;
comment|/**      * whether the query is a result of optimisation or original one.      */
specifier|private
name|boolean
name|optimised
decl_stmt|;
...
return|;
block|}
comment|/**      * convenience method for creating a UnionQueryImpl with proper settings.      *       * @param left      * @param right      * @return      */
specifier|private
name|UnionQueryImpl
name|newOptimisedUnionQuery
parameter_list|(
...
return|;
block|}
comment|/**      * compute a cost overhead for the OAK-2660 use case. The query engine better perform/compute      * the use case `(a = 'v' OR CONTAINS(b, 'v1') OR CONTAINS(c, 'v2') AND (...)` as a UNION query      * to leverage different indexes. In this case we return an 'Infinity' overhead for make the      * query engine choose a union query instead.      *       * @param constraint the constraint to analyse. Cannot be null.      * @return      */
specifier|private
name|double
name|oak2660CostOverhead
parameter_list|(
