...
begin_comment
comment|/**  * Simple factory for creating {@link DataSource}s based on a JDBC connection  * URL.  *<p>  * This class is not intended for use in production, as it does not support  * configuring the pool's parameters.  */
end_comment
