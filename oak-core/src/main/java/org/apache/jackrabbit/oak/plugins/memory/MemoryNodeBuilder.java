...
block|}
block|}
comment|/**      * Determine whether the named child has been removed. This is the      * case when the write state has a corresponding {@code null} entry.      * Assumes {@code read()}, {@code write()} needs not be called.      * @param name  name of the child      * @return  {@code true} iff a child with the given name has been removed      */
specifier|private
name|boolean
name|removed
parameter_list|(
