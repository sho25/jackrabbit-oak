...
block|{
comment|/**      * True property which is used to mark the presence of relative node      * This needs to be set when a bundled relative node is added      */
specifier|private
specifier|static
specifier|final
name|PropertyState
name|NODE_PRESENCE_MARKER
init|=
name|PropertyStates
operator|.
name|createProperty
