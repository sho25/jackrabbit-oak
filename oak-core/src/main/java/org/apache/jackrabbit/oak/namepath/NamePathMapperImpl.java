...
return|;
block|}
comment|// Shortcut iff the JCR path does not start with a dot, does not contain any of
comment|// {}[]/ and if it contains a colon the session does not have local re-mappings.
name|boolean
name|hasLocalMappings
init|=
name|hasSessionLocalMappings
argument_list|()
decl_stmt|;
