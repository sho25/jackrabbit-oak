...
parameter_list|()
function_decl|;
comment|/**      * Move this child to a new parent with a new name.      * @param newParent  builder for the new parent.      * @param newName  name of this child at the new parent      * @return  {@code true} on success, {@code false} otherwise      */
name|boolean
name|moveTo
parameter_list|(
annotation|@
