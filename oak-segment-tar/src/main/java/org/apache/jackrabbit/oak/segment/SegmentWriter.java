...
argument_list|)
decl_stmt|;
comment|/**      * Size of the window for collecting statistics about the time it takes to      * write / compact nodes.      * @see DescriptiveStatistics#setWindowSize(int)      */
specifier|private
specifier|static
specifier|final
name|int
name|NODE_WRITER_STATS_WINDOW
init|=
name|getInteger
argument_list|(
literal|"oak.tar.nodeWriterStatsWindow"
argument_list|,
literal|10000
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**      * @return  Statistics for node compaction times (in ns). These statistics      * include explicit compactions triggered by the file store and implicit      * compactions triggered by references to older generations.      * The statistics are collected with a window size defined by {@link #NODE_WRITER_STATS_WINDOW}      * @see #getNodeWriteTimeStats()      */
annotation|@
name|Nonnull
specifier|public
name|DescriptiveStatistics
...
return|;
block|}
comment|/**      * @return  Statistics for node write times (in ns).      * The statistics are collected with a window size defined by {@link #NODE_WRITER_STATS_WINDOW}      * @see #getNodeCompactTimeStats()      */
annotation|@
name|Nonnull
specifier|public
name|DescriptiveStatistics
...
return|;
block|}
comment|/**      * @return  Statistics for the template deduplication cache or {@code null} if not available.      */
annotation|@
name|CheckForNull
specifier|public
name|CacheStatsMBean
...
return|;
block|}
comment|/**      * Write a node state      * @param state node state to write      * @return segment node state equal to {@code state}      * @throws IOException      */
annotation|@
name|Nonnull
specifier|public
...
argument_list|()
decl_stmt|;
comment|/*              * Total number of nodes in the subtree rooted at the node passed              * to {@link #writeNode(SegmentWriteOperation, SegmentBufferWriter, NodeState)}              */
specifier|public
name|int
name|nodeCount
decl_stmt|;
comment|/*              * Number of cache hits for a deferred compacted node              */
specifier|public
name|int
name|cacheHits
decl_stmt|;
comment|/*              * Number of cache misses for a deferred compacted node              */
specifier|public
name|int
name|cacheMiss
decl_stmt|;
comment|/*              * Number of nodes that where de-duplicated as the store already contained              * them.              */
specifier|public
name|int
name|deDupNodes
decl_stmt|;
comment|/*              * Number of nodes that actually had to be written as there was no de-duplication              * and a cache miss (in case of a deferred compaction).              */
specifier|public
name|int
name|writesOps
decl_stmt|;
comment|/*              * {@code true} for if the node written was a compaction operation, false otherwise              */
name|boolean
name|isCompactOp
decl_stmt|;
annotation|@
...
block|}
block|}
comment|/**          * This exception is used internally to signal cancellation of a (recursive)          * write node operation.          */
specifier|private
class|class
name|CancelledWriteException
extends|extends
...
name|super
argument_list|(
literal|"Cancelled write operation"
argument_list|)
expr_stmt|;
block|}
block|}
...
condition|)
block|{
comment|// Poor man's Either Monad
throw|throw
operator|new
name|CancelledWriteException
argument_list|()
