...
parameter_list|()
block|{
comment|// 2 authorization configuration with different RestrictionProvider
name|AuthorizationConfiguration
name|ac
init|=
name|createAuthorizationConfigurationImpl
...
specifier|public
name|void
name|testRedundantRestrictionProvider
parameter_list|()
block|{
comment|// 2 authorization configuration sharing the same RestrictionProvider
name|AuthorizationConfiguration
name|ac
init|=
name|createAuthorizationConfigurationImpl
...
argument_list|)
decl_stmt|;
comment|// composite should detect the duplication
name|RestrictionProvider
name|rp
init|=
name|cc
...
specifier|public
name|void
name|testDefaultEvaluationFilter
parameter_list|()
block|{
name|PermissionProvider
name|pp
...
specifier|public
name|void
name|testAbortingEvaluationFilter
parameter_list|()
block|{
name|Set
argument_list|<
