...
begin_comment
comment|/**  * Utility class defining the conversion that take place between {@link org.apache.jackrabbit.oak.api.PropertyState}s  * of different types.  *<p>  * Example:  *<pre>  *    double three = convert("3.0").toDouble();  *</pre>  */
end_comment
...
return|;
block|}
comment|/**      * Create a converter for a long. {@code String.valueOf(long)} is used for the conversion to {@code String}.      * The conversions to {@code double} and {@code long} return the {@code value} itself.      * The conversion to decimal uses {@code new BigDecimal(long)}.      * @param value  The long to convert      * @return  A converter for {@code value}      */
specifier|public
specifier|static
name|Converter
name|convert
...
return|;
block|}
comment|/**      * Create a converter for a double. {@code String.valueOf(double)} is used for the conversion to {@code String}.      * The conversions to {@code double} and {@code long} return the {@code value} itself where in the former case      * the value is casted to {@code long}.      * The conversion to decimal uses {@code new BigDecimal(double)}.      * @param value  The double to convert      * @return  A converter for {@code value}      */
specifier|public
specifier|static
name|Converter
name|convert
...
return|;
block|}
comment|/**      * Create a converter for a decimal. {@code BigDecimal.toString()} is used for the conversion to {@code String}.      * {@code BigDecimal.longValue()} and {@code BigDecimal.doubleValue()} is used for the conversions to      * {@code long} and {@code double}, respectively.      * @param value  The decimal to convert      * @return  A converter for {@code value}      */
specifier|public
specifier|static
name|Converter
name|convert
