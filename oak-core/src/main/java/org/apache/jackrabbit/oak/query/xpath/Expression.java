...
return|;
block|}
comment|/**      * Get the most specific nodetype condition, that is a condition of the form      * "jcr:primaryType = 'x'". If there are multiple such conditions, only the      * most strict one needs to be returned. If there are no, or conflicting      * conditions, then null may be returned, meaning no usable condition.      *       * @param selectorName the selector name      * @return null or the nodetype value      */
specifier|public
name|String
