...
begin_comment
comment|/**  * Implementation of the copy node operation => "*" STRING ":" STRING  */
end_comment
...
name|sourcePath
decl_stmt|;
comment|/**      * Constructs a new {@code CopyNodeInstruction}.      *      * @param path The path.      * @param sourcePath The source path.      * @param destPath The destination path.      */
specifier|public
name|CopyNodeInstructionImpl
parameter_list|(
name|String
