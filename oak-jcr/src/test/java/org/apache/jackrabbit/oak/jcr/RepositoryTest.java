...
try|try
block|{
comment|// After receiving an event wait until event listener is removed
name|waitForRemove
operator|.
name|get
argument_list|()
...
argument_list|()
expr_stmt|;
comment|// Make sure we see the first event
name|assertTrue
argument_list|(
name|hasEvents
operator|.
...
argument_list|)
expr_stmt|;
comment|// Remove event listener before it receives the second event
name|Executors
operator|.
...
argument_list|()
expr_stmt|;
comment|// Make sure we don't see the second event
name|assertFalse
argument_list|(
name|hasEvents
operator|.
