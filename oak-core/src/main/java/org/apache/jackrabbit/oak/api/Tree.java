...
parameter_list|()
function_decl|;
comment|/**      * @return the parent of this {@code Tree} instance. This method returns      *         {@code null} if the parent is not accessible or if no parent exists (root      *         node).      * @deprecated use {@link #getParent()} and {@link #exists()} instead.      */
annotation|@
name|CheckForNull
annotation|@
name|Deprecated
