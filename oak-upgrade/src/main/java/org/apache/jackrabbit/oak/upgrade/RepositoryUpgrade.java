...
condition|)
block|{
comment|// Ignore built in privileges as those have been installed by
comment|// the PrivilegesInitializer already
continue|continue;
block|}
name|NodeBuilder
name|def
...
expr_stmt|;
block|}
comment|// FIXME (OAK-2400): the privilege bits of aggregated privileges is not just 'next' but must be properly calculated from the aggregates
name|PrivilegeBits
name|bits
init|=
name|PrivilegeBits
...
name|UnsupportedRepositoryOperationException
argument_list|(
literal|"Cannot copy default value of type "
operator|+
name|Type
operator|.
name|fromTag
...
name|UnsupportedRepositoryOperationException
argument_list|(
literal|"Cannot copy default value "
operator|+
name|path
argument_list|)
throw|;
