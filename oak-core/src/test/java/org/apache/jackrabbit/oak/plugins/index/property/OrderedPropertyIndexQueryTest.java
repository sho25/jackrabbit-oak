...
expr_stmt|;
block|}
comment|/**      * checks the {@code OR} and {@code IN} conditions in queries.      *       * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
...
comment|// {@code createTestIndexNode()}
comment|// generates:
comment|//  /test/n0, /test/n1, /test/n2
name|Tree
name|rTree
init|=
name|root
...
name|statementOr
init|=
literal|"SELECT * FROM [nt:unstructured] "
operator|+
literal|"WHERE "
operator|+
name|ORDERED_PROPERTY
...
name|statementIn
init|=
literal|"SELECT * FROM [nt:unstructured] WHERE "
operator|+
name|ORDERED_PROPERTY
operator|+
literal|" IN($or1, $or2)"
...
argument_list|)
decl_stmt|;
comment|// re-sorting ascending as the index is ASC and the results will be returned as ASC
name|Collections
operator|.
name|sort
argument_list|(
...
expr_stmt|;
block|}
comment|// re-initialising the filtered for the test
name|filtered
operator|=
name|Iterables
operator|.
...
name|assertFalse
argument_list|(
literal|"We should have looped throught all the results"
argument_list|,
name|results
operator|.
name|hasNext
...
literal|"OAK-1763"
argument_list|)
comment|// FIXME OAK-1763
specifier|public
name|void
name|orderByOnDouble
parameter_list|()
throws|throws
name|CommitFailedException
throws|,
...
specifier|public
name|void
name|orderByQueryOnSpecialChars
parameter_list|()
throws|throws
name|CommitFailedException
throws|,
...
name|assertFalse
argument_list|(
literal|"We should have looped through all the results"
argument_list|,
name|results
operator|.
name|hasNext
...
argument_list|)
expr_stmt|;
comment|// remove the default test index definition
name|root
operator|.
name|getTree
argument_list|(
...
name|format
argument_list|(
literal|"SELECT * FROM [%s] as s WHERE s.foo IS NOT NULL and ISDESCENDANTNODE(s, '/test')"
argument_list|,
name|NT_UNSTRUCTURED
argument_list|)
argument_list|,
...
specifier|public
name|void
name|indexDefinitionBelowRootOrderBy
parameter_list|()
throws|throws
name|Exception
block|{
...
name|format
argument_list|(
literal|"SELECT * FROM [%s] as s WHERE ISDESCENDANTNODE(s, '/test') ORDER BY s.foo"
argument_list|,
name|NT_UNSTRUCTURED
argument_list|)
argument_list|,
