...
argument_list|)
expr_stmt|;
comment|// Not deleting nodes in case of multi level nodes
comment|// Probably  change/improve this in future.
if|if
condition|(
operator|!
name|createMultiLevelNodes
...
specifier|public
name|void
name|testDumpRefWithVerboseRootPath
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testDumpRefWithoutVerbose
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testDumpRefVerboseRootPathRegex
parameter_list|()
throws|throws
name|Exception
block|{
...
name|additionalParams
operator|+=
literal|" --verboseRootPath /foo --verbosePathInclusionRegex /*/test"
expr_stmt|;
for|for
control|(
name|String
...
specifier|public
name|void
name|testDumpRefVerboseRegexWithoutVerboseRootPath
parameter_list|()
throws|throws
name|Exception
block|{
...
try|try
block|{
comment|// Create exec command without --verboseRootPath - It should throw an exception
comment|// since we used --verbosePathInclusionRegex without --verboseRootPath
name|testDumpRef
argument_list|(
name|dump
argument_list|,
...
name|equals
argument_list|(
literal|"Option(s) [verbosePathInclusionRegex] are unavailable "
operator|+
literal|"given other options on the command line"
argument_list|)
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// Verbose would have paths as well as ids changed, otherwise only ids would be listed as it is.
name|assertFileEquals
argument_list|(
name|dump
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Verbose would have backend friendly encoded ids
name|assertFileEquals
argument_list|(
name|dump
argument_list|,
...
name|Data
block|{
comment|// Set of blob ids created
specifier|private
name|Set
argument_list|<
name|String
...
name|added
decl_stmt|;
comment|// Mapping of id to the path on which their ref exists
specifier|private
name|Map
argument_list|<
name|String
...
name|deleted
decl_stmt|;
comment|// Set of blobs that will be deleted from datastore
specifier|private
name|Set
argument_list|<
name|String
...
name|missingDataStore
decl_stmt|;
comment|// A subset of added blobs - use this to test the --verboseRootPath option
comment|// (In case of getting the blob refs only under a specific path)
specifier|private
name|Set
argument_list|<
name|String
