...
argument_list|)
expr_stmt|;
comment|//connection.bind(user.getExternalId().getId(), new String(creds.getPassword()));
name|timer
operator|.
name|mark
argument_list|(
...
name|debug
argument_list|(
literal|"getDeclaredGroupRefs: using SearchRequest {}."
argument_list|,
name|req
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"getDeclaredGroupRefs: search below {} with {} found {} entries. {}"
argument_list|,
name|config
operator|.
name|getGroupConfig
...
name|warn
argument_list|(
literal|"Failed to close search cursor."
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"getEntry: using SearchRequest {}."
argument_list|,
name|req
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"getEntry: search below {} with {} found 0 entries."
argument_list|,
name|idConfig
operator|.
name|getBaseDN
...
name|debug
argument_list|(
literal|"getEntry: search below {} with {} found {}"
argument_list|,
name|idConfig
operator|.
name|getBaseDN
...
name|debug
argument_list|(
literal|"loadNextPage: using SearchRequest {}."
argument_list|,
name|req
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"loadNextPage: search below {} with {} found {}"
argument_list|,
name|idConfig
operator|.
name|getBaseDN
