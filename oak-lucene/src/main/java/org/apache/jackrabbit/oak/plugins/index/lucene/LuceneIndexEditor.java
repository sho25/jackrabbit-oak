...
condition|)
block|{
name|markParentsOnRelPropChange
argument_list|()
expr_stmt|;
block|}
if|if
...
argument_list|)
expr_stmt|;
name|checkForRelativePropertyChange
argument_list|(
name|after
operator|.
name|getName
...
condition|)
block|{
comment|// need to update aggregated properties on deletes
return|return
operator|new
name|LuceneIndexEditor
argument_list|(
