...
specifier|public
name|void
name|testReadWithLargeBufferFromOffset
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|testReadWithSmallBufferFromOffset
parameter_list|()
throws|throws
name|IOException
block|{
...
specifier|public
name|void
name|testReadWithEmptyBufferFromOffset
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// it is powers of 2, not evens
name|assertEquals
argument_list|(
literal|32L
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// random mid-range number
comment|// Test values around the upper limit of powers of 2 in the signed int range
name|assertEquals
argument_list|(
literal|0x01L
operator|<<
