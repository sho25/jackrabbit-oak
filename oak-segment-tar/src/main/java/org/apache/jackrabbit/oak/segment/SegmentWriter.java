...
return|;
block|}
comment|/**      * Write a node state, unless cancelled      * @param state   node state to write      * @param cancel  supplier to signal cancellation of this write operation      * @return segment node state equal to {@code state} or {@code null} if cancelled.      * @throws IOException      */
annotation|@
name|CheckForNull
specifier|public
name|SegmentNodeState
