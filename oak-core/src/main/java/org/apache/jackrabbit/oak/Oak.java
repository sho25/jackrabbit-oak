...
return|;
block|}
comment|/**      * Associates the given login context provider with the repository to be      * created.      *      * @param loginContextProvider a login context provider.      * @return this builder.      */
annotation|@
name|Nonnull
specifier|public
name|Oak
...
return|;
block|}
comment|/**      * Associates the given access control context provider with the repository      * to be created.      *      * @param accProvider an access control context provider.      * @return this builder.      */
annotation|@
name|Nonnull
specifier|public
name|Oak
