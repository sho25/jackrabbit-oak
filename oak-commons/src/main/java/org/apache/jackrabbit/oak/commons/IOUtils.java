...
return|;
block|}
comment|/**      * Try to read the given number of bytes starting at the specified position      * into the buffer. This method reads until the maximum number of bytes have      * been read or until the end of the channel.      *      * @param channel     the input channel      * @param position    the position to start reading from the channel      * @param buffer      the output buffer      * @return the number of bytes read, 0 meaning EOF or no space in buffer      * @throws java.io.IOException If an error occurs.      */
specifier|public
specifier|static
name|int
name|readFully
