...
argument_list|()
decl_stmt|;
comment|/**      * Set of added, modified or removed ({@code null} value) child node states.      */
specifier|private
specifier|final
name|Map
argument_list|<
...
block|}
block|}
comment|/**      * Returns an optimized snapshot of the current state of the given map.      *      * @param map mutable map      * @return optimized snapshot      */
specifier|private
specifier|static
parameter_list|<
name|T
