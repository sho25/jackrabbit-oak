...
argument_list|)
expr_stmt|;
comment|// Include all properties for both assets and pages
name|Tree
name|assetProps
init|=
name|TestUtil
...
name|statement
init|=
literal|"select [rep:excerpt] from [test:Page] as page where contains(*, '%s*')"
decl_stmt|;
name|Tree
name|content
init|=
...
argument_list|)
decl_stmt|;
comment|// contains 'aliq' but not 'tinc'
name|pageContent
operator|.
name|setProperty
argument_list|(
literal|"bar"
argument_list|,
literal|"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque aliquet odio varius odio "
operator|+
literal|"imperdiet, non egestas ex consectetur. Fusce congue ac augue quis finibus. Sed vulputate sollicitudin neque, nec "
operator|+
literal|"lobortis nisl varius eget."
argument_list|)
expr_stmt|;
comment|// doesn't contain 'aliq' but 'tinc'
name|pageContent
operator|.
name|getParent
argument_list|()
...
literal|"bar"
argument_list|,
literal|"Donec lacinia luctus leo, sed rutrum nulla. Sed sed hendrerit turpis. Donec ex quam, "
operator|+
literal|"bibendum et metus at, tristique tincidunt leo. Nam at elit ligula. Etiam ullamcorper, elit sit amet varius molestie, "
operator|+
literal|"nisl ex egestas libero, quis elementum enim mi a quam."
argument_list|)
expr_stmt|;
name|root
operator|.
...
argument_list|)
expr_stmt|;
comment|// assert that there is only a single hit
name|PropertyValue
name|excerptValue
init|=
name|firstHit
...
name|term
operator|+
literal|"' is not supposed to be empty."
argument_list|,
literal|""
operator|.
name|equals
...
return|;
block|}
comment|/**      *<p>      * convenience method that create an "page" structure like      *</p>      *      *<pre>      *  "parent" : {      *      "nodeName" : {      *          "jcr:primaryType" : "test:Page",      *          "jcr:content" : {      *              "jcr:primaryType" : "test:PageContent"      *          }      *      }      *  }      *</pre>      *      *<p>      *  and returns the {@code jcr:content} node      *</p>      *      * @param parent the parent under which creating the node      * @param nodeName the node name to be used      * @return the {@code jcr:content} node. See above for details      */
specifier|private
specifier|static
name|Tree
name|createPageStructure
