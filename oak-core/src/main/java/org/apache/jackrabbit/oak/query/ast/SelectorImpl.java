...
name|scanCount
decl_stmt|;
comment|/**      * Names of all matching node type names encountered so far.      */
specifier|private
specifier|final
name|Set
argument_list|<
...
name|matchingTypes
decl_stmt|;
comment|/**      * Names of all<em>non-matching</em> node type names encountered so far.      */
specifier|private
specifier|final
name|Set
argument_list|<
...
literal|true
return|;
comment|// shortcut for a common case
block|}
name|Set
argument_list|<
name|String
