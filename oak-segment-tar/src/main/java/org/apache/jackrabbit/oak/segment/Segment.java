...
name|HEADER_SIZE
decl_stmt|;
comment|// lazily populated cache of msbs and lsbs of the referenced segments ids.
comment|// DO NOT keep references to the SegmentIds here as this will overflow the heap.
comment|// See OAK-4949.
specifier|final
name|long
index|[]
name|ids
