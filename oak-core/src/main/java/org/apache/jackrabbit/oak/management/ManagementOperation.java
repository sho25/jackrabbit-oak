...
return|;
block|}
comment|/**      * An operation that is already done with the given {@code value}.      *      * @param name  name of the operation      * @param value value returned by the operation      * @return  a {@code ManagementOperation} instance that is already done.      */
specifier|public
specifier|static
name|ManagementOperation
name|done
