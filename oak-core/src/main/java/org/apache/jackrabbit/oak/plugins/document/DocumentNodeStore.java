...
condition|)
block|{
comment|// maybe this should be an interface
operator|(
operator|(
name|RDBBlobStore
operator|)
...
condition|)
block|{
comment|// update diff cache for modified nodes
name|PathRev
name|key
init|=
name|diffCacheKey
...
return|return;
block|}
comment|// write back the pending _lastRevs with an exclusive lock to
