...
begin_comment
comment|/**  * Read-Only {@code PrivilegeManager} implementation reading privilege definitions  * from the repository content.  *  * TODO: review if jcr:all should be present in the content as well (updated in the privilege commit validator)  */
end_comment
...
name|UnsupportedRepositoryOperationException
argument_list|(
literal|"ReadOnly PrivilegeManager: Privilege registration not supported"
argument_list|)
throw|;
block|}
comment|//------------------------------------------------------------< private>---
