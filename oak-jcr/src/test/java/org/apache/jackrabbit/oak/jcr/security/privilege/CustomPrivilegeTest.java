...
name|Exception
block|{
comment|// FIXME: remove any remaining custom privilege definitions
name|super
operator|.
name|tearDown
argument_list|()
...
annotation|@
name|Ignore
comment|// FIXME: default setup should enforce access restrictions
annotation|@
name|Test
specifier|public
name|void
...
name|fail
argument_list|(
literal|"Custom privilege must show up after Session#refresh()"
argument_list|)
expr_stmt|;
block|}
catch|catch
