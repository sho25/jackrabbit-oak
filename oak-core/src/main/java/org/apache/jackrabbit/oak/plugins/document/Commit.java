...
argument_list|()
decl_stmt|;
comment|/**      * Create a new Commit.      *        * @param nodeStore the node store.      * @param revision the revision for this commit.      * @param baseRevision the base revision for this commit or {@code null} if      *                     there is none.      * @param branch the branch associated with this commit or {@code null} if      *               there is none.      *                                    */
name|Commit
parameter_list|(
annotation|@
name|Nonnull
