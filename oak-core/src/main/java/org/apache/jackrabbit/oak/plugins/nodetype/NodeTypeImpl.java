...
return|;
block|}
comment|/**      * Returns the namespace neutral CND of the given node type definition.      * @param def the node type definition      * @return the CND      * @throws IOException if an error occurs.      */
specifier|private
specifier|static
name|String
name|getCnd
...
return|;
block|}
comment|/**      * Returns the namespace neutral CND of the this node type definition.      * @return the CND      */
specifier|private
name|String
name|getCnd
parameter_list|()
...
name|error
argument_list|(
literal|"Internal error while writing CND for {}"
argument_list|,
name|this
argument_list|)
expr_stmt|;
