...
begin_comment
comment|/**  * A copy of the class org.apache.jackrabbit.oak.spi.blob.AbstractBlobStoreTest,  * converted to JUnit 4. The class in oak-mk is not re-used because it is not  * visible here.  */
end_comment
