...
name|refreshAtNextAccess
operator|||
name|commitDoneByOtherSessionInCurrentThread
argument_list|()
operator|||
name|timeElapsed
operator|>=
...
parameter_list|()
block|{
comment|//if the threadLocal counter differs from our seen saveCount so far then
