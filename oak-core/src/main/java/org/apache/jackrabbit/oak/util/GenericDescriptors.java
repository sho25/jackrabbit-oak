...
return|;
block|}
comment|/**      * Adds a new descriptor to this set of descriptors which overlay the ones from the base set.      *      * @param name descriptor name      * @param values array of descriptor values      * @param singleValued flag indicating if this is single valued descriptor. see {@link Descriptors#isSingleValueDescriptor(String)}      * @param standard flag indicating if this is a standard descriptor. see {@link Descriptors#isStandardDescriptor(String)}      * @return {@code this} suitable for chaining.      */
specifier|public
name|GenericDescriptors
name|put
parameter_list|(
...
return|;
block|}
comment|/**      * Adds a new descriptor to this set of descriptors which overlay the ones from the base set.      *      * @param name descriptor name      * @param value descriptor value      * @param singleValued flag indicating if this is single valued descriptor. see {@link Descriptors#isSingleValueDescriptor(String)}      * @param standard flag indicating if this is a standard descriptor. see {@link Descriptors#isStandardDescriptor(String)}      * @return {@code this} suitable for chaining.      */
specifier|public
name|GenericDescriptors
name|put
parameter_list|(
