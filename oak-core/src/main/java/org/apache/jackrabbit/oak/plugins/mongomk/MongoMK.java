...
condition|)
block|{
comment|// visible from this branch if revision is
comment|// not newer than base of branch
if|if
condition|(
operator|!
name|isRevisionNewer
...
block|{
comment|// non-branch read -> check if newer
if|if
condition|(
name|isRevisionNewer
argument_list|(
...
comment|// -> overlay with unsaved last revs from branch
name|Revision
name|r
init|=
name|branch
