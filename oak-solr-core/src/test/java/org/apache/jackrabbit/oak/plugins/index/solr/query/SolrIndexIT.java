...
name|nativeQueryString
init|=
literal|"select [jcr:path] from [nt:base] where native('solr', 'mlt?q=text:welt&mlt.fl=text&mlt.mindf=1&mlt.mintf=1')"
decl_stmt|;
name|Tree
name|tree
init|=
...
name|nativeQueryString
init|=
literal|"select [jcr:path] from [nt:base] where native('solr', 'mlt?stream.body=sky is cloudy&mlt.fl=text&mlt.mindf=0&mlt.mintf=0')"
decl_stmt|;
name|Tree
name|tree
init|=
...
literal|"text"
argument_list|,
literal|"the lazy fox jumped over the brown dog"
argument_list|)
expr_stmt|;
name|test
operator|.
...
literal|"text"
argument_list|,
literal|"the lazy bones raised to eat a dog"
argument_list|)
expr_stmt|;
name|root
operator|.
...
name|assertQuery
argument_list|(
literal|"/jcr:root//*[jcr:contains(., 'lazy AND brown')]"
argument_list|,
literal|"xpath"
argument_list|,
name|ImmutableList
...
name|assertQuery
argument_list|(
literal|"/jcr:root//*[jcr:contains(., 'lazy OR eat')]"
argument_list|,
literal|"xpath"
argument_list|,
name|ImmutableList
...
name|assertQuery
argument_list|(
literal|"/jcr:root//*[jcr:contains(., 'lazy AND bones')]"
argument_list|,
literal|"xpath"
argument_list|,
name|ImmutableList
...
name|assertQuery
argument_list|(
literal|"/jcr:root//*[jcr:contains(., 'lazy OR dog')]"
argument_list|,
literal|"xpath"
argument_list|,
name|ImmutableList
...
name|query
init|=
literal|"select [jcr:path] from [nt:base] where native('solr','select?q=loc:*') AND foo IS NOT NULL"
decl_stmt|;
name|Iterator
argument_list|<
name|String
