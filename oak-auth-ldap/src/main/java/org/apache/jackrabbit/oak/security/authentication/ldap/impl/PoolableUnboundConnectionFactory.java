...
expr_stmt|;
block|}
comment|/**      * gets the connection validator      * @return the connection validator      */
specifier|public
name|LdapConnectionValidator
name|getValidator
parameter_list|()
...
return|;
block|}
comment|/**      * Sets the connection validator that is used when the connection is taken out of the pool      * @param validator the validator      */
specifier|public
name|void
name|setValidator
parameter_list|(
