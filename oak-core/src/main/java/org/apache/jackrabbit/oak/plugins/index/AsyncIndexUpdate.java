...
name|debug
argument_list|(
literal|"The {} indexer is already running; skipping this update"
argument_list|,
name|name
argument_list|)
expr_stmt|;
...
operator|+
literal|" rerunning the initial {} index update"
argument_list|,
name|refCheckpoint
argument_list|,
name|name
...
name|debug
argument_list|(
literal|"The {} index update failed; releasing the related checkpoint {}"
argument_list|,
name|name
argument_list|,
name|checkpoint
...
name|debug
argument_list|(
literal|"The {} index update succeeded; releasing the previous checkpoint {}"
argument_list|,
name|name
argument_list|,
name|refCheckpoint
