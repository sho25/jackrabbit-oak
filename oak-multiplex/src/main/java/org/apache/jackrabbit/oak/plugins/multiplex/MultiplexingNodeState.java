...
comment|// /a and /a/b, which will not be visible through the multiplexing node store.
comment|//
comment|// If a node store holds information _below_ a path which belongs to another
comment|// repository, the multiplexing node store will not consider that information.
comment|//
