...
name|info
argument_list|(
literal|"Registering blobStore {} with editorProvider. "
argument_list|,
name|blobStore
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Unregistering blobStore"
argument_list|)
expr_stmt|;
block|}
name|editorProvider
...
name|info
argument_list|(
literal|"Oldest checkpoint time data ({}) is older than buffer period for deleted blobs."
operator|+
...
name|warn
argument_list|(
literal|"Couldn't find timestamp in checkpoint mbean output: {}"
argument_list|,
name|data
argument_list|)
expr_stmt|;
