...
specifier|public
name|void
name|getNodesWithDefaultFilter
parameter_list|()
block|{
name|String
name|head
...
control|)
block|{
comment|// verify initial content with implicit default filter
name|JSONObject
name|obj
init|=
name|parseJSONObject
...
specifier|public
name|void
name|testReadReturnsNonNegative
parameter_list|()
block|{
name|TestInputStream
name|in
...
name|assertTrue
argument_list|(
literal|"read returns negative value"
argument_list|,
name|mk
operator|.
name|read
