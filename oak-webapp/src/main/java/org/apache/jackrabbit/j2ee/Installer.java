...
name|configTemplate
init|=
literal|"/org/apache/jackrabbit/core/repository.xml"
decl_stmt|;
...
name|error
argument_list|(
literal|"Trying to install new repository home '{}' but it already contain a repository"
argument_list|,
name|repHome
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// install repository xml for Jackrabbit Classic
try|try
block|{
...
expr_stmt|;
block|}
comment|/**      * Installs the bootstrap config file from the template      * @param dest the destination location      * @param repHome the repository home location      * @param repXml the repository xml location      * @throws IOException if an I/O error occurs      */
specifier|private
name|void
name|installBootstrap
parameter_list|(
