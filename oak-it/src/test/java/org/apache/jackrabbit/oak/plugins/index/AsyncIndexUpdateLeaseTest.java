...
specifier|public
name|void
name|testLeaseUpdateAndNumberOfChanges
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|//Run with changes more than threshold and then lease should change more than once
name|testContent
argument_list|(
name|store
argument_list|,
