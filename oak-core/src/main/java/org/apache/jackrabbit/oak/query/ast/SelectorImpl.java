...
expr_stmt|;
block|}
comment|//   queryConstraint;
comment|//   protected JoinConditionImpl joinCondition;
comment|//   protected ArrayList<JoinConditionImpl> allJoinConditions =
comment|//           new ArrayList<JoinConditionImpl>();
comment|//   protected boolean join;
comment|//   protected boolean outerJoinLeftHandSide;
comment|//   protected boolean outerJoinRightHandSide;
comment|//   protected boolean isParent;
