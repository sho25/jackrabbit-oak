...
name|nodeCache
decl_stmt|;
comment|/**          * The {@code StatisticsProvider} instance used to expose statistics of          * the caches managed by this instance.          */
annotation|@
name|Nonnull
specifier|private
specifier|final
