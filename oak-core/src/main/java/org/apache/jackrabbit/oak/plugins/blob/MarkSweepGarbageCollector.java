...
block|}
block|}
comment|/**              * Adds the marked references to the blob store root. Default NOOP              *               * @param blobStore the blob store              * @param fs the fs              * @param repoId the repo id              * @throws DataStoreException the data store exception              * @throws IOException Signals that an I/O exception has occurred.              */
annotation|@
name|Override
name|void
name|addMarked
...
name|DEFAULT
block|;
comment|/**          * Deletes a batch of blobs from blob store.          *          * @param blobStore blobStore          * @param ids ids to sweep          * @param exceptionQueue add removes to the queue          * @param maxModified maxModified time of blobs to be deleted          * @return          */
name|long
name|sweepInternal
parameter_list|(
name|GarbageCollectableBlobStore
...
block|}
block|}
comment|/**          * Hook to handle all the removed ids.          *          * @param blobStore          * @param removedIds          * @throws IOException          */
name|void
name|handleRemoves
parameter_list|(
name|GarbageCollectableBlobStore
