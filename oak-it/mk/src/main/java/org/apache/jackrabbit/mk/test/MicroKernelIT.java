...
argument_list|)
expr_stmt|;
comment|// test getRevisionHistory/getJournal/diff path filter
name|mk
operator|.
name|commit
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// get history since ts1 (no filter)
name|array
operator|=
name|parseJSONArray
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// get history since ts1 (non-matching filter)
name|array
operator|=
name|parseJSONArray
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// get history since ts1 (filter on /test/bar)
name|array
operator|=
name|parseJSONArray
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// history should contain 1 commits: revFoo and revBar
name|assertEquals
argument_list|(
literal|1
argument_list|,
