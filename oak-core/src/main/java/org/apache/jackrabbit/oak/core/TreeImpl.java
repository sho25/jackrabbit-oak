...
argument_list|)
expr_stmt|;
comment|// readstatus is ALLOW_ALL for new items
name|readStatus
operator|=
operator|(
name|getBaseState
...
return|;
block|}
comment|/**      * The node state this tree is based on. {@code null} if this is a newly added tree.      * @return the base node state of this tree      */
annotation|@
name|CheckForNull
specifier|final
name|NodeState
