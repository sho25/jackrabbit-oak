...
parameter_list|()
block|{
comment|// Id of the segment to be written in the file store. If the segment id
comment|// is not null, a segment will be written outside of the synchronized block.
name|SegmentId
name|segmentId
init|=
literal|null
decl_stmt|;
comment|// Buffer containing segment data, and offset and length to locate the
comment|// segment data into the buffer. These variable will be initialized in
...
block|}
block|}
comment|/**      * Write a large blob ID. A blob ID is considered large if the length of its      * binary representation is equal to or greater than {@code      * Segment.BLOB_ID_SMALL_LIMIT}.      *      * @param blobId Blob ID.      * @return A record ID pointing to the written blob ID.      */
specifier|private
name|RecordId
name|writeLargeBlobId
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// The length uses a fake "length" field that is always equal to 0xF0.
...
block|}
block|}
comment|/**      * Write a small blob ID. A blob ID is considered small if the length of its      * binary representation is less than {@code Segment.BLOB_ID_SMALL_LIMIT}.      *      * @param blobId Blob ID.      * @return A record ID pointing to the written blob ID.      */
specifier|private
name|RecordId
name|writeSmallBlobId
parameter_list|(
