...
return|;
block|}
comment|/**      * Helper method to create or update an ordered index definition.      *      * @param session the session      * @param indexDefinitionName the name of the node for the index definition      * @param propertyNames the list of properties to index      * @param unique if unique or not      * @param enclosingNodeTypes the enclosing node types      * @param direction the direction      * @return the node just created      * @throws RepositoryException the repository exception      */
specifier|public
specifier|static
name|Node
