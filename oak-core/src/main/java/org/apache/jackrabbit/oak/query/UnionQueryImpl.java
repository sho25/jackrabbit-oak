...
argument_list|)
block|,
comment|// retrieve the original statement from either of the unioned subqueries, i.e., the left one
name|PropertyValues
operator|.
name|newString
argument_list|(
...
block|{
comment|// This would suggest either the sub queries are sorted by index or explicitly by QueryImpl (in case of traversing index)
comment|// So use mergeSorted here.
name|it
operator|=
name|Iterators
operator|.
