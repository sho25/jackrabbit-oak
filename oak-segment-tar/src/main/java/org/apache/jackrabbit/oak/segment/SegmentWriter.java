...
argument_list|()
decl_stmt|;
comment|// FIXME OAK-4445: Collect write statistics: clean this up:
comment|// - It should be possible to switch the statistics on/off. There should be no
comment|// performance penalty when off.
comment|// - Expose via logging and/or MBean?
comment|// - What metrics should we collect? Use the Metrics API!?
comment|// - Decouple this from the SegmentWriter
specifier|private
specifier|static
class|class
name|CompactionStats
...
name|compactNodeStats
decl_stmt|;
comment|/*          * {@code true} iff this is an explicit compaction (vs. an implicit          * and deferred one triggered by a commit referring to an "old" base          * state.          */
specifier|private
specifier|final
name|boolean
name|isCompaction
...
expr_stmt|;
block|}
comment|/*          * The operation caused a deferred compaction iff it accessed the cache.          */
specifier|public
name|boolean
name|isDeferredCompactionOp
parameter_list|()
block|{
return|return
name|cacheHits
