...
argument_list|()
decl_stmt|;
comment|/**      * Cache of recently stored string and template records, used to      * avoid storing duplicates of frequently occurring data.      */
specifier|private
specifier|final
name|Map
argument_list|<
...
specifier|final
name|RecordId
name|finalChildNameId
parameter_list|,
specifier|final
name|RecordId
name|finalPropNamesId
parameter_list|)
block|{
name|RecordId
name|id
...
expr_stmt|;
block|}
comment|// Call flush from outside a synchronized context to avoid
...
condition|)
block|{
comment|// Delayed flush this builder as it was borrowed while flush() was called.
name|builder
operator|.
name|flush
argument_list|()
