...
argument_list|()
expr_stmt|;
name|assertBlobGCMbeanNotActivated
argument_list|()
expr_stmt|;
...
argument_list|()
expr_stmt|;
name|assertBlobGCMbeanActivated
argument_list|()
expr_stmt|;
name|unregisterSegmentNodeStoreService
argument_list|()
...
expr_stmt|;
block|}
comment|/**      * A SharedDataStore service should be registered when the "customBlobStore"      * configuration property is true and a BlobStore service as SharedDataStore available.      */
annotation|@
name|Test
specifier|public
name|void
name|testUseCustomBlobStoreWithSharedBlobStore
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
name|assertSharedDataStoreRegistered
argument_list|(
name|dataStoreBlobStore
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|/**      * A SharedDataStore service should not be registered when the "customBlobStore"      * configuration property is false and a BlobStore service as SharedDataStore available.      */
annotation|@
name|Test
specifier|public
name|void
name|testUseNoCustomBlobStoreWithSharedBlobStore
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
name|assertSharedDataStoreNotRegistered
argument_list|(
name|dataStoreBlobStore
argument_list|)
expr_stmt|;
