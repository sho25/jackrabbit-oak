...
expr_stmt|;
block|}
comment|/**      * Normalize the property name (including namespace remapping).      *      * @param propertyName the property name to normalize      * @return the normalized property name      */
specifier|protected
name|String
