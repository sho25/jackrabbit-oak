...
specifier|public
name|void
name|testSuggestQuerySpecialChars
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|final
name|String
name|higherRankPropValue
init|=
literal|"DD DD DD DD"
decl_stmt|;
specifier|final
name|String
name|exceptionThrowingPropValue
init|=
literal|"DD~@#$%^&*()_+{}\":?><`1234567890-=[]"
decl_stmt|;
specifier|final
...
name|assertTrue
argument_list|(
literal|"There must not be more than 2 suggestions"
argument_list|,
name|count
operator|<=
literal|2
...
specifier|public
name|void
name|emptySuggestWithNothingIndexed
parameter_list|()
throws|throws
name|Exception
block|{
