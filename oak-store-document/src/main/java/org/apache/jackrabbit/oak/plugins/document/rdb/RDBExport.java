...
operator|)
condition|?
literal|"id, modified, hasbinary, deletedonce, cmodcount, modcount, dsize, data, bdata"
else|:
name|columns
expr_stmt|;
name|List
...
name|IOException
argument_list|(
literal|"required columns: id, modified, hasbinary, deletedonce, modcount, cmodcount, data, bdata"
argument_list|)
throw|;
block|}
name|FileInputStream
...
name|println
argument_list|(
literal|"  --columns column-names             column names (comma separated)"
argument_list|)
expr_stmt|;
name|System
operator|.
