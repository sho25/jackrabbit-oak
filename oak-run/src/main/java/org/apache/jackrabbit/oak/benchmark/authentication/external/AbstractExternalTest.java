...
argument_list|)
expr_stmt|;
comment|// TODO OAK-4101 : syncConfig.user().setDynamicMembership(dynamicMembership);
block|}
specifier|protected
specifier|abstract
name|Configuration
...
argument_list|)
expr_stmt|;
comment|//  TODO: enable once OAK-4104 is commited
comment|//            PrincipalConfiguration principalConfiguration = getConfiguration(PrincipalConfiguration.class);
comment|//            if (!(principalConfiguration instanceof CompositePrincipalConfiguration)) {
comment|//                throw new IllegalStateException();
comment|//            } else {
comment|//                PrincipalConfiguration defConfig = checkNotNull(((CompositePrincipalConfiguration) principalConfiguration).getDefaultConfig());
comment|//                bindPrincipalConfiguration((new ExternalPrincipalConfiguration(this)));
comment|//                bindPrincipalConfiguration(defConfig);
comment|//            }
block|}
block|}
specifier|private
