...
expr_stmt|;
block|}
comment|/**      * Puts the file into the staging cache if possible.      * Returns an optional SettableFuture if staged for upload otherwise empty.      *      * @param id the id of the file to be staged      * @param input the file to be staged      * @return An Optional SettableFuture.      */
specifier|public
name|Optional
argument_list|<
name|SettableFuture
...
return|;
block|}
comment|/**      * Create a placeholder in the file system cache folder for the given identifier.      *      * @param id of the file      * @return file handle      */
specifier|private
name|File
name|getFile
parameter_list|(
