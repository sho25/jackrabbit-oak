...
block|}
block|}
comment|// use interpolation search to find the matching entry in this map leaf
name|int
name|shift
init|=
literal|32
...
name|mask
decl_stmt|;
comment|// lower bound on hash values in this map leaf
name|int
name|q
init|=
name|size
...
name|mask
decl_stmt|;
comment|// upper bound on hash values in this map leaf
while|while
condition|(
name|p
operator|<=
...
name|qH
assert|;
comment|// interpolate the most likely index of the target entry
comment|// based on its hash code and the lower and upper bounds
name|int
name|i
init|=
name|p
