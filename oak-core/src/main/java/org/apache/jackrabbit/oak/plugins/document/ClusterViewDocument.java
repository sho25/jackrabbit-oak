...
condition|)
block|{
comment|// prevent an endless loop
break|break;
block|}
block|}
block|}
...
block|}
block|}
comment|/**      * Determine the oldest history entry (to be removed to keep history      * limited to HISTORY_LIMIT)      *       * @param historyMap      */
specifier|private
specifier|static
name|Revision
name|oldestRevision
...
argument_list|(
literal|"previousView must not be null"
argument_list|)
throw|;
block|}
name|String
