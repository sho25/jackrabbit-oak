...
name|name
decl_stmt|;
comment|/**      * Create a new property delegate for an existing parent.      * @param sessionDelegate      * @param parent  parent tree      * @param name  property name      * @return  {@code PropertyDelegate} instance or {@code null} if either {@code parent}      *          does not exist or does not have a property {@code name}.      */
annotation|@
name|CheckForNull
specifier|static
name|PropertyDelegate
