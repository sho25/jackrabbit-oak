...
return|;
block|}
comment|/**      * Create a new {@code PropertyBuilder} from the specified parameters. Depending      * on the {@code isArray} flag this corresponds to      *<pre>{@link #array(org.apache.jackrabbit.oak.api.Type, String)}</pre> or      *<pre>{@link #scalar(org.apache.jackrabbit.oak.api.Type, String)}</pre>.      *      *      *      * @param type type of the {@code PropertyState} instances to be built.      * @param name the name of the state to be built.      * @param isArray      * @return {@code PropertyBuilder} for {@code type}.      */
specifier|public
specifier|static
parameter_list|<
name|T
