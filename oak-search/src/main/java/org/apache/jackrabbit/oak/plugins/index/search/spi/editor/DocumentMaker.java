...
begin_comment
comment|/**  * A {@link DocumentMaker} is responsible for creating an instance of a document D to be indexed.  * For Apache Lucene that would be a Lucene {@code Document}, for Apache Solr that might be a {@code SolrInputDocument}, etc.  */
end_comment
