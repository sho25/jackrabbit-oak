...
name|domain
init|=
name|getDirectDownloadBlobStorageDomain
argument_list|(
name|downloadOptions
operator|.
...
name|NullPointerException
argument_list|(
literal|"Could not determine domain for direct download"
argument_list|)
throw|;
block|}
name|uri
...
name|domain
init|=
name|getDirectUploadBlobStorageDomain
argument_list|(
name|options
operator|.
name|isDomainOverrideIgnored
...
name|NullPointerException
argument_list|(
literal|"Could not determine domain for direct upload"
argument_list|)
throw|;
block|}
name|EnumSet
...
specifier|private
name|String
name|getDefaultBlobStorageDomain
parameter_list|()
block|{
name|String
name|accountName
...
name|format
argument_list|(
literal|"%s.blob.core.windows.net"
argument_list|,
name|accountName
argument_list|)
return|;
...
name|warn
argument_list|(
literal|"Can't generate presigned URI - no Azure domain provided (is Azure account name configured?)"
argument_list|)
expr_stmt|;
return|return
literal|null
