...
name|debug
argument_list|(
literal|"Trying to register SynchronizationMBean"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|debug
argument_list|(
literal|"SynchronizationMBean already registered"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"Cannot register SynchronizationMBean; not yet activated."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"Cannot register SynchronizationMBean; waiting for references to ContentRepository|SecurityProvider."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"Registering SynchronizationMBean"
argument_list|)
expr_stmt|;
name|String
name|idpName
...
name|debug
argument_list|(
literal|"Registration of SynchronizationMBean completed"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|debug
argument_list|(
literal|"Unregistering SynchronizationMBean"
argument_list|)
expr_stmt|;
name|mbeanRegistration
operator|.
...
name|debug
argument_list|(
literal|"Unregister SynchronizationMBean: completed"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|debug
argument_list|(
literal|"Unable to unregister SynchronizationMBean; missing registration."
argument_list|)
expr_stmt|;
block|}
block|}
