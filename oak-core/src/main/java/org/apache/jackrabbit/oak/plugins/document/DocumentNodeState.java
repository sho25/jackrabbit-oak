...
name|bundlingContext
expr_stmt|;
comment|//TODO [bundling] hasChildren optimization
name|this
operator|.
name|hasChildren
operator|=
...
return|;
block|}
comment|//TODO [bundling] Optimize if matcher matches all child
if|if
condition|(
name|max
operator|>
...
expr_stmt|;
block|}
comment|//TODO [bundling] Handle serialization
if|if
condition|(
name|properties
operator|.
...
literal|true
argument_list|,
comment|//TODO Determine child node
name|lastRevision
argument_list|,
name|rootRevision
argument_list|,
