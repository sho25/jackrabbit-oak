...
return|;
block|}
comment|/**      * Get the latest index name object that matches this index base name, and      * is customized.      *      * @param all the list of all indexes      * @return the lastest customized index, or null if none      */
specifier|public
name|IndexName
...
return|;
block|}
comment|/**      * Get the latest product index that matches this index base name.      *      * @param all the list of all indexes      * @return the latest product index, or null if none      */
specifier|public
name|IndexName
