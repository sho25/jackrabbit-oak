...
comment|// state == null&& recoveryLock not held by someone
if|if
condition|(
name|nodeInfo
operator|.
...
name|info
argument_list|(
literal|"Recovering candidates modified in time range : {0}"
argument_list|,
operator|new
name|Object
index|[]
...
parameter_list|)
block|{
comment|// take a lock on the update process by setting the value of the lock to true
name|updateRecoveryLockOnCluster
argument_list|(
name|clusterId
argument_list|,
name|ClusterNodeInfo
operator|.
name|REV_RECOVERY_ON
argument_list|)
expr_stmt|;
name|Iterable
argument_list|<
...
name|debug
argument_list|(
literal|"_lastRev recovery candidates : {}"
argument_list|,
name|suspects
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"Error closing iterable : "
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Set/Unset lock value on the clusterInfo for the clusterId      *       * @param clusterId for which _lastRev recovery operation performed      * @param value the lock value      */
specifier|protected
name|void
name|updateRecoveryLockOnCluster
parameter_list|(
