...
parameter_list|)
function_decl|;
comment|/**      * Returns the password hash for the user with the specified user tree      * or {@code null} if the hash is not accessible for the editing      * session.      *      *      * @param userTree      * @return the password hash or {@code null}.      */
annotation|@
name|CheckForNull
name|String
