...
name|matches
argument_list|(
literal|"Update of root document to _lastRev .* failed. Detected concurrent update"
argument_list|)
condition|)
block|{
comment|// we have to accept this exception to happen
name|end
operator|.
name|countDown
argument_list|()
...
name|assertTrue
argument_list|(
literal|"Background update did not create a journal entry with id "
operator|+
name|id
argument_list|,
name|ns1
