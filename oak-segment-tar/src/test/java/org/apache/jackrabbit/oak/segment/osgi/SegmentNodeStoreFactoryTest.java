...
name|getResourceAsStream
argument_list|(
literal|"/OSGI-INF/metatype/org.apache.jackrabbit.oak.segment.SegmentNodeStoreFactory$Configuration.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|assertTrue
...
name|withReference
argument_list|(
literal|"org.apache.jackrabbit.oak.segment.SegmentNodeStoreFactory$Configuration"
argument_list|)
operator|.
name|check
argument_list|()
