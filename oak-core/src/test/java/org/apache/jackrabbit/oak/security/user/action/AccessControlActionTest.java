...
begin_comment
comment|/**  * Integration tests for the {@code AccessControlAction} with complete security setup  */
end_comment
...
index|[]
block|{
literal|"administrativePrincipalName"
block|}
argument_list|)
decl_stmt|;
return|return
...
specifier|public
name|void
name|testAdministrativePrincipals
parameter_list|()
throws|throws
name|Exception
block|{
