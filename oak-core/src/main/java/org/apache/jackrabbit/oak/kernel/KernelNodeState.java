...
name|value
decl_stmt|;
comment|// TODO properly handle property types not covered by JSON: Binary, double, decimal, date, name, path, (weak)ref, uri
if|if
condition|(
name|reader
operator|.
...
argument_list|()
decl_stmt|;
comment|// TODO: property deal with different number types (double, BigDecimal)
if|if
condition|(
name|number
operator|.
...
condition|)
block|{
comment|// TODO: deal with other property types
name|value
operator|=
name|valueFactory
operator|.
