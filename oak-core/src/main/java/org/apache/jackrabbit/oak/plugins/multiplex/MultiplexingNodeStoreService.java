...
specifier|public
class|class
name|MultiplexingNodeStoreService
block|{
specifier|private
specifier|static
specifier|final
...
name|context
expr_stmt|;
name|registerMultiplexingNodeStore
argument_list|()
expr_stmt|;
block|}
annotation|@
...
name|info
argument_list|(
literal|"Multiplexing node store registration is deferred until there's a global node store registered in OSGi"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|info
argument_list|(
literal|"Multiplexing node store registration is deferred until there's mount {} registered in OSGi"
argument_list|,
name|m
operator|.
name|getName
...
index|[]
block|{
literal|"nodeStoreType=multiplexing"
block|}
argument_list|)
expr_stmt|;
name|MultiplexingNodeStore
...
name|info
argument_list|(
literal|"Registering the multiplexing node store"
argument_list|)
expr_stmt|;
name|nsReg
operator|=
...
name|info
argument_list|(
literal|"Unregistering the multiplexing node store"
argument_list|)
expr_stmt|;
name|nsReg
operator|.
