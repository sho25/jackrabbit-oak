...
specifier|public
name|void
name|branchAndMerge2
parameter_list|()
block|{
comment|// make sure /trunk doesn't exist in head
name|assertFalse
argument_list|(
name|mk
operator|.
...
argument_list|)
expr_stmt|;
comment|// add a node /trunk in head
name|mk
operator|.
name|commit
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// add a node /trunk/child1 in head
name|mk
operator|.
name|commit
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// add a node /trunk/child1/child2 in branchRev
name|branchRev
operator|=
name|mk
operator|.
...
argument_list|)
expr_stmt|;
comment|// add a node /trunk/child3 in head
name|mk
operator|.
name|commit
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// make sure /trunk/child1/child2 does now exist in head
name|assertTrue
argument_list|(
name|mk
operator|.
...
argument_list|)
expr_stmt|;
comment|// make sure /trunk/child3 still exists in head
name|assertTrue
argument_list|(
name|mk
operator|.
