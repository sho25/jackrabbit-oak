...
return|;
block|}
comment|/**      *      * @param oakPath the Oak path as specified with the ac mgr call.      * @param tree the access controlled node.      * @return the new acl tree.      * @throws RepositoryException if an error occurs      */
annotation|@
name|Nonnull
specifier|private
name|NodeUtil
...
argument_list|(
literal|"Item based principal expected"
argument_list|)
throw|;
block|}
name|String
