...
block|{
comment|// check for child node : there may at most be one child for
...
block|{
comment|// if rep:numPermissions is present it contains the exact number of
comment|// access controlled nodes for the given principal name.
comment|// if this property is missing (backward compat) we use the old
comment|// mechanism and use child-cnt with a max value to get a rough idea
comment|// about the magnitude (note: this approximation ignores the hash-collisions)
name|long
name|l
init|=
name|TreeUtil
