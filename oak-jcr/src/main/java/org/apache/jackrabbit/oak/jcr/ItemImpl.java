...
return|;
block|}
comment|/**      * Determine property type from property definition and default to      * {@code defaultType} in the case of {@link javax.jcr.PropertyType#UNDEFINED}.      *      * @param definition      * @param defaultType      * @return the type determined from the property definition      */
specifier|private
specifier|static
name|int
name|getType
...
block|}
block|}
comment|/**      * Removes all {@code null} values from the given array.      *      * @param values value array      * @return value array without {@code null} entries      */
specifier|private
specifier|static
name|Value
index|[]
...
block|}
block|}
comment|/**      * Create a single value property state given a {@code name}, a {@code value} and a      * property {@code definition}. If the value does not match the property definition      * it is converted accordingly      *      * @param name      * @param value      * @param definition      * @return  single valued property state      * @throws ValueFormatException  if {@code definition} defines a multi valued property      * @throws RepositoryException  if value conversion fails      */
name|PropertyState
...
block|}
block|}
comment|/**      * Create a single value property state given a {@code name}, a {@code type}, a      * {@code value} and a property {@code definition}. If the type does not match the      * property definition it is converted accordingly      *      * @param name      * @param type      * @param values      * @param definition      * @return  array valued property state      * @throws ValueFormatException  if {@code definition} does not define a multi valued property      * @throws RepositoryException  if value conversion fails      */
name|PropertyState
