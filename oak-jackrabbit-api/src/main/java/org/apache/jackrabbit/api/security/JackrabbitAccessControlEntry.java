...
begin_comment
comment|/**  *<code>JackrabbitAccessControlEntry</code> is a Jackrabbit specific extension  * of the<code>AccessControlEntry</code> interface. It represents an single  * entry of a {@link JackrabbitAccessControlList}.  */
end_comment
...
name|AccessControlEntry
block|{
comment|/**      * @return true if this entry adds<code>Privilege</code>s for the principal;      * false otherwise.      */
name|boolean
name|isAllow
parameter_list|()
function_decl|;
