...
name|Exception
block|{
comment|// because of full text search test #testFindRange
...
specifier|public
name|void
name|testGetPrincipalsNonExistingId
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testGetPrincipalsForGroup
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testFindRangeNegativeOffset
parameter_list|()
block|{
name|List
argument_list|<
