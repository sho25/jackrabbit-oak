...
return|;
block|}
comment|/**      * Factory method for creating a {@link SessionDelegate} instance for      * a new session. Called by {@link #login()}. Can be overridden by      * subclasses to customize the SessionDelegate implementation.      *      * @return session context      */
specifier|protected
name|SessionDelegate
name|createSessionDelegate
parameter_list|(
