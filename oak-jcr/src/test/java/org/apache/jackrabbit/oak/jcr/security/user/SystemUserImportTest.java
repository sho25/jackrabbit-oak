...
begin_comment
comment|/**  * Testing system user import with default {@link org.apache.jackrabbit.oak.spi.xml.ImportBehavior}  */
end_comment

begin_class
specifier|public
class|class
name|SystemUserImportTest
extends|extends
...
operator|+
literal|"<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:SystemUser</sv:value></sv:property>"
operator|+
...
argument_list|)
expr_stmt|;
comment|// saving changes of the import -> must succeed. all mandatory props should have been created.
name|s
operator|.
name|save
argument_list|()
...
specifier|public
name|void
name|testImportIntoNonSystemPath
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"</sv:node>"
decl_stmt|;
comment|/*          importing a system user below the regular users-path:          - saving changes must fail with ConstraintViolationEx.          */
name|Session
name|s
init|=
name|getImportSession
...
literal|"</sv:node>"
decl_stmt|;
comment|/*          importing a user with a multi-valued rep:password property          - nonProtected node rep:SystemUser must be created.          - property rep:password must be created regularly without being protected          */
name|Node
name|target
init|=
name|getTargetNode
