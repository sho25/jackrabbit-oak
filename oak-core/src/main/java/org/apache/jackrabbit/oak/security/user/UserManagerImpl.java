...
block|}
comment|//--------------------------------------------------------------------------
comment|/**      *      *      * @param userTree The tree representing the user.      * @param password The plaintext password to set.      * @param forceHash If true the specified password will always be hashed.      * @throws javax.jcr.RepositoryException If an error occurs      */
name|void
name|setPassword
parameter_list|(
name|Tree
...
name|RepositoryException
block|{
comment|// TODO: remove check once user-validator properly enforces that constraint
if|if
condition|(
name|userTree
operator|.
