...
return|;
block|}
comment|/**      * Returns previous {@link NodeDocument}, which include entries for the      * property in the given revision.      * If the<code>revision</code> is<code>null</code>, then all previous      * documents are returned. The returned documents are returned in descending      * revision order (newest first).      *      * @param property the name of a property.      * @param revision the revision to match or<code>null</code>.      * @return previous documents.      */
name|Iterable
argument_list|<
name|NodeDocument
argument_list|>
