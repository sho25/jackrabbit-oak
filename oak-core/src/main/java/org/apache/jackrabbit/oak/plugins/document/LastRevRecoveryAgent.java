...
name|info
argument_list|(
literal|"Active cluster nodes already in the process of being recovered: "
operator|+
name|beingRecoveredRightNow
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Check if _lastRev recovery needed for this cluster node state is Active      *&& currentTime past the leaseEnd time&& recoveryLock not held by someone      */
specifier|private
name|boolean
name|isRecoveryNeeded
parameter_list|(
