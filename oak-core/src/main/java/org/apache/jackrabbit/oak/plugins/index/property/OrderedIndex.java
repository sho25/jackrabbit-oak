...
return|;
block|}
comment|/**          * retrieve an {@code OrderDirection} from a provided String. Will return null in case of no-match          *           * @param direction the direction of the sorting: ascending or descending          * @return the order          */
annotation|@
name|Nullable
annotation|@
name|CheckForNull
