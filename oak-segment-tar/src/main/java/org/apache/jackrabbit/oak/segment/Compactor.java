...
name|getBoolean
argument_list|(
literal|"oak.compaction.eagerFlush"
argument_list|)
decl_stmt|;
static|static
block|{
...
argument_list|()
decl_stmt|;
comment|/**      * Enables content based de-duplication of binaries. Involves a fair amount      * of I/O when reading/comparing potentially equal blobs.      */
specifier|private
specifier|final
name|boolean
name|binaryDedup
decl_stmt|;
comment|/**      * Set the upper bound for the content based de-duplication checks.      */
specifier|private
specifier|final
name|long
name|binaryDedupMaxSize
decl_stmt|;
...
block|}
block|}
comment|/**      * Deduplication cache for blobs. 10% of the total cache size.      */
specifier|private
specifier|final
name|PriorityCache
argument_list|<
...
argument_list|)
decl_stmt|;
comment|/**      * Deduplication cache for nodes. 90% of the total cache size.      */
specifier|private
specifier|final
name|PriorityCache
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// TODO verify binary impact on cache
name|RecordId
name|compactedId
init|=
name|blobCache
...
condition|)
block|{
comment|// alternatively look if the exact same binary has been
comment|// cloned
name|key
operator|=
name|getBlobKey
