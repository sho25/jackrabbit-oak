...
name|hashCode
decl_stmt|;
comment|/**      * Construct a new {@code UnmodifiableAccessControlList}      *      * @param jcrPath The JCR path of this policy.      * @param entries The access control entries contained in this policy.      * @param restrictionProvider The restriction provider.      */
specifier|public
name|ImmutableACL
parameter_list|(
name|String
