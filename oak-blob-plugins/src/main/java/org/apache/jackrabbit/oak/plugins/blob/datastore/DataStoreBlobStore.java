...
argument_list|)
decl_stmt|;
comment|/**      * Flag to determine whether to remove repository id from DataStore on close.      */
specifier|private
specifier|final
name|boolean
name|SHARED_TRANSIENT
init|=
name|Boolean
operator|.
name|parseBoolean
...
name|getProperty
argument_list|(
literal|"oak.datastore.sharedTransient"
argument_list|)
argument_list|)
decl_stmt|;
specifier|protected
...
name|DataStoreException
block|{
comment|// If marked as shared transient then delete the repository marker in close
if|if
condition|(
name|SHARED_TRANSIENT
condition|)
...
name|warn
argument_list|(
literal|"Could not add track id"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**      * Create a BLOB value from in input stream. Small objects will create an in-memory object,      * while large objects are stored in the data store      *      * @param in the input stream      * @param options      * @return the value      */
specifier|private
name|DataRecord
name|writeStream
parameter_list|(
...
return|;
block|}
comment|//<--------------- BlobAccessProvider implementation - Direct binary access feature --------------->
annotation|@
name|Nullable
annotation|@
name|Override
...
name|warn
argument_list|(
literal|"Unable to initiate direct upload"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Unable to complete direct upload for upload token {}"
argument_list|,
name|uploadToken
argument_list|,
name|e
