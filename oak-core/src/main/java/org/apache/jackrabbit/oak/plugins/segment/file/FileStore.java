...
argument_list|)
decl_stmt|;
comment|/**      * Flag to set the compaction on pause.      */
specifier|private
specifier|volatile
name|boolean
...
name|info
argument_list|(
literal|"Estimated compaction in {}ms, gain is {}% ({}/{}), so running compaction"
argument_list|,
operator|new
name|Object
index|[]
...
name|info
argument_list|(
literal|"Estimated compaction in {}ms, gain is {}% ({}/{}), so skipping compaction for now"
argument_list|,
operator|new
name|Object
index|[]
...
name|info
argument_list|(
literal|"TarMK revision cleanup started"
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"TarMK revision cleanup completed in {}ms"
argument_list|,
name|MILLISECONDS
operator|.
name|convert
...
name|info
argument_list|(
literal|"TarMK compaction running"
argument_list|)
expr_stmt|;
name|SegmentWriter
name|writer
