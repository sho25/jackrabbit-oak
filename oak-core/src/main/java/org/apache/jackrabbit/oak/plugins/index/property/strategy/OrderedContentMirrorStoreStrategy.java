...
return|;
block|}
comment|/**      * short-cut for using ChildNodeEntry. See {@code getNext(NodeState)}      */
specifier|static
name|String
name|getPropertyNext
parameter_list|(
