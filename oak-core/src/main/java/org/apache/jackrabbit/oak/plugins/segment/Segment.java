...
name|current
decl_stmt|;
comment|/**      * String records read from segment. Used to avoid duplicate      * copies and repeated parsing of the same strings.      */
specifier|private
specifier|final
name|ConcurrentMap
argument_list|<
...
name|format
argument_list|(
literal|"Segment %s (%d bytes, %d ref%s, %d root%s)%n"
argument_list|,
name|uuid
argument_list|,
name|length
