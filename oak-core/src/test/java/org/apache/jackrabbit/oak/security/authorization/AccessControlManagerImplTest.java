...
block|}
block|}
comment|/**      * // TODO review again      * @since OAK 1.0 : access to privileges needs read access to the corresponding tree.      */
annotation|@
name|Test
specifier|public
name|void
...
name|fail
argument_list|(
literal|"no read access to the privilege store."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// success
block|}
comment|// ensure readability of the privileges
try|try
block|{
name|setupPolicy
argument_list|(
