...
return|;
block|}
comment|/**      * Compares the given {@code state} against the {@code base} state and      * reports the differences as a json diff string.      *      * @param node the state to compare.      * @param base the base state to compare against.      * @return the json diff.      */
name|String
name|diff
parameter_list|(
specifier|final
