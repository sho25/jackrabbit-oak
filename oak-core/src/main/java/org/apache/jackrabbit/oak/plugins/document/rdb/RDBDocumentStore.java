...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA bytea)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA blob)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
block|{
comment|// see
comment|// http://dev.mysql.com/doc/refman/5.5/en/innodb-parameters.html#sysvar_innodb_large_prefix
name|stmt
operator|.
name|execute
argument_list|(
...
name|tableName
operator|+
literal|" (ID varchar(767) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA mediumblob)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED number, HASBINARY number, MODCOUNT number, CMODCOUNT number, DSIZE number, DATA varchar(4000), BDATA blob)"
argument_list|)
expr_stmt|;
block|}
else|else
