...
return|;
block|}
comment|/**      * Returns the set of declared supertype names without 'nt:base', which is      * irrelevant for a diff of supertypes.      *      * @param def a NodeTypeDefinition.      * @return the set of declared supertype names.      */
specifier|private
name|Set
argument_list|<
name|String
