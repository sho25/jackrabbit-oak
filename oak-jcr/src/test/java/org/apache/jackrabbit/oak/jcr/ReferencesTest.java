...
name|fail
argument_list|(
literal|"must fail with ReferentialIntegrityException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|testRecreateWithDifferentUUID
parameter_list|()
throws|throws
name|RepositoryException
block|{
...
specifier|public
name|void
name|testRecreateNonReferenceable
parameter_list|()
throws|throws
name|RepositoryException
block|{
