...
block|}
comment|//--------------------------------------------------< Namespaces>---
comment|// The code below is copied from JCR Commons AbstractSession, but provides information
comment|// the "hasRemappings" information
comment|/**      * Local namespace mappings. Prefixes as keys and namespace URIs as values.      *<p>      * This map is only accessed from synchronized methods (see      *<a href="https://issues.apache.org/jira/browse/JCR-1793">JCR-1793</a>).      */
specifier|private
specifier|final
name|Map
argument_list|<
...
throw|;
block|}
comment|// Add the mapping to the local set, we already know that
comment|// the prefix is not taken
name|namespaces
operator|.
name|put
argument_list|(
...
block|}
block|}
comment|// needed for implementation of NameMapper.hasSessionLocalMappings
specifier|public
name|boolean
