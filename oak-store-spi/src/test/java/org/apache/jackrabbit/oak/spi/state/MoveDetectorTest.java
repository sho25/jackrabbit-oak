...
expr_stmt|;
block|}
comment|/**      * Moving a transiently added node from a moved subtree doesn't generate a move event.      * @throws CommitFailedException      */
annotation|@
name|Test
specifier|public
name|void
name|moveAddedFromMovedSubtree
parameter_list|()
throws|throws
name|CommitFailedException
block|{
...
name|rootBuilder
argument_list|,
literal|"/test/y/z/added"
argument_list|,
literal|"/test/x/added"
argument_list|)
operator|.
name|getNodeState
argument_list|()
