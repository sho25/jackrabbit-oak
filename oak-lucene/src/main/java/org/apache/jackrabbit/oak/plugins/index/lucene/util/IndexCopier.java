...
name|IOException
block|{
comment|//TODO Handle the reindex case. In case of reindex a new directory should be used
name|String
name|subDir
init|=
name|Hashing
...
name|IOException
block|{
comment|//TODO Handle cleanup of orphaned index directory caused by reindex
name|executor
operator|.
name|execute
argument_list|(
