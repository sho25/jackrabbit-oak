...
argument_list|)
expr_stmt|;
comment|// loop until the recommended interval is at 60s (precisionMS)
do|do
block|{
name|rec
operator|=
...
condition|)
do|;
comment|// loop with successful runs (1 node/sec interval deleted) and observe the interval
name|int
name|iterations
init|=
literal|0
...
name|assertTrue
argument_list|(
literal|"VersionGC should have finished after "
operator|+
name|maxiterations
operator|+
literal|" iterations, but did not. Last scope was: "
operator|+
name|rec
operator|.
name|scope
