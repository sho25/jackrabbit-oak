...
name|OpenDataException
function_decl|;
comment|/**      * Provides the name of the result type.      *      * @return A {@code String} representing the name of the result type.      */
specifier|protected
specifier|abstract
name|String
name|getTypeName
...
return|;
block|}
comment|/**      * Utility method for converting the fields associated with a checkpoint to      * the composite data format.      *      * @param type    name of the result type      * @param id      id of the checkpoint      * @param created creation data of the checkpoint      * @param expires expiry data of the checkpoint      * @return composite data representation of the fields associated with the      * checkpoint      * @throws OpenDataException      */
specifier|protected
specifier|static
name|CompositeDataSupport
name|toCompositeData
