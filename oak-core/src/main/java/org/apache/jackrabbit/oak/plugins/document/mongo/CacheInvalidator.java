...
name|root
decl_stmt|;
comment|//TODO Split documents are immutable hence no need to
comment|//check them
comment|//TODO Need to determine way to determine if the
comment|//key is referring to a split document
name|result
operator|.
name|cacheSize
operator|++
...
name|debug
argument_list|(
literal|"Negative cache entry with long path {}. Invalidating"
argument_list|,
name|id
argument_list|)
expr_stmt|;
