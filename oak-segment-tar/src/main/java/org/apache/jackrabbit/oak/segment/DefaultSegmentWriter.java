...
argument_list|)
decl_stmt|;
comment|/**      * Number of updates to child nodes before changes are flushed to disk.      */
specifier|private
specifier|static
specifier|final
name|int
name|CHILD_NODE_UPDATE_LIMIT
init|=
name|Integer
operator|.
name|getInteger
argument_list|(
literal|"child.node.update.limit"
argument_list|,
literal|10000
argument_list|)
decl_stmt|;
