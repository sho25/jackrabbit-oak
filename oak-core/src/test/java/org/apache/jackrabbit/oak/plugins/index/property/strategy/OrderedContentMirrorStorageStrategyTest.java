...
argument_list|)
expr_stmt|;
comment|// equality matching
name|searchfor
operator|=
literal|"2012-11-25T21:00:45.967-07:00"
expr_stmt|;
name|entry
operator|=
literal|"2012-11-25T21%3A00%3A45.967-07%3A00"
expr_stmt|;
name|predicate
operator|=
operator|new
...
name|assertTrue
argument_list|(
literal|"this should have matched the equality flag"
argument_list|,
name|predicate
operator|.
name|apply
...
name|node
decl_stmt|;
comment|// creating a dangling link on each lane one at time.
for|for
control|(
name|int
name|lane
...
control|)
block|{
comment|// ---------------------------------------------------< ascending, plain/inserts case>
name|missingEntry
operator|=
name|KEYS
index|[
...
argument_list|)
expr_stmt|;
comment|// -------------------------------------------------< descending, plain/inserts case>
name|missingEntry
operator|=
name|KEYS
index|[
...
name|assertNull
argument_list|(
literal|"the seeked node does not exist and should have been null. lane: "
operator|+
name|lane
argument_list|,
name|entry
...
name|assertEquals
argument_list|(
literal|"As the index is a NodeBuilder we expect the entry to be fixed. lane: "
operator|+
name|lane
argument_list|,
literal|""
...
expr_stmt|;
block|}
comment|/**      *<p>      * utility method to create the structure for the {@link #oak2077()} test.      *</p>      *<p>      * Create an index according to strategy with nodes from {@code 001} to {@code 004}.      *</p>      *       * @param lane      * @param strategy      * @param missingEntry      * @return the node name with the wrong lane for testing on it later on.      */
specifier|private
specifier|static
name|String
name|oak2077CreateStructure
