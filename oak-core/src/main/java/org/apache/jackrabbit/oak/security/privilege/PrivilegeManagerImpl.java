...
begin_comment
comment|/**  * {@code PrivilegeManager} implementation reading from and storing privileges  * into the repository.  *  * TODO: review if jcr:all should be present in the content as well (updated in the privilege commit validator)  */
end_comment
