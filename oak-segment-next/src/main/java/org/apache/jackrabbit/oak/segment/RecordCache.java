...
parameter_list|)
block|{
comment|// Avoid calling getCache on every invocation.
if|if
condition|(
operator|!
name|generations
...
condition|)
block|{
comment|// The small race here might still result in getCache being called
comment|// more than once. Implementors much take this into account.
name|generations
operator|.
name|putIfAbsent
argument_list|(
