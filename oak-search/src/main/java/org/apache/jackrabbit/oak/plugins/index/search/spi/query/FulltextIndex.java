...
parameter_list|)
function_decl|;
comment|/**      * Whether replaced indexes (that is, if a new version of the index is      * available) should be filtered out.      *       * @return true if yes (e.g. in a blue-green deployment model)      */
specifier|protected
specifier|abstract
name|boolean
...
literal|null
argument_list|,
literal|"The fulltext index of type "
operator|+
name|getType
argument_list|()
operator|+
