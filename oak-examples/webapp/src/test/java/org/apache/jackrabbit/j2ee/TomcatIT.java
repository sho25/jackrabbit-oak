...
parameter_list|)
block|{
comment|// sometimes on jenkins there are connections exceptions.
comment|// ignoring the rest of the test in this case
name|LOG
operator|.
name|error
argument_list|(
literal|"Failed connecting to tomcat"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|replace
argument_list|(
literal|"<param-value>oak/bootstrap.properties</param-value>"
argument_list|,
literal|"<param-value>target/bootstrap.properties</param-value>"
argument_list|)
expr_stmt|;
name|writer
operator|.
