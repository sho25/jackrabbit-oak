...
name|name
decl_stmt|;
comment|// FIXME: should be synchronized, and weak refs
specifier|private
specifier|final
name|Map
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Create a new instance which represents the root of a tree.      * @param store  underlying store to the tree      * @param rootBuilder  builder for the root      * @param listener  change listener for the tree. May be {@code null} if      *                  listening to changes is not needed.      */
name|TreeImpl
parameter_list|(
name|NodeStore
name|store
...
argument_list|(
literal|"Stale NodeStateBuilder for "
operator|+
name|getPath
argument_list|()
argument_list|)
