...
specifier|public
name|void
name|testByDefaultAdminHasNoPwNode
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * import existing user: rep:passwordLastModified must not be updated (unless this property is explicitly included in the xml import)      */
annotation|@
name|Test
specifier|public
name|void
...
block|}
block|}
comment|/**      * import new user: rep:passwordLastModified must be created as it would when calling UserManager.createUser      */
annotation|@
name|Test
specifier|public
name|void
