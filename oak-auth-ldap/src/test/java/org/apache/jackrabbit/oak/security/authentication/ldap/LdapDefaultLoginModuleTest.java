...
begin_comment
comment|/**  * LDAP Login should not only work in the default jaas configuration  *  * LoginModuleImpl SUFFICIENT  * ExternalLoginModule REQUIRED  *  * but also with the jaas configuration specifying the external login module  * first:  *  * ExternalLoginModule SUFFICIENT  * LoginModuleImpl REQUIRED  */
end_comment

begin_class
specifier|public
class|class
name|LdapDefaultLoginModuleTest
extends|extends
