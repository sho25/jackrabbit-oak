...
block|}
block|}
comment|/**      * Suspends until the given revision is visible from the current      * headRevision or the given revision is canceled from the commit queue.      *      * @param r the revision to become visible.      */
name|void
name|suspendUntil
parameter_list|(
annotation|@
