...
parameter_list|()
function_decl|;
comment|/**      * Called by the {@link #registerNamespace(String, String)} and      * {@link #unregisterNamespace(String)} methods to acquire a fresh      * {@link Root} instance that can be used to persist the requested      * namespace changes (and nothing else).      *<p>      * The default implementation of this method throws an      * {@link UnsupportedOperationException}.      *      * @return fresh {@link Root} instance      */
specifier|protected
name|Root
name|getWriteRoot
parameter_list|()
