...
specifier|private
name|boolean
name|presignedDownloadURIVerifyExists
init|=
literal|true
decl_stmt|;
specifier|public
...
name|error
argument_list|(
literal|"Bucket [{}] does not exist in [{}] and was not automatically created"
argument_list|,
name|bucket
argument_list|,
name|s3Region
...
name|error
argument_list|(
literal|"Attempt to create S3 bucket [{}] in [{}] failed"
argument_list|,
name|bucket
argument_list|,
name|s3Region
...
name|debug
argument_list|(
literal|"Binary uploaded to S3 - identifier={}"
argument_list|,
name|key
argument_list|,
operator|new
...
name|debug
argument_list|(
literal|"Binary downloaded from S3 - identifier={}"
argument_list|,
name|key
argument_list|,
operator|new
...
name|debug
argument_list|(
literal|"Queue is empty, but there is more data in the S3 bucket"
argument_list|)
expr_stmt|;
name|loadBatch
argument_list|()
