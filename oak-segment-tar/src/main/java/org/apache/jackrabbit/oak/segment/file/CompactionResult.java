...
return|;
block|}
comment|/**      * @return a predicate determining which segments to {@link      * FileStore.GarbageCollector#cleanup(CompactionResult) clean up} for the      * given compaction result.      */
specifier|abstract
name|Predicate
argument_list|<
name|GCGeneration
