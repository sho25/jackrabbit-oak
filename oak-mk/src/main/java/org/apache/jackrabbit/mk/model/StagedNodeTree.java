...
condition|)
block|{
comment|// added nodes with same name but different content
try|try
block|{
comment|// try to merge the added nodes
name|StagedNode
name|child
init|=
name|stagedNode
...
parameter_list|)
block|{
comment|// should never happen (conflicts are marked in content)
throw|throw
operator|new
...
name|format
argument_list|(
literal|"colliding concurrent node creation: '%s'\n%s"
argument_list|,
name|conflictPath
argument_list|,
name|e
...
return|;
block|}
comment|/**          * Merge the properties and nodes of another node with this node.          *          * @param other other node to be merged with this node.          * @param markConflicts if true, conflicts are marked in content; otherwise an exception is thrown on conflict.          * @throws Exception          */
name|void
name|merge
parameter_list|(
specifier|final
...
name|format
argument_list|(
literal|"property '%s': conflictying values '%s' and '%s'"
argument_list|,
name|propName
argument_list|,
name|oldValue
...
parameter_list|)
block|{
comment|// check if there's already been a conflict
if|if
condition|(
operator|(
name|markConflicts
