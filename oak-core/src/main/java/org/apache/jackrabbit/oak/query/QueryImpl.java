...
condition|)
block|{
comment|// can apply limit and offset directly
name|it
operator|=
operator|new
name|RowIterator
...
block|{
comment|// read and order first; skip and limit afterwards
name|it
operator|=
operator|new
name|RowIterator
...
argument_list|()
expr_stmt|;
comment|// skip the head (this is more efficient than removing
comment|// if there are many entries)
for|for
control|(
name|int
name|i
