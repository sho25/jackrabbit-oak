...
block|}
block|}
comment|/**      * Create a new property2 index definition below the given {@code indexNode}.      *      * @param indexNode      * @param indexDefName      * @param unique      * @param propertyNames      */
specifier|public
specifier|static
name|void
name|createIndexDefinition
