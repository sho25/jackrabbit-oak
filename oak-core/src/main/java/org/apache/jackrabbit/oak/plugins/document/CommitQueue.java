...
block|}
block|}
comment|/**      * Sets the suspend timeout in milliseconds.      * See also {@link #suspendUntil(Revision)}.      *      * @param timeout the timeout to set.      */
name|void
