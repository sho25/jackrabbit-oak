...
name|RemoteTree
block|{
comment|/**      * Read the properties associated to the root of this remote tree. The root      * of this remote tree is represented by the instance of {@code RemoteTree}      * this method is invoked on.      *      * @return the properties associated to the root of this remote tree.      */
name|Map
argument_list|<
name|String
argument_list|,
