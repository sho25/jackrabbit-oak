...
condition|)
block|{
comment|//log.debug("offering segment " + ((SegmentReply) evt).getSegment());
name|segment
operator|.
name|offer
argument_list|(
...
name|error
argument_list|(
literal|"can't wrap segment to output stream"
argument_list|,
name|f
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Closing channel. Got exception: "
operator|+
name|cause
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// implementation of RemoteSegmentLoader
specifier|public
name|Segment
name|getSegment
parameter_list|()
