...
return|;
block|}
comment|// FIXME: This should be based on the secure base state
name|NodeState
name|parentBase
init|=
name|getBaseState
...
parameter_list|)
block|{
comment|// TODO: OAK-753 TreeImpl exposes hidden child trees
comment|// return tree.getNodeState().exists()&& !NodeStateUtils.isHidden(tree.getName());
return|return
name|tree
operator|.
name|getNodeState
