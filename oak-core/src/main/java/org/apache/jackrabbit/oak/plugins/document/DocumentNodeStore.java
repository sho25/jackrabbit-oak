...
name|diffCache
decl_stmt|;
comment|/**      * A fixed size cache for commit values.      */
specifier|private
specifier|final
name|Cache
argument_list|<
...
argument_list|>
name|versionGarbageCollectorSupplier
decl_stmt|;
specifier|private
specifier|final
...
condition|)
block|{
comment|//This is very unexpected situation - parent's child list declares the child to exist, while
comment|//its node state is null. Let's put some extra effort to do some logging
name|String
name|id
init|=
name|Utils
