...
return|;
block|}
comment|/**      * Create a new token node below the specified {@code parent}.      *      * @param parent The parent node.      * @param creationTime The creation time that is used as name hint.      * @return The new token node      * @throws AccessDeniedException      */
specifier|private
name|NodeUtil
name|createTokenNode
parameter_list|(
...
name|debug
argument_list|(
literal|"Failed to create token node "
operator|+
name|tokenName
operator|+
literal|". Using random name as fallback."
argument_list|)
expr_stmt|;
name|root
operator|.
