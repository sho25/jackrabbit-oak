...
block|{
comment|/**          * Invoked whenever a constraint violation is detected.          *           *<p>Implementors may choose to throw a {@link #CommitFailedException} or to handle the error          * internally, for instance by logging.</p>          *           *<p>Implementors may<b>not</b> throw other exception types from this method.</p>          *           * @param path the path where the constraint violation was detected          * @param nodeTypeNames the node type names of the node          * @param code the error code          * @param message the descriptive error mesage          * @throws CommitFailedException thrown when the implementation decides to stop futher processing          *           * @see TypeEditor#THROW_ON_CONSTRAINT_VIOLATION          * @see TypeEditor#WARN_ON_CONSTRAINT_VIOLATION          */
name|void
