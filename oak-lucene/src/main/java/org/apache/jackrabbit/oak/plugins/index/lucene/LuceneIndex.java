...
comment|// throw new IllegalStateException("Lucene index is used even when no full-text conditions are used for filter " + filter);
return|return
name|Collections
operator|.
name|emptySet
...
argument_list|)
expr_stmt|;
name|addFullTextConstraintsOld
argument_list|(
name|qs
argument_list|,
name|filter
...
block|{
comment|// q = new TermQuery(newFulltextTerm(text));
if|if
condition|(
operator|!
name|text
