...
comment|//TODO May be this can be relaxed if we have an index which
comment|//maintains the list of propertyName present in a node say
comment|//against :propNames. Only configured set of properties would
comment|//be
continue|continue;
block|}
...
default|default:
block|{
comment|//TODO Support for pr.like
...
condition|)
block|{
comment|//For property index do not filter on type. If property
comment|//is included then that is sufficient
return|return
literal|false
return|;
block|}
