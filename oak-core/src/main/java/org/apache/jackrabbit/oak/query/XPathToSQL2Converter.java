...
literal|false
decl_stmt|;
comment|// TODO support one node matcher ('*' wildcard), example:
comment|// /jcr:root/content/acme/*/jcr:content[@template='/apps/acme']
comment|// TODO verify '//' is behaving correctly, as specified, example:
comment|// /jcr:root/content/acme//jcr:content[@template='/apps/acme']
while|while
condition|(
literal|true
