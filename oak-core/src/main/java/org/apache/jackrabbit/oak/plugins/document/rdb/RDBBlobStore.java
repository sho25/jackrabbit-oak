...
name|tableName
operator|+
literal|" (ID varbinary(767) not null primary key, LVL int, LASTMOD bigint)"
return|;
block|}
annotation|@
name|Override
...
name|tableName
operator|+
literal|" (ID varbinary(767) not null primary key, DATA mediumblob)"
return|;
block|}
block|}
block|;
...
return|;
block|}
comment|/**          * Table creation statement string for metadata          *          * @param tableName          * @return the table creation string          */
specifier|public
name|String
name|getMetaTableCreationStatement
parameter_list|(
...
return|;
block|}
comment|/**          * Table creation statement string for data          *          * @param tableName          * @return the table creation string          */
specifier|public
name|String
name|getDataTableCreationStatement
parameter_list|(
