...
name|childNames
decl_stmt|;
comment|/**      * {@code true} is this is a node state from a branch. {@code false}      * otherwise.      *<p>      * TODO: this is a workaround to avoid creating branches from a branch      * until this is supported by the MicroKernel. See {@link KernelNodeState#builder()}.      */
specifier|private
name|boolean
name|isBranch
decl_stmt|;
