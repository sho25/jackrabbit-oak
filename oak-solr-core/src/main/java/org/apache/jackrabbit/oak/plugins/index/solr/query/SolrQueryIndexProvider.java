...
expr_stmt|;
block|}
comment|// TODO : need to add index tracking capabilities in order to shutdown SolrServer in case the server node gets deleted
block|}
block|}
return|return
name|tempIndexes
...
parameter_list|)
block|{
comment|// TODO : check if any change has been done on a persisted SSP
block|}
block|}
end_class
