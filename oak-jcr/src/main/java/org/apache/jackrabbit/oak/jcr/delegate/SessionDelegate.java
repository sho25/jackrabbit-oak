...
block|}
block|}
comment|/**      * Save the subtree rooted at the given {@code path}.      *<p>      * This implementation only performs the save if the subtree rooted at {@code path} contains      * all transient changes and will throw an      * {@link javax.jcr.UnsupportedRepositoryOperationException} otherwise.      *      * @param path      * @throws RepositoryException      */
specifier|public
name|void
name|save
parameter_list|(
...
name|SubtreeExcludingValidator
block|{
comment|/**          * Name of the property whose {@link #propertyChanged(PropertyState, PropertyState)} to          * ignore or {@code null} if no property should be ignored.          */
specifier|private
specifier|final
name|String
