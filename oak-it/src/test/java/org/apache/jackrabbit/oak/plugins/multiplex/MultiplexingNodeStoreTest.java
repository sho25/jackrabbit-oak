...
specifier|public
class|class
name|MultiplexingNodeStoreTest
block|{
specifier|private
specifier|final
name|NodeStoreKind
...
specifier|public
name|void
name|childNodeEntryForMountIsMultiplexed
parameter_list|()
block|{
name|ChildNodeEntry
name|libsNode
...
name|assertThat
argument_list|(
literal|"Property must be visible in multiplexed store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Property must be removed from multiplexed store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node must be added to multiplexed store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node must be removed from the multiplexed store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node must be removed from the owning (multiplexed) store"
argument_list|,
name|globalStore
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node apps must have no properties (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node /apps/child1 must exist (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node tmp must have no properties (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node /tmp/build3 must exist (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"/multi-holder/oak:mount-temp should be visible from the multiplexed store"
argument_list|,
name|holderNode
operator|.
name|hasChildNode
...
name|assertTrue
argument_list|(
literal|"/dst/src must exist (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"/tmp/src must exist (multiplexed store)"
argument_list|,
name|store
operator|.
name|getRoot
...
block|{
comment|// expected
comment|// validate that changes were not applied
name|CountingDiff
name|countingDiff
init|=
operator|new
...
name|assertThat
argument_list|(
literal|"Unexpected number of changes"
argument_list|,
name|countingDiff
operator|.
name|getNumChanges
