...
name|error
argument_list|(
literal|"Failed to remove Group "
operator|+
name|createdGroup
operator|.
name|getID
...
comment|//    @Test
comment|//    public void testCreateGroupWithPath() throws RepositoryException, NotExecutableException {
comment|//        Principal p = getTestPrincipal();
comment|//        Group gr = createGroup(p, "/any/path/to/the/new/group");
comment|//        createdGroups.add(gr);
comment|//
comment|//        assertNotNull(gr.getID());
comment|//        assertEquals(p.getName(), gr.getPrincipal().getName());
comment|//        assertFalse("A new group must not have members.",gr.getMembers().hasNext());
comment|//    }
annotation|@
name|Test
specifier|public
