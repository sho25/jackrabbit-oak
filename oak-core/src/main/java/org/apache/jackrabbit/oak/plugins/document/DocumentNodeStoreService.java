...
name|info
argument_list|(
literal|"BlobStore use enabled. DocumentNodeStoreService would be initialized when BlobStore would be available"
argument_list|)
expr_stmt|;
name|blobStoreTracker
operator|=
...
name|info
argument_list|(
literal|"BlobStore services unregistered. Unregistered the DocumentNodeStore"
argument_list|)
expr_stmt|;
name|unregisterNodeStore
argument_list|()
