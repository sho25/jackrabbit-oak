...
expr_stmt|;
block|}
comment|/**      * Creates new download options.      *      * @param mediaType the internet media type for the blob.      * @param characterEncoding the character encoding for the blob.      * @param fileName the file name for the blob.      * @param dispositionType the disposition type.      * @param domainOverrideIgnored true if any configured domain override      *                              should be ignored when generating URIs;      *                              false otherwise.      */
specifier|public
name|BlobDownloadOptions
parameter_list|(
annotation|@
...
return|;
block|}
comment|/**      * Indicates whether the data store should ignore any provided download      * domain override configuration value when generating the signed URI.      *      * @return true if the domain override should be ignored; false otherwise.      */
specifier|public
name|boolean
