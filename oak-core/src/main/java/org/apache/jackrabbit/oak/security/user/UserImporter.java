...
condition|)
block|{
comment|// remove the cache if present
name|protectedParent
operator|.
name|remove
argument_list|()
...
argument_list|)
expr_stmt|;
comment|/* since we ignore the set of failed ids later on and                            don't know the real memberId => use fake memberId as                            value in the map */
name|nonExisting
operator|.
name|put
argument_list|(
