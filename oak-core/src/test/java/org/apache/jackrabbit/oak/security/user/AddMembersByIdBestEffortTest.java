...
expr_stmt|;
block|}
comment|/**      * @since Oak 1.8 : for performance reasons cyclic membership is only check      * within GroupImpl and those import-behaviours that actually resolve the id to a user/group      */
annotation|@
name|Override
annotation|@
name|Test
...
argument_list|()
expr_stmt|;
comment|// cyclic membership must be spotted upon membership resolution
name|assertEquals
argument_list|(
literal|1
argument_list|,
