...
condition|)
block|{
comment|// TODO: The factory should not control repository lifecycle
comment|// See also https://issues.apache.org/jira/browse/OAK-32
name|String
name|dir
decl_stmt|;
if|if
...
block|}
block|}
comment|/**      * Disposes an instance that was created by this factory.      * @param mk MicroKernel instance      */
specifier|public
specifier|static
name|void
name|disposeInstance
