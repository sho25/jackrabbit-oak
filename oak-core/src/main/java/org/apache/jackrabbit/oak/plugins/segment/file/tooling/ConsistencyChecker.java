...
name|debugInterval
decl_stmt|;
comment|/**      * Run a consistency check.      *      * @param directory  directory containing the tar files      * @param journalFileName  name of the journal file containing the revision history      * @param fullTraversal    full traversal consistency check if {@code true}. Only try      *                         to access the root node otherwise.      * @param debugInterval    number of seconds between printing progress information to      *                         the console during the full traversal phase.      * @return  the latest consistent revision out of the revisions listed in the journal.      * @throws IOException      */
specifier|public
specifier|static
name|String
...
name|print
argument_list|(
literal|"Searched through {} of {} revisions"
argument_list|,
name|revisionCount
argument_list|,
name|revisions
...
expr_stmt|;
block|}
comment|/**      * Check whether the nodes and all its properties of all given      * {@code paths} are consistent at the given {@code revision}.      *      * @param revision  revision to check      * @param paths     paths to check      * @return  Path of the first inconsistency detected or {@code null} if none.      */
specifier|public
name|String
name|check
parameter_list|(
...
name|propertyCount
decl_stmt|;
comment|/**      * Travers the given {@code revision}      * @param revision  revision to travers      */
specifier|public
name|String
name|traverse
parameter_list|(
