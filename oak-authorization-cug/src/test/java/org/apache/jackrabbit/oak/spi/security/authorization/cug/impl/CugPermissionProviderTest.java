...
argument_list|)
expr_stmt|;
comment|// path below supported-path but which never contains a cug
name|PATH_INCUG_MAP
operator|.
name|put
argument_list|(
...
name|put
argument_list|(
literal|"/content/no/cug/in/subtree"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testSupportedPermissionsByNonExistingVersionTree
parameter_list|()
block|{
name|Tree
name|versionTree
...
name|root
argument_list|,
literal|"/path/to/no-existing/tree"
argument_list|)
argument_list|,
name|Permissions
operator|.
...
specifier|public
name|void
name|testSupportedPermissionsByNullLocation
parameter_list|()
block|{
name|Tree
name|t
...
try|try
block|{
comment|// additionally create a root that doesn't have access to the root node
name|Root
name|anonymousRoot
init|=
name|anonymous
...
specifier|public
name|void
name|testGetPrivilegesWithInvalidCugTree
parameter_list|()
block|{
name|Tree
name|invalidCug
...
specifier|public
name|void
name|testHasPrivilegesNonExistingVersionTree
parameter_list|()
block|{
name|Tree
name|versionTree
...
argument_list|)
expr_stmt|;
comment|// jcr:system special case
name|TreePermission
name|jcrSystemTp
init|=
name|cugPermProvider
...
specifier|public
name|void
name|testGetTreePermissionNonExistingVersionTree
parameter_list|()
block|{
name|Tree
name|versionTree
...
specifier|public
name|void
name|testIsGrantedJcrActionsNonExistingPath
parameter_list|()
block|{
name|String
name|p
...
specifier|public
name|void
name|testIsAllowMissingPrincipalNames
parameter_list|()
block|{
name|Tree
name|cugTree
