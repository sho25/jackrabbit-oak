...
block|}
block|}
comment|/**      * Persist the pending changes to _lastRev to the given store. This method      * does not guarantee consistency when there are concurrent updates on      * this instance through {@link #put(String, Revision)}. The caller must      * use proper synchronization to ensure no paths are added while this method      * is called.      *      * @param store the document node store.      */
specifier|public
name|void
name|persist
parameter_list|(
