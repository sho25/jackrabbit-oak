...
name|nodeType
decl_stmt|;
comment|/**      *  The value prefix, or null if not set.      */
specifier|private
name|String
name|valuePrefix
decl_stmt|;
...
name|first
decl_stmt|;
comment|/**          * Whether only values bigger than the first value should be returned.          */
specifier|public
name|boolean
name|firstExcluding
decl_stmt|;
...
name|last
decl_stmt|;
comment|/**          * Whether only values smaller than the last value should be returned.          */
specifier|public
name|boolean
name|lastExcluding
decl_stmt|;
