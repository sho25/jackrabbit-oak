...
argument_list|()
decl_stmt|;
comment|// deliberately put the 'rep:members' before the 'rep:authorizableId' to cover OAK-2367
name|String
name|xml
init|=
literal|"<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
...
literal|"<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:AuthorizableFolder</sv:value></sv:property>"
operator|+
literal|"<sv:node sv:name=\"g_different\">"
operator|+
literal|"<sv:property sv:name=\"jcr:primaryType\" sv:type=\"Name\"><sv:value>rep:Group</sv:value></sv:property>"
operator|+
literal|"<sv:property sv:name=\"jcr:uuid\" sv:type=\"String\"><sv:value>0120a4f9-196a-3f9e-b9f5-23f31f914da7</sv:value></sv:property>"
...
literal|"</sv:value></sv:property>"
operator|+
literal|"<sv:property sv:name=\"rep:authorizableId\" sv:type=\"String\"><sv:value>g1</sv:value></sv:property>"
operator|+
literal|"</sv:node>"
operator|+
literal|"</sv:node>"
...
argument_list|()
argument_list|,
literal|"GroupImportTest-testImportGroupMembersFromNodes.xml"
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|()
argument_list|,
literal|"GroupImportTest-testImportGroupMembersFromOakNodes.xml"
argument_list|)
expr_stmt|;
if|if
condition|(
