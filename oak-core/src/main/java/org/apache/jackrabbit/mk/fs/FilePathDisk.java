...
return|;
block|}
comment|/**      * Call the garbage collection and run finalization. This close all files that      * were not closed, and are no longer referenced.      */
specifier|static
name|void
name|freeMemoryAndFinalize
parameter_list|()
block|{
name|Runtime
name|rt
