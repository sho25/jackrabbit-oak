...
block|}
block|}
comment|// OAK-1965: let's see if we can find a (x='...' OR y='...')
comment|// constraint where both x and y are covered by this index
comment|// TODO: avoid repeated scans through the constraints
for|for
control|(
name|ConstraintImpl
name|constraint
...
return|;
block|}
comment|/**      * Checks whether the given dynamic operand is a property      * covered by this index.      */
specifier|private
name|boolean
name|isIndexed
parameter_list|(
