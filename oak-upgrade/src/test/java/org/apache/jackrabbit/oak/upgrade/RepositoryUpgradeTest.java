...
condition|)
block|{
comment|// FIXME uncomment once OAK-1731 is fixed
comment|//                    assertNotNull(pDef.getDefaultValues());
comment|//                    assertEquals(1, pDef.getDefaultValues().length);
comment|//                    assertEquals("defaultValue", pDef.getDefaultValues()[0].getString());
break|break;
block|}
name|fail
argument_list|(
literal|"Expected property definition with name \"default\""
argument_list|)
expr_stmt|;
block|}
block|}
