...
condition|)
block|{
comment|// return the first definition with a default primary type
return|return
name|def
return|;
block|}
...
return|;
block|}
comment|/**      * Same as {@link #getDefinition(Iterable, String, javax.jcr.nodetype.NodeType)} but returns      * {@code null} if no matching definition could be found instead of throwing a      * {@code RepositoryException}.      */
specifier|public
name|NodeDefinition
name|getDefinitionOrNull
parameter_list|(
...
decl_stmt|;
comment|// TODO: This may need to be optimized
comment|// TODO: cleanup redundancy with getDefinition(Node, Node)
for|for
control|(
name|NodeType
name|nt
...
literal|true
decl_stmt|;
comment|// TODO: check again if passing null nodeType is legal.
if|if
condition|(
name|nodeType
operator|!=
