...
argument_list|)
expr_stmt|;
comment|//TODO log warning when queue is full
return|return
name|added
return|;
block|}
...
name|debug
argument_list|(
literal|"No IndexNode found for index [{}]. Skipping index entry for [{}]"
argument_list|,
name|doc
operator|.
name|indexPath
...
name|warn
argument_list|(
literal|"Error occurred while indexing node [{}] for index [{}]"
argument_list|,
name|doc
operator|.
name|docPath
