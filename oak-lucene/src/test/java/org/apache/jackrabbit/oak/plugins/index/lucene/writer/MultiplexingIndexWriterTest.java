...
argument_list|)
expr_stmt|;
comment|// delete all dir nodes first
name|getIndexDirNodes
argument_list|()
operator|.
name|stream
...
argument_list|)
expr_stmt|;
comment|// empty index dir doesn't get created during normal indexing
name|writer
operator|=
name|factory
operator|.
...
argument_list|)
expr_stmt|;
comment|// only mount foo must have indexed document
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// both mounts must have 1 document each
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//3. Add another entry in foo mount without reindexing
name|writer
operator|=
name|factory
operator|.
...
argument_list|)
expr_stmt|;
comment|//4. Add another entry in default mount without reindexing
name|writer
operator|=
name|factory
operator|.
