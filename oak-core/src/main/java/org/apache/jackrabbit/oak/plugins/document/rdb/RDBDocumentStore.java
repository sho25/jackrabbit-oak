...
name|tableName
operator|+
literal|" (ID varchar(512) not null primary key, MODIFIED bigint, HASBINARY "
operator|+
literal|"smallint, MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA bytea)"
operator|)
return|;
block|}
block|}
...
name|tableName
operator|+
literal|" (ID varchar(512) not null primary key, MODIFIED number, HASBINARY number,"
operator|+
literal|" MODCOUNT number, CMODCOUNT number, DSIZE number, DATA varchar(4000), BDATA blob)"
operator|)
return|;
block|}
block|}
...
name|tableName
operator|+
literal|" (ID varbinary(512) not null primary key, MODIFIED bigint, HASBINARY "
operator|+
literal|"smallint, MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16000), BDATA mediumblob)"
operator|)
return|;
block|}
annotation|@
...
block|}
block|;
comment|/**          * Gets the data limit in octets          * Default 16384          * @return the limit in octets          */
specifier|public
name|int
name|getDataOctetLimit
parameter_list|()
...
name|tableName
operator|+
literal|" (ID varchar(512) not null primary key, MODIFIED bigint, HASBINARY smallint, "
operator|+
literal|"MODCOUNT bigint, CMODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA blob)"
return|;
block|}
comment|/**          * Instruments the given query to inject the LIMIT or equivalent parameter supported.          *          * @param query the query          * @param limit the limit          * @return the instrumented query string          */
specifier|public
name|String
name|instrumentLimitQuery
parameter_list|(
...
block|{
return|return
literal|"GREATEST(MODIFIED, ?)"
return|;
block|}
comment|/**          * Returns the CONCAT function or its equivalent function or sub-query supported.          *          * @return the concat query string          */
specifier|public
name|String
name|getConcatQueryString
parameter_list|(
...
literal|"_modCount"
decl_stmt|;
comment|/**      * Optional counter for changes to {#NodeDocument.COLLISIONS} map.      */
specifier|private
specifier|static
specifier|final
name|String
...
argument_list|)
expr_stmt|;
comment|/* Perform any db initialization */
if|if
condition|(
operator|!
name|Strings
...
argument_list|()
decl_stmt|;
comment|/* Substitutions required             %1$s - GREATEST or equivalent             %2$s - CONCAT or equivalent         */
name|t
operator|.
name|append
argument_list|(
...
name|append
argument_list|(
literal|" set MODIFIED = %s, HASBINARY = ?, MODCOUNT = ?, CMODCOUNT = ?, DSIZE = DSIZE + ?, "
argument_list|)
operator|.
name|append
argument_list|(
literal|"DATA = %s where ID = ?"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|append
argument_list|(
literal|" set MODIFIED = %s, MODCOUNT = MODCOUNT + 1, DSIZE = DSIZE + ?, DATA = %s where "
operator|+
literal|"ID in ("
argument_list|)
expr_stmt|;
