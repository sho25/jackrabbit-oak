...
return|;
block|}
comment|/**          * Instruct the command to check only the last {@code revisionsCount} revisions.          * This parameter is not required and defaults to {@code 1}.          * @param revisionsCount number of revisions to check.          * @return this builder.          */
specifier|public
name|Builder
...
return|;
block|}
comment|/**          * Attach a repository statistics instance to collect info on nodes          * and properties checked on head.          *          * @param repoStatistics instance to collect statistics          * @return this builder.          */
specifier|public
name|Builder
name|withRepositoryStatistics
parameter_list|(
name|RepositoryStatistics
name|repoStatistics
parameter_list|)
...
decl_stmt|;
name|int
name|headPropertyCount
decl_stmt|;
specifier|public
name|int
name|getHeadNodeCount
parameter_list|()
block|{
return|return
name|headNodeCount
