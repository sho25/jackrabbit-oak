...
argument_list|)
expr_stmt|;
comment|//Here at max a single call should happen for reading child nodes
name|assertThat
argument_list|(
name|counter
operator|.
