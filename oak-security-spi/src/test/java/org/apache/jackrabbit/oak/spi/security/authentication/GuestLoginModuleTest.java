...
specifier|public
name|void
name|testNullLoginReadOnlySubject
parameter_list|()
throws|throws
name|LoginException
block|{
...
argument_list|)
expr_stmt|;
comment|// subject is readonly and credentials cannot be destroyed => loginexception required
name|guestLoginModule
operator|.
name|logout
argument_list|()
...
specifier|public
name|void
name|testCommitWithReadOnlySubject
parameter_list|()
throws|throws
name|Exception
block|{
