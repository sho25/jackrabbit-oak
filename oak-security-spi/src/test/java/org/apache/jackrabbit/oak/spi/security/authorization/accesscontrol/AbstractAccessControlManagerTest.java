...
specifier|public
name|void
name|testGetPrivilegesSessionPrincipalSet
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// getPrivileges(String,Set) for the principals attached to the content session,
comment|// must result in forwarding the call to getPrivilege(String)
name|verify
argument_list|(
name|mgr
argument_list|,
