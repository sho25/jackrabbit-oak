...
return|;
block|}
comment|/**      * A condition that holds for fat sub trees. That is, for child nodes      * of added nodes or removed nodes.      * @return fat tree condition      */
annotation|@
name|Nonnull
specifier|public
name|Condition
