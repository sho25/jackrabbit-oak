...
return|return;
block|}
comment|// Use DFS to traverse segment graph and make sure
comment|// to add each data segment to the data list only
comment|// after all its references were already added
name|log
operator|.
name|debug
argument_list|(
