...
return|;
block|}
comment|/**      * Shortcut for {@code SessionDelegate.getNamePathMapper().getOakPath(jcrPath)}.      *      * @param jcrPath      * @return      * @throws RepositoryException      */
specifier|public
name|String
name|getOakPath
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// TODO: do the checks below belong here?
