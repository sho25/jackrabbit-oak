...
decl_stmt|;
comment|// initialized lazily
comment|/**      * Create the {@code SecureNodeBuilder} for the root node.      *      * @param builder The {@code NodeBuilder} of the root node.      * @param permissionProvider The {@code PermissionProvider} used to evaluation read access.      */
name|SecureNodeBuilder
parameter_list|(
annotation|@
name|NotNull
