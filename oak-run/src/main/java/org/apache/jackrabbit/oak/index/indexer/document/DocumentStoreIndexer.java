...
parameter_list|()
block|{
name|configureTraversalRateEstimator
argument_list|(
name|progressReporter
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Estimated number of entries in flat file store are {}"
argument_list|,
name|entryCount
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Number of entries in flat file store are unknown"
argument_list|)
expr_stmt|;
block|}
for|for
