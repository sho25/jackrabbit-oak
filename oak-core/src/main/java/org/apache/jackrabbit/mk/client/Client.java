...
begin_comment
comment|/**  * Client exposing a<code>MicroKernel</code> interface, that "remotes" commands  * to a server.  *<p/>  * All public methods inside this class are completely synchronized because  * HttpExecutor is not thread-safe.  */
end_comment
...
name|executor
decl_stmt|;
comment|/**      * Create a new instance of this class, given a URL to connect to.      *       * @param url url      * @return micro kernel      */
specifier|public
specifier|static
name|MicroKernel
...
block|}
block|}
comment|/**      * Create a new instance of this class, where every request goes through an HTTP bridge      * before being delivered to a given micro kernel implementation.      *       * @param mk micro kernel       * @return bridged micro kernel      */
specifier|public
specifier|static
name|MicroKernel
