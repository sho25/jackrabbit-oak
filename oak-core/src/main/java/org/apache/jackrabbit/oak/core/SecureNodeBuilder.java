...
return|;
block|}
comment|/**      * This implementation simply delegates back to {@code moveTo} method      * of {@code source} passing the underlying builder for {@code newParent}.      * @param source  source to move to this builder      * @param newName  the new name      * @return      */
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * This implementation simply delegates back to {@code copyTo} method      * of {@code source} passing the underlying builder for {@code newParent}.      * @param source  source to move to this builder      * @param newName  the new name      * @return      */
annotation|@
name|Override
specifier|public
name|boolean
