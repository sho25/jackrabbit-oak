...
block|}
block|}
comment|/**      * Get or open the object. The following prefixes are supported:      *<ul><li>fs: store the binaries in the file system      *</li><li>server: also start the server      *</li></ul>      *      * @param url the url      * @return the object      */
specifier|public
specifier|static
...
case|:
block|{
comment|// TODO is it really required?
comment|// TODO possibly support target position notation
comment|// TODO support copy in wrappers, index,...
name|t
operator|.
name|read
argument_list|(
