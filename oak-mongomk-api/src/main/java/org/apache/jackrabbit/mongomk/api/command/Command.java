...
begin_comment
comment|/**  * The {@code Command} framework provides an way to encapsulate specific actions of the {@link MicroKernel}.  *  *<p>  * It adds some functionality for retries and other non business logic related actions (i.e. logging, performance  * tracking, etc).  *</p>  *  * @see<a href="http://en.wikipedia.org/wiki/Command_pattern">Command Pattern</a>  * @see CommandExecutor  *  * @param<T>  *            The result type of the {@code Command}.  *  * @author<a href="mailto:pmarx@adobe.com>Philipp Marx</a>  */
end_comment
...
parameter_list|>
block|{
comment|// TODO Add postExecute and preExecute; Maybe add AOP but only if Granite moves to OSGi 4.3
