...
name|Observer
block|{
comment|/**      * Observes a content change. See the {@link Observer} class javadocs      * and relevant repository and observer registration details for more      * information on when and how this method gets called.      *      * @param root root state of the repository      * @param info commit information      */
name|void
name|contentChanged
parameter_list|(
annotation|@
