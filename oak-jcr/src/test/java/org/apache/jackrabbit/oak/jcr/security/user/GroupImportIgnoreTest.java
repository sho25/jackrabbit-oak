...
literal|"</sv:node>"
decl_stmt|;
comment|/*         import groups with cyclic membership with with IGNORE.         expected:         - group is imported         - circular membership is ignored         - g is member of g1         - g1 isn't member of g  (circular membership detected)         */
name|doImport
argument_list|(
name|getTargetPath
argument_list|()
...
name|assertEquals
argument_list|(
literal|"Circular membership must be detected"
argument_list|,
operator|!
name|b
argument_list|,
