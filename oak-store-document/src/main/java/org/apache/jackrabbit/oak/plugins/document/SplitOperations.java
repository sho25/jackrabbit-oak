...
name|Long
argument_list|>
name|BINARY_FOR_SPLIT_THRESHOLD
init|=
operator|new
name|Predicate
argument_list|<
...
parameter_list|)
block|{
comment|// only force trigger split for binaries bigger than 4k
return|return
name|input
operator|>
literal|4096
...
name|hasBinaryToSplit
operator||=
name|hasBinaryPropertyForSplit
argument_list|(
name|splitMap
operator|.
name|values
