...
specifier|public
name|void
name|testCanHandleMovedUnsupportedItemBasedSystemUserPrincipal
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// using original principal again -> obtaining from cache without further validation
name|assertTrue
argument_list|(
name|filter
operator|.
...
argument_list|)
expr_stmt|;
comment|// using SystemUserPrincipal without path -> obtaining from cache without further validation
name|assertTrue
argument_list|(
name|filter
operator|.
...
argument_list|)
expr_stmt|;
comment|// path mismatch -> lookup will reveal removed tree and adjust caches
name|assertFalse
argument_list|(
name|filter
operator|.
...
argument_list|)
expr_stmt|;
comment|// using original principal will no longer work
name|assertFalse
argument_list|(
name|filter
operator|.
...
specifier|public
name|void
name|testCanHandlePopulatesCacheUnsupportedSystemUser
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testCanHandleUserPrincipalDoesntHitProvider
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// for a non-system-user principal the principal resolution must never be triggered
name|verify
argument_list|(
name|pp
argument_list|,
