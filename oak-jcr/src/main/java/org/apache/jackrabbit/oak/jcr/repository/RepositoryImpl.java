...
argument_list|()
operator|+
literal|" MountInfoProvider references, expected at most 1."
argument_list|)
throw|;
block|}
comment|//---------------------------------------------------------< Repository>---
...
block|}
block|}
comment|/**      * Predicate which ensures that refresh strategy is invoked only      * if there is no event listeners registered with the session      */
specifier|private
specifier|static
class|class
name|RefreshPredicate
