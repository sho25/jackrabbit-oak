...
parameter_list|)
block|{
comment|// FIXME: should use sessionDelegate.getProperty(oakPath)
comment|// FIXME: avoid converting oak-path to jcr-path and back and to avoid
comment|// FIXME: using jcr-api calls internally.
try|try
block|{
return|return
name|sessionDelegate
