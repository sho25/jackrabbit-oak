...
name|info
argument_list|(
literal|"Custom paths have been specified, checkpoints won't be migrated"
argument_list|)
expr_stmt|;
name|isRemoveCheckpointReferences
operator|=
