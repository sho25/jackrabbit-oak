...
specifier|public
class|class
name|FederatedNodeStoreService
block|{
specifier|private
specifier|static
specifier|final
...
argument_list|)
expr_stmt|;
name|registerFederatedNodeStore
argument_list|()
expr_stmt|;
block|}
annotation|@
...
parameter_list|()
block|{
name|unregisterFederatedNodeStore
argument_list|()
expr_stmt|;
block|}
specifier|private
...
name|info
argument_list|(
literal|"Federated node store registration is deferred until there's a global node store registered in OSGi"
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|info
argument_list|(
literal|"Federated node store registration is deferred until there's mount {} registered in OSGi"
argument_list|,
name|m
operator|.
name|getName
...
index|[]
block|{
literal|"nodeStoreType=federatedStore"
block|}
argument_list|)
expr_stmt|;
name|FederatedNodeStore
...
name|info
argument_list|(
literal|"Registering the federated node store"
argument_list|)
expr_stmt|;
name|nsReg
operator|=
...
name|info
argument_list|(
literal|"Unregistering the federated node store"
argument_list|)
expr_stmt|;
name|nsReg
operator|.
