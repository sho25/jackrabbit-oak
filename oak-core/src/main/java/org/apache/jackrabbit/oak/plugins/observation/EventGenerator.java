...
name|name
decl_stmt|;
comment|/**          * Before state of this node.          */
specifier|private
specifier|final
name|NodeState
name|before
decl_stmt|;
comment|/**          * AFter state of this node.          */
specifier|private
specifier|final
name|NodeState
name|after
...
block|}
block|}
comment|/**          * Factory method for creating {@code EventGenerator} instances of child nodes.          * @param name  name of the child node          * @param before  before state of the child node          * @param after  after state of the child node          */
specifier|private
name|void
name|addChildGenerator
parameter_list|(
