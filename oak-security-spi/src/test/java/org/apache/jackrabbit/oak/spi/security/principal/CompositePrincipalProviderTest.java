...
specifier|public
name|void
name|testGetMembershipPrincipalsUnknown
parameter_list|()
block|{
name|assertTrue
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// NOTE: CompositePrincipalProvider passes 0 offset to the aggregated provider!
name|when
argument_list|(
name|pp
operator|.
