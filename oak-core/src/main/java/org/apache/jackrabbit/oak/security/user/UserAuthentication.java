...
init|=
literal|"passwordExpiryForAdmin"
decl_stmt|;
specifier|private
specifier|final
name|UserConfiguration
...
argument_list|)
expr_stmt|;
comment|// change the password if the credentials object has the UserConstants.CREDENTIALS_ATTRIBUTE_NEWPASSWORD attribute set
if|if
condition|(
...
argument_list|()
decl_stmt|;
comment|// unless PARAM_PASSWORD_EXPIRY_FOR_ADMIN is enabled, the password of the "admin" user never expires
if|if
condition|(
operator|!
name|Utils
