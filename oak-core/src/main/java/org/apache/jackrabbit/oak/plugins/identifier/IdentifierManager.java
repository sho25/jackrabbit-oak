...
init|=
operator|new
name|ReferencePropertyIterable
argument_list|(
name|result
argument_list|,
name|uuid
...
block|}
block|}
comment|/**      * Implements an iterable that is used to collect the paths of the properties from a query result      * that contain a reference to the given uuid.      */
specifier|private
class|class
name|ReferencePropertyIterable
...
condition|)
block|{
comment|// filter by node type if needed
name|Tree
name|tree
init|=
name|root
