...
name|TransientNodeState
block|{
comment|/** Branch this state belongs to */
specifier|private
specifier|final
name|KernelBranch
name|branch
...
name|parent
decl_stmt|;
comment|/**      * Create a new instance representing the root of a branch.      * @param branch  the branch this state belongs to      * @param persistentState  underlying persistent state      */
name|TransientKernelNodeState
parameter_list|(
name|KernelBranch
name|branch
...
expr_stmt|;
block|}
comment|/**      * Create a new instance representing a added node state      * @param branch  the branch the state belongs to      * @param parent  the parent state of the state      * @param name  name of the state      */
specifier|private
name|TransientKernelNodeState
parameter_list|(
name|KernelBranch
...
expr_stmt|;
block|}
comment|/**      * Create a new instance with an underlying persistent state      * @param branch  the branch the state belongs to      * @param persistedState  underlying persistent state      * @param parent  the parent state of the state      * @param name  name of the state      */
specifier|private
name|TransientKernelNodeState
parameter_list|(
name|KernelBranch
