...
block|}
block|}
comment|// initialising the stopwatch.
name|swl
operator|=
operator|new
name|StopwatchLogger
...
condition|)
block|{
comment|// perform extra operations for starting correctly the clock.
name|Set
argument_list|<
name|String
argument_list|>
...
condition|)
block|{
comment|// if not started we will probably won't have processed anything
comment|// tracking down the time spent for the overall process
name|swl
operator|.
name|stop
argument_list|(
...
name|format
argument_list|(
literal|"item added to the index - %s"
argument_list|,
name|getPropertyNames
argument_list|()
argument_list|)
