...
name|hashCode
decl_stmt|;
comment|/**      * Construct a new {@code UnmodifiableAccessControlList}      *      * @param jcrPath      * @param entries      * @param restrictionProvider      */
specifier|public
name|ImmutableACL
parameter_list|(
name|String
...
parameter_list|)
block|{
comment|// failed to retrieve access control entries -> objects are not equal.
block|}
block|}
return|return
literal|false
