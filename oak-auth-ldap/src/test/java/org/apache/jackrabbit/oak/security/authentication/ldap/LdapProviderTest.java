...
parameter_list|()
block|{
comment|//The attribute "mail" is excluded deliberately
return|return
name|createIDP
argument_list|(
operator|new
...
expr_stmt|;
block|}
comment|/**      * Test case to reproduce OAK-3396 where an ldap user entry      * without a uid caused a NullpointerException in LdapIdentityProvider.createUser      */
annotation|@
name|Test
specifier|public
name|void
name|testListUsersWithMissingUid
parameter_list|()
throws|throws
name|Exception
block|{
comment|// the ERRONEOUS_LDIF contains an entry without uid
name|InputStream
name|erroneousDIF
init|=
name|LdapProviderTest
...
argument_list|()
decl_stmt|;
comment|// without the LdapInvalidAttributeValueException a NPE would result here:
while|while
condition|(
name|users
operator|.
...
argument_list|()
decl_stmt|;
comment|// the 'Faulty Entry' of the ERRONEOUS_LDIF should be filtered out
comment|// (by LdapIdentityProvider.listUsers.getNext())
name|assertTrue
argument_list|(
operator|!
name|user
...
literal|"description"
argument_list|,
literal|"Capt. Horatio Hornblower, R.N"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
literal|"mail"
argument_list|,
literal|"hhornblo@royalnavy.mod.uk"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
specifier|private
name|void
name|authenticateValidateInternal
parameter_list|(
name|LdapIdentityProvider
name|idp
parameter_list|,
...
name|assertNotNull
argument_list|(
literal|"User 1 must authenticate (i="
operator|+
name|i
operator|+
literal|")"
...
specifier|public
name|void
name|testAuthenticateValidateFalseFalse
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAuthenticateValidateFalseTrue
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAuthenticateValidateTrueFalse
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAuthenticateValidateTrueTrue
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testAuthenticateCaseInsensitive
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertArrayEquals
argument_list|(
literal|"Array must not contain empty strings"
argument_list|,
operator|new
name|String
index|[]
...
specifier|public
name|void
name|testResolvePrincipalNameUser
parameter_list|()
throws|throws
name|ExternalIdentityException
block|{
...
specifier|public
name|void
name|testResolvePrincipalNameGroup
parameter_list|()
throws|throws
name|ExternalIdentityException
block|{
...
specifier|public
name|void
name|testResolvePrincipalNameForeignExtId
parameter_list|()
throws|throws
name|Exception
block|{
