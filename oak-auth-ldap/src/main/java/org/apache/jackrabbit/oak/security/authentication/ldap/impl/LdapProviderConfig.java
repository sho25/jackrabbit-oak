...
specifier|final
name|int
name|PARAM_ADMIN_POOL_MAX_ACTIVE_DEFAULT
init|=
literal|8
decl_stmt|;
comment|/**      * @see PoolConfig#getMaxActive()      */
...
name|label
operator|=
literal|"Admin pool max active"
argument_list|,
name|description
operator|=
literal|"The max active size of the admin connection pool."
argument_list|,
name|longValue
operator|=
name|PARAM_ADMIN_POOL_MAX_ACTIVE_DEFAULT
...
specifier|final
name|String
name|PARAM_ADMIN_POOL_MAX_ACTIVE
init|=
...
specifier|final
name|int
name|PARAM_USER_POOL_MAX_ACTIVE_DEFAULT
init|=
literal|8
decl_stmt|;
comment|/**      * @see PoolConfig#getMaxActive()      */
...
name|label
operator|=
literal|"User pool max active"
argument_list|,
name|description
operator|=
literal|"The max active size of the user connection pool."
argument_list|,
name|longValue
operator|=
name|PARAM_USER_POOL_MAX_ACTIVE_DEFAULT
...
block|}
block|}
comment|/**      * Defines the configuration of a connection pool. Currently we only define the max size.      * (documentation copied from {@link org.apache.commons.pool.impl.GenericObjectPool})      */
specifier|public
specifier|static
class|class
name|PoolConfig
...
name|append
argument_list|(
literal|", memberOfFilterTemplate='"
argument_list|)
operator|.
name|append
argument_list|(
