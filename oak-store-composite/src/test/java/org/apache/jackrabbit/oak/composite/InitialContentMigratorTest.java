...
specifier|public
name|void
name|noMigrationJcrNamespaces
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Initialize seed
name|NodeStore
name|seed
init|=
operator|new
...
argument_list|()
decl_stmt|;
comment|// Initialize seed content
operator|new
name|InitialContent
argument_list|()
operator|.
...
name|namespaceBuilder
argument_list|,
literal|"http://sling.apache.org/jcr/sling/1.0"
argument_list|,
literal|"sling"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Initialize target to migrate to
name|MemoryNodeStore
name|target
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// Initialize target with a little different namespace
name|targetRootBuilder
operator|=
name|target
operator|.
...
name|targetNamespaceBuilder
argument_list|,
literal|"http://pling.apache.org/jcr/sling/1.0"
argument_list|,
literal|"pling"
argument_list|)
expr_stmt|;
