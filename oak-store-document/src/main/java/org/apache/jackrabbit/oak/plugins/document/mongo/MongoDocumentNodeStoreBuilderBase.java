...
return|;
block|}
comment|/**      * Use the given MongoDB as backend storage for the DocumentNodeStore.      *      * @param db the MongoDB connection      * @return this      * @deprecated use {@link #setMongoDB(MongoClient, String, int)} instead.      */
specifier|public
name|T
name|setMongoDB
parameter_list|(
...
return|;
block|}
comment|/**      * Use the given MongoDB as backend storage for the DocumentNodeStore.      *      * @param db the MongoDB connection      * @return this      * @deprecated use {@link #setMongoDB(MongoClient, String)} instead.      */
specifier|public
name|T
name|setMongoDB
parameter_list|(
...
argument_list|(
literal|"DB must be constructed from MongoClient"
argument_list|)
throw|;
block|}
block|}
