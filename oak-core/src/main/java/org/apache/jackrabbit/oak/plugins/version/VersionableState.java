...
return|;
block|}
comment|/**      * Creates a versionable state for a restore.      *      * @param version the version to restore.      * @param versionable the versionable node.      * @param ntMgr the node type manager.      * @return a versionable state.      */
specifier|static
name|VersionableState
name|forRestore
parameter_list|(
...
block|}
block|}
comment|/**      * Restore the versionable node to the given version.      *      * @return the versionable node.      * @throws CommitFailedException if the operation fails.      */
specifier|public
name|NodeBuilder
name|restore
parameter_list|()
...
expr_stmt|;
comment|// ...
comment|// restoreVersionable(dest, selector.select(history));
block|}
