...
begin_comment
comment|/**  * Test for the hidden {@link TreeConstants#OAK_CHILD_ORDER} property  */
end_comment
...
specifier|public
name|void
name|testChildOrderWithoutPropertyReadAccess
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// verify that properties cannot be read:
name|assertFalse
argument_list|(
name|aTree
operator|.
