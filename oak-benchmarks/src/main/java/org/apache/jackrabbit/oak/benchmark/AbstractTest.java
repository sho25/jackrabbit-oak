...
name|format
argument_list|(
literal|"# %-26.26s       C     min     10%%     50%%     90%%     max       N%s%n"
argument_list|,
name|toString
argument_list|()
argument_list|,
name|statsNamesJoined
argument_list|(
literal|false
argument_list|)
argument_list|)
...
name|format
argument_list|(
literal|"%-28.28s  %6d  %6.0f  %6.0f  %6.0f  %6.0f  %6.0f  %6d"
operator|+
name|statsFormatsJoined
argument_list|(
literal|false
argument_list|)
operator|+
...
expr_stmt|;
block|}
comment|/**      * Names of additional stats which benchmark wants to be reported as part of      * default report. Add required padding to the names to account for stats value      * size      */
specifier|protected
name|String
index|[]
name|statsNames
...
return|;
block|}
comment|/**      * Format string used for additional stats as per {@link java.util.Formatter}      * Example [ "%6d" , "%6.0f" ]      */
specifier|protected
name|String
index|[]
name|statsFormats
...
return|;
block|}
comment|/**      * Stats values which needs to be included in the report      */
specifier|protected
name|Object
index|[]
name|statsValues
