...
argument_list|)
decl_stmt|;
comment|/**      * Controls the number of concurrent tester threads      */
specifier|protected
specifier|static
specifier|final
name|int
...
argument_list|)
decl_stmt|;
comment|/**      * Controls whether fulltext indexing is enabled or disabled. Enabled by default.      */
specifier|protected
specifier|static
specifier|final
name|boolean
...
argument_list|)
decl_stmt|;
comment|/**      * Controls whether to generate random dates in a range      */
specifier|protected
specifier|static
specifier|final
name|boolean
