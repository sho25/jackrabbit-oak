...
name|ValueFormatException
argument_list|(
literal|"All values of a multi-valued property must be of the same type"
argument_list|)
throw|;
block|}
block|}
...
begin_comment
comment|/**      * Determine property type from property definition and default to      * {@code defaultType} in the case of {@link PropertyType#UNDEFINED}.      *      * @param definition      * @param defaultType      * @return the type determined from the property definition      */
end_comment
