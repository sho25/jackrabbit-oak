...
return|;
block|}
comment|/**      * Check if the index definition is fresh of some index has happened      *      * @param definition nodestate for Index Definition      * @return true if index has some indexed content      */
specifier|public
specifier|static
name|boolean
name|hasPersistedIndex
