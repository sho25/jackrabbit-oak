...
name|format
argument_list|(
literal|"[jcr:contains(.,'%s')]"
argument_list|,
name|buildSearchPatternFT
argument_list|(
name|nameHint
argument_list|)
argument_list|)
...
name|format
argument_list|(
literal|"[jcr:like(@rep:principalName,'%s')]"
argument_list|,
name|buildSearchPatternContains
argument_list|(
name|nameHint
argument_list|)
argument_list|)
...
name|append
argument_list|(
literal|" order by @rep:principalName"
argument_list|)
decl_stmt|;
name|Result
name|result
...
argument_list|)
decl_stmt|;
comment|// everyone is injected only in complete set, not on pages
name|boolean
name|noRange
init|=
name|offset
...
name|RepositoryException
argument_list|(
literal|"Failed to retrieve path of group principal "
operator|+
name|getName
argument_list|()
argument_list|)
