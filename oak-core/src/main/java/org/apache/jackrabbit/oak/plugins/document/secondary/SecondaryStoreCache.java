...
decl_stmt|;
name|NodeStateCacheEntry
name|cacheEntryResult
init|=
name|findByMatchingParentLastRev
argument_list|(
name|currentRoot
argument_list|,
name|path
...
block|}
block|}
comment|//TODO Check in tail if rootRevision is not in our maintained list of root
name|knownMissed
operator|.
name|mark
argument_list|()
...
name|root
decl_stmt|;
comment|//Get the parent node state
for|for
control|(
name|String
name|name
...
name|parentNodeState
decl_stmt|;
comment|//So parent state exists and matches the expected revision
if|if
condition|(
name|parentLastRev
operator|.
