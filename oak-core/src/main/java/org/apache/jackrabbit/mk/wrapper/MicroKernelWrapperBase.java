...
return|;
block|}
comment|/**      * Unwrap a wrapped MicroKernel implementation previously created by      * {@link #wrap};      *      * @param wrapper the MicroKernel wrapper to unwrap      * @return the unwrapped instance      * @throws IllegalArgumentException if the specified instance was not      * originally returned by {@link #wrap}.      */
specifier|public
specifier|static
name|MicroKernel
name|unwrap
...
argument_list|(
literal|"wrapper instance was not created by this factory"
argument_list|)
throw|;
block|}
specifier|private
