...
name|trace
argument_list|(
literal|"Skipping task {} as some exception occurred in previous run"
argument_list|,
name|task
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"Error occurred while copying files. Further processing would be skipped"
argument_list|,
name|t
argument_list|)
expr_stmt|;
...
literal|1
argument_list|,
literal|"Completed pending copying task {}"
argument_list|,
name|pendingCopies
argument_list|)
expr_stmt|;
...
name|IOException
argument_list|(
literal|"Error occurred while copying files"
argument_list|,
name|t
argument_list|)
throw|;
...
name|msg
init|=
literal|"CopyOnWrite stats : Skipped copying {} files with total size {}"
decl_stmt|;
if|if
condition|(
name|reindexMode
...
name|trace
argument_list|(
literal|"File listing - Upon completion {}"
argument_list|,
name|Arrays
operator|.
name|toString
