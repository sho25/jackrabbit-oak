...
name|QueryEngineSettingsMBean
block|{
comment|/**      * the flag used to turn on/off the optimisations on top of the {@link org.apache.jackrabbit.oak.query.Query} object.      * {@code -Doak.query.sql2optimisation}      */
specifier|public
specifier|static
specifier|final
name|String
