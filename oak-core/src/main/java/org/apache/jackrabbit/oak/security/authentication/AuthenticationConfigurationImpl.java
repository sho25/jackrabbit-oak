...
argument_list|)
name|String
name|org_apache_jackrabbit_oak_authentication_appName
parameter_list|()
default|default
name|AuthenticationConfiguration
operator|.
...
operator|+
literal|"name if JAAS authentication is managed by Felix JAAS Support with its Global "
operator|+
literal|"Configuration Policy set to 'default'."
argument_list|)
name|String
name|org_apache_jackrabbit_oak_authentication_configSpiName
parameter_list|()
function_decl|;
block|}
specifier|private
