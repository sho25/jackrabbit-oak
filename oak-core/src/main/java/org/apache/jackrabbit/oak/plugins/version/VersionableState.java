...
return|;
block|}
comment|/**      * Creates a frozen node under the version and initializes it with the basic      * frozen properties (jcr:frozenPrimaryType, jcr:frozenMixinTypes and      * jcr:frozenUuid) from the given node. The node must be referenceable.      *      * @return this versionable state.      */
specifier|private
name|VersionableState
name|initFrozen
parameter_list|(
