...
parameter_list|)
block|{
comment|// UPPER(x) implies x is not null
name|operand
operator|.
name|restrict
argument_list|(
...
parameter_list|)
block|{
comment|// "UPPER(x) IN (A, B)" implies x is not null
name|operand
operator|.
name|restrict
argument_list|(
...
parameter_list|)
block|{
comment|// optimizations of the type "lower(upper(x)) = 'x'" are not supported
block|}
annotation|@
name|Override
specifier|public
