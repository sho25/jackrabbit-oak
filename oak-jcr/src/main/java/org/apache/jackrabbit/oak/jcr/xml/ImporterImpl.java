...
name|accessManager
decl_stmt|;
comment|/**      * There are two IdentifierManagers used.      *      * baseStateIdManager - Associated with the initial root on which      *   no modifications are performed      *      * currentStateIdManager - Associated with current root on which all import      *   operations are being performed      *      */
specifier|private
specifier|final
name|IdentifierManager
...
name|definitionProvider
decl_stmt|;
comment|/**      * Set of newly created uuid from nodes which are      * created in this import      */
specifier|private
specifier|final
name|Set
argument_list|<
...
name|pnImporter
decl_stmt|;
comment|/**      * Creates a new importer instance.      * @param absPath  The absolute JCR paths such as passed to the JCR call.      * @param sessionContext The context of the editing session      * @param root The write {@code Root}, which in case of a workspace import      * is different from the {@code Root} associated with the editing session.      * @param initialRoot      * @param uuidBehavior The uuid behavior      * @param isWorkspaceImport {@code true} if this is a workspace import,      * {@code false} otherwise.      * @throws javax.jcr.RepositoryException If the initial validation of the      * path or the state of target node/session fails.      */
specifier|public
name|ImporterImpl
parameter_list|(
name|String
