...
argument_list|)
decl_stmt|;
comment|/**      * Number of {@link #setWorkspaceRootState(NodeState)} calls for which changes      * are kept in memory.      */
specifier|private
specifier|static
specifier|final
name|int
...
name|branch
decl_stmt|;
comment|/** Lazily initialised builder for the root node state of this workspace */
specifier|private
name|NodeStateBuilder
name|workspaceBuilder
decl_stmt|;
comment|/**      * Number of {@link #setWorkspaceRootState(NodeState)} occurred so since the lase      * purge.      */
specifier|private
name|int
name|modCount
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**      * Returns the current root node state of the workspace      * @return root node state      */
annotation|@
name|Nonnull
specifier|public
name|NodeState
...
block|}
block|}
comment|/**      * Returns the node state of the workspace from which      * the current branch was created.      * @return base node state      */
annotation|@
name|Nonnull
specifier|public
name|NodeState
...
return|;
block|}
comment|/**      * Set the node state of the current workspace      *      * @param nodeState  node state representing the modified workspace      */
specifier|public
name|void
...
block|}
block|}
comment|/**      * Lazily initialise the {@code NodeStateBuilder} associated with the      * root node of the current workspace.      * @return      */
specifier|private
