...
return|;
block|}
comment|/**      * Build a read only subject for the {@link #commit(String, CommitHook)} call that makes the      * principals, auth info and the permission provider available to the commit hooks.      *      * @return a new read only subject.      */
specifier|private
name|Subject
name|getCommitSubject
parameter_list|(
