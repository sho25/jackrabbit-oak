...
argument_list|)
decl_stmt|;
comment|/**      * Empty commit information object to be used for<b>external changes</b>. Used as a dummy object when no      * metadata is known (or needed) about a commit.      */
specifier|public
specifier|static
specifier|final
name|CommitInfo
...
expr_stmt|;
block|}
comment|/**      * Creates a commit info for the given session and user and info map.      *  @param sessionId session identifier      * @param userId The user id.      * @param info info map      * @param external indicates if the commit info is from external change      */
specifier|public
name|CommitInfo
parameter_list|(
annotation|@
...
return|;
block|}
comment|/**      * Return a flag indicating whether this is commit info is      * for an external change      *      * @return true if commit info is for an external change      */
specifier|public
name|boolean
name|isExternal
parameter_list|()
