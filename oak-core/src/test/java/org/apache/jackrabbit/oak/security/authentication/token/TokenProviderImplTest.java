...
argument_list|)
decl_stmt|;
comment|// name must not be a uuid which is only used in case of conflict during
comment|// creation which is not expected here.
try|try
block|{
name|UUID
operator|.
...
name|fail
argument_list|(
literal|"UUID-name should only be used in case of conflict"
argument_list|)
expr_stmt|;
block|}
catch|catch
