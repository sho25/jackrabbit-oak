...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA bytea)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA blob)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" (ID varchar(767) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, DSIZE bigint, DATA varchar(16384), BDATA mediumblob)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" set MODIFIED = ?, HASBINARY = ?, MODCOUNT = ?, DSIZE = ?, DATA = ?, BDATA = ? where ID = ?"
decl_stmt|;
if|if
condition|(
name|oldmodcount
...
name|tableName
operator|+
literal|"(ID, MODIFIED, HASBINARY, MODCOUNT, DSIZE, DATA, BDATA) values (?, ?, ?, ?, ?, ?, ?)"
argument_list|)
decl_stmt|;
try|try
block|{
