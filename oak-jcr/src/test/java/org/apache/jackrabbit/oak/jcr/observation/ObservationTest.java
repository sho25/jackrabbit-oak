...
name|fail
argument_list|(
literal|"addEventListener() must fail with RepositoryException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
specifier|public
name|void
name|deepNodeTypeMixinHierarchy
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// create a fresh session here to catch the above new node type definitions
name|observingSession
operator|=
name|createAdminSession
argument_list|()
...
specifier|public
name|void
name|includeAncestorsRemove_WithGlobs
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
name|doIncludeAncestorsRemove_WithGlobs
argument_list|(
name|oef
argument_list|)
expr_stmt|;
...
name|TEST_PATH
operator|+
literal|"/a/b/c/d.jsp/jcr:primaryType"
argument_list|)
operator|&&
name|event
operator|.
...
name|assertTrue
argument_list|(
literal|"didnt get either event"
argument_list|,
name|done
operator|.
name|get
...
name|assertFalse
argument_list|(
literal|"did get unexpected events"
argument_list|,
name|unexpected
operator|.
name|get
...
expr_stmt|;
block|}
comment|/**      * This tests a filter which registers a few paths and then expects      * NOT to get any event if an unrelated parent is removed      */
annotation|@
name|Test
specifier|public
name|void
name|includeAncestorsRemove_Unrelated
parameter_list|()
throws|throws
name|Exception
block|{
name|doIncludeAncestorsRemove_Unrelated
argument_list|(
operator|new
name|String
index|[]
...
index|[]
block|{
literal|"/unrelated/child"
block|,
literal|"/unrelated"
block|,
literal|"/a/b/c/unrelated/child"
block|,
literal|"/a/b/c/unrelated"
block|,
literal|"/a/b/unrelated/child"
block|,
literal|"/a/b/unrelated"
block|,
literal|"/a/unrelated/child"
block|,
literal|"/a/unrelated"
block|,
literal|"/a"
...
index|[]
block|{
literal|"/a/b/c/d/jcr:primaryType"
block|}
argument_list|)
expr_stmt|;
name|doIncludeAncestorsRemove_Unrelated
...
literal|"/a/b/c/unrelated"
block|,
literal|"/a/b/related/unrelatedchild"
block|,
literal|"/a/b/related"
block|,
literal|"/a/unrelated/child"
...
literal|"/unrelated"
block|,
literal|"/a/b/c/related/child"
block|,
literal|"/a/b/c/related"
block|,
literal|"/a/b/related/child"
block|,
literal|"/a/b/related"
block|,
literal|"/a/unrelated/child"
...
literal|"/a/b/unrelated"
block|,
literal|"/a/related/unrelatedchild"
block|,
literal|"/a/related"
block|,
literal|"/a/b"
...
literal|"/a/b/related"
block|,
literal|"/a/related/relatedchild"
block|,
literal|"/a/related"
block|,
literal|"/a/b"
...
index|[]
block|{
literal|"/a/b/c/x.html/jcr:primaryType"
block|}
argument_list|)
expr_stmt|;
name|doIncludeAncestorsRemove_Unrelated
...
name|String
index|[]
name|createAndRemoveNodes
parameter_list|,
name|String
index|[]
name|expectedRemoveNodeEvents
parameter_list|,
name|String
index|[]
name|expectedRemovePropertyEvents
parameter_list|)
throws|throws
name|Exception
block|{
...
decl_stmt|;
name|OakEventFilter
name|filterWithAncestorsRemove
init|=
name|FilterFactory
operator|.
name|wrap
...
expr_stmt|;
name|ExpectationListener
name|listenerWithAncestorsRemove
init|=
operator|new
name|ExpectationListener
argument_list|()
...
expr_stmt|;
name|OakEventFilter
name|filterWithoutAncestorsRemove
init|=
name|FilterFactory
operator|.
name|wrap
...
expr_stmt|;
name|ExpectationListener
name|listenerWithoutAncestorsRemove
init|=
operator|new
name|ExpectationListener
argument_list|()
...
name|assertTrue
argument_list|(
literal|"Unexpected events (listenerWithoutAncestorsRemove): "
operator|+
name|unexpected
argument_list|,
name|unexpected
...
name|assertTrue
argument_list|(
literal|"Missing events (listenerWithoutAncestorsRemove): "
operator|+
name|missing
argument_list|,
name|missing
...
name|assertTrue
argument_list|(
literal|"Unexpected events (listenerWithAncestorsRemove): "
operator|+
name|unexpected
argument_list|,
name|unexpected
...
name|assertTrue
argument_list|(
literal|"Missing events (listenerWithAncestorsRemove): "
operator|+
name|missing
argument_list|,
name|missing
...
name|Expectation
argument_list|(
literal|"/a/b/c is optionally sent depending on filter"
argument_list|)
block|{
annotation|@
name|Override
...
specifier|public
name|void
name|includeRemovedSubtree_Globs
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// the glob is for a jsp - so we should (only) get an event for that
comment|// but only for the properties of d.jsp that get removed, not of removal of d.jsp itself
comment|// as that would again be reported towards the parent of d.jsp which is /a/b/c
name|Node
name|dDotJsp
init|=
name|testNode
...
argument_list|)
expr_stmt|;
comment|// but we're removing /a/b
name|testNode
operator|.
name|getNode
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// and for removal of /e nothing should be generated
name|testNode
operator|.
name|getNode
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// OAK-5096: in OR mode the following event also gets sent:
name|listener
operator|.
name|expect
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * OAK-5096 : new test case for OR mode      */
annotation|@
name|Test
specifier|public
name|void
...
specifier|public
name|void
name|testFileWithGlobs
parameter_list|()
throws|throws
name|Exception
block|{
name|doTestFileWithGlobs
argument_list|(
literal|"/parent/bar/zet.jsp"
argument_list|,
literal|"/parent/bar/zet.jsp"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// OAK-5096 : a specific **/*.jsp test case
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
name|oef
comment|// without includeAncestorsRemove this time
operator|.
name|withNodeTypeAggregate
argument_list|(
operator|new
...
argument_list|)
expr_stmt|;
comment|// OAK-5096 : this is what OAK-5096 is all about: when you change
comment|// the property jcr:content/jcr:data it should be reported with
comment|// identifier of the aggregate - even though it is not in the original glob path
name|jcrContent
operator|.
name|setProperty
argument_list|(
