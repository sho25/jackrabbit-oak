...
name|bundleFilter
decl_stmt|;
comment|//By default shutdown framework if there is a timeout
specifier|private
name|boolean
name|shutdownOnTimeout
init|=
literal|true
decl_stmt|;
specifier|private
name|boolean
name|repositoryCreateDefaultIndexes
init|=
literal|true
decl_stmt|;
specifier|private
...
argument_list|)
decl_stmt|;
comment|//Default 5 minute timeout
specifier|private
name|JNDIConfig
name|jndiConfig
init|=
...
specifier|public
name|void
name|setRepositoryCreateDefaultIndexes
parameter_list|(
name|boolean
name|repositoryCreateDefaultIndexes
parameter_list|)
