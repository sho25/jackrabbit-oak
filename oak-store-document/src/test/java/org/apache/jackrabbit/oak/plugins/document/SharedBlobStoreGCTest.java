...
begin_comment
comment|/**  * Test for gc in a shared data store among heterogeneous oak node stores.  */
end_comment
...
name|debug
argument_list|(
literal|"Running testMarkOnCloned()"
argument_list|)
expr_stmt|;
name|BlobStore
name|blobeStore3
...
argument_list|)
expr_stmt|;
comment|// run the mark phase on other repositories
name|cluster1
operator|.
name|gc
operator|.
...
name|debug
argument_list|(
literal|"Running testGCStatsOnCloned()"
argument_list|)
expr_stmt|;
name|BlobStore
name|blobeStore3
...
argument_list|)
expr_stmt|;
comment|// Only run the mark phase on all the nodes to get the stats
name|cluster1
operator|.
name|gc
operator|.
...
name|warn
argument_list|(
literal|"Error in writing record"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Error in writing record...retrying"
argument_list|,
name|e
argument_list|)
expr_stmt|;
