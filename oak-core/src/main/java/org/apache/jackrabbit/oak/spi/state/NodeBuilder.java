...
parameter_list|)
function_decl|;
comment|/**      * Returns the name values of the named property. The implementation      * is equivalent to the following code, but may be optimized.      *<pre>      * PropertyState property = builder.getProperty(name);      * if (property != null&& property.getType() == Type.NAMES) {      *     return property.getValue(Type.NAMES);      * } else {      *     return null;      * }      *</pre>      *      * @param name property name      * @return name values of the named property, or {@code null}      */
annotation|@
name|CheckForNull
name|Iterable
argument_list|<
