...
specifier|final
name|boolean
name|PROP_DELETED_BLOB_COLLECTION_ENABLED
init|=
literal|false
decl_stmt|;
annotation|@
...
name|label
operator|=
literal|"Actively remove deleted index blobs from blob store"
argument_list|,
name|description
operator|=
literal|"Index blobs are explicitly unique and don't require mark-sweek type collection."
operator|+
literal|"Turning this on would setup early deletion of blobs from blob collection that are deleted"
operator|+
literal|" during indexing."
argument_list|)
specifier|private
specifier|static
specifier|final
name|String
name|PROP_ENABLE_DELETED_BLOB_COLLECTION_DEFINITION
init|=
literal|"enableDeletedBlobsCollection"
decl_stmt|;
specifier|private
name|Whiteboard
name|whiteboard
...
name|info
argument_list|(
literal|"Active blob collector set to NOOP. Enable? {}; blobStore: {}"
argument_list|,
name|PROP_DELETED_BLOB_COLLECTION_ENABLED
argument_list|,
name|blobStore
