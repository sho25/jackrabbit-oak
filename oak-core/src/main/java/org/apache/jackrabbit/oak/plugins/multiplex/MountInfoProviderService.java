...
specifier|final
name|boolean
name|PROP_MOUNT_SUPPORT_FRAGMENT_DEFAULT
init|=
literal|true
decl_stmt|;
annotation|@
...
name|label
operator|=
literal|"Support fragment"
argument_list|,
name|description
operator|=
literal|"If enabled then oak:mount-* nodes will be included to this mount"
argument_list|,
name|boolValue
operator|=
name|PROP_MOUNT_SUPPORT_FRAGMENT_DEFAULT
...
specifier|final
name|String
name|PROP_MOUNT_SUPPORT_FRAGMENT
init|=
literal|"supportFragment"
decl_stmt|;
specifier|private
specifier|final
name|Logger
