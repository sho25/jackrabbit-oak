...
begin_comment
comment|/**  * Tests for ReadOnlyFileStore#collectReferences  */
end_comment

begin_class
specifier|public
class|class
name|ReadOnlyStoreBlobReferencesTest
block|{
annotation|@
name|Rule
specifier|public
...
name|assertEquals
argument_list|(
literal|"Binary should be visible before gc cycle"
argument_list|,
literal|1
argument_list|,
name|actualReferences
...
name|assertEquals
argument_list|(
literal|"Binary should be deleted after gc cycle"
argument_list|,
literal|0
argument_list|,
name|actualReferences
...
name|assertEquals
argument_list|(
literal|"Read only store visible references different"
argument_list|,
name|count
argument_list|,
name|actualReferences
