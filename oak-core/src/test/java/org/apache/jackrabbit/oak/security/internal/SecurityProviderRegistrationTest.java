...
specifier|public
name|void
name|testDeactivateUnregistersMBeans
parameter_list|()
block|{
comment|// activate
name|registration
...
argument_list|)
expr_stmt|;
comment|// validate that registration is not performed
name|SecurityProvider
name|service
init|=
name|context
...
argument_list|)
expr_stmt|;
comment|// register AuthenticationConfiguration to trigger MBean registration
name|AuthenticationConfigurationImpl
name|mockAc
init|=
name|mock
...
argument_list|)
expr_stmt|;
comment|// register required service
name|RestrictionProvider
name|mockRp
init|=
name|mock
...
argument_list|)
expr_stmt|;
comment|// assert that SecurityProvider is registered
name|service
operator|=
name|context
operator|.
...
argument_list|)
expr_stmt|;
comment|// assert that MBean is registered
name|assertThat
argument_list|(
literal|"LoginModuleMBean is not registered"
argument_list|,
name|context
operator|.
name|getService
...
argument_list|)
expr_stmt|;
comment|// manually deactivate, simulate AuthenticationConfiguration going away due to new config for it coming in
name|registration
operator|.
name|deactivate
argument_list|()
expr_stmt|;
comment|// assert that service is now unregistered
name|service
operator|=
name|context
operator|.
...
argument_list|)
expr_stmt|;
comment|// assert that MBean is no longer registered
name|assertThat
argument_list|(
literal|"LoginModuleMBean is still registered"
argument_list|,
name|context
operator|.
name|getService
...
specifier|public
name|void
name|testBindAggregationFilter
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testUnbindAggregationFilter
parameter_list|()
block|{
name|registration
operator|.
...
argument_list|)
expr_stmt|;
comment|// since unbind was called on filter -> no additional calls
name|verify
argument_list|(
name|filter
argument_list|,
...
specifier|public
name|void
name|testMultipleEvaluationFilterFalse
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testMultipleEvaluationFilterTrue
parameter_list|()
throws|throws
name|Exception
block|{
