...
specifier|public
name|void
name|testCreateOrUpdateIsNewFalse
parameter_list|()
block|{
name|String
name|id
...
argument_list|()
operator|+
literal|".testCreateOrUpdateIsNewFalse"
decl_stmt|;
name|super
operator|.
name|ds
...
argument_list|)
expr_stmt|;
comment|// create with isNew==false
name|UpdateOp
name|up
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// has the document been created?
name|NodeDocument
name|nd
init|=
name|super
...
argument_list|()
operator|+
literal|".testInterestingValidIds-"
operator|+
name|test
argument_list|)
decl_stmt|;
...
name|assertTrue
argument_list|(
literal|"failed to insert a document with id '"
operator|+
name|id
operator|+
literal|"' in "
...
argument_list|()
operator|+
literal|".testInterestingInvalidIds-"
operator|+
name|test
argument_list|)
decl_stmt|;
...
parameter_list|)
block|{
comment|// it would be acceptable to reject the delete request due to
comment|// malformed string (for instance, PostgreSQL behaves like that)
block|}
name|UpdateOp
name|up
init|=
