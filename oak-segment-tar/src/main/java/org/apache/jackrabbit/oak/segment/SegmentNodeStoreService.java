...
expr_stmt|;
block|}
comment|/**      * Configures and registers a new SegmentNodeStore instance together will      * all required components. Anything that must be disposed of (like      * registered services or MBeans) will be registered via the      * {@code registration} parameter.      *      * @param context            An instance of {@link ComponentContext}.      * @param blobStore          An instance of {@link BlobStore}. It can be      *                           {@code null}.      * @param statisticsProvider An instance of {@link StatisticsProvider}.      * @param registrations      An instance of {@link Closer}. It will be used      *                           to track every registered service or      *                           component.      * @param whiteboard         An instance of {@link OsgiWhiteboard}. It will      *                           be used to register services in the OSGi      *                           framework.      * @param role               The role of this component. It can be {@code      *                           null}.      * @param descriptors        Determines if repository descriptors related to      *                           discovery services should be registered.      * @return A configured {@link SegmentNodeStore}, or {@code null} if the      * setup failed.      * @throws IOException In case an unrecoverable error occurs.      */
specifier|static
