...
argument_list|(
literal|"document does not have an id: "
operator|+
name|this
argument_list|)
throw|;
...
expr_stmt|;
block|}
comment|// calculate range new range
name|Revision
name|h
init|=
literal|null
...
operator|&&
operator|!
name|referencesOldDocAfterSplit
argument_list|(
name|mainDoc
argument_list|,
name|oldDoc
...
expr_stmt|;
block|}
comment|/**      * Checks if the main document has changes referencing {@code oldDoc} after      * the split.      *      * @param mainDoc the main document before the split.      * @param oldDoc  the old document created by the split.      * @return {@code true} if the main document contains references to the      *         old document after the split; {@code false} otherwise.      */
specifier|private
specifier|static
name|boolean
name|referencesOldDocAfterSplit
