...
begin_comment
comment|/**  * Mechanism for keeping track of time at millisecond accuracy.  *<p>  * As of Oak 1.20, this extends from {@link java.time.Clock}.  */
end_comment
...
literal|0
decl_stmt|;
comment|/**      * Returns the current time in milliseconds since the epoch.      *      * @see System#currentTimeMillis()      * @see java.time.Clock#millis()      * @return current time in milliseconds since the epoch      */
specifier|public
specifier|abstract
name|long
name|getTime
...
argument_list|(
literal|"ZoneIds other than 'Z' are not supported by this clock"
argument_list|)
throw|;
block|}
return|return
