...
return|;
block|}
comment|/**          * @param name          * @return  the state of the property with the given {@code name} or          * {@code null} if if does not exist.          */
specifier|public
name|PropertyState
...
return|;
block|}
comment|/**          * @return  an iterator for all added and modified property states.          */
specifier|public
name|Iterator
argument_list|<
name|PropertyState
...
expr_stmt|;
block|}
comment|/**          * Set the property with the given {@code name} to {@code value} or remove the          * property if {@code value} is {@code null}.          * @param name          * @param value          */
specifier|public
name|void
name|setValue
parameter_list|(
...
block|}
block|}
comment|/**          * Set the property with the given {@code name} to {@code values}.          * @param name          * @param values          */
specifier|public
name|void
name|setValue
parameter_list|(
