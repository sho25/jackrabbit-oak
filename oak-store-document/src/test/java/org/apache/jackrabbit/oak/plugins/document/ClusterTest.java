...
argument_list|)
expr_stmt|;
comment|// using a NOOP RecoveryHandler must prevent use of expired clusterId 1 (OAK-7316)
name|c2
operator|=
name|ClusterNodeInfo
operator|.
...
comment|// must get inactive id (OAK-7316)
name|c1
operator|=
name|ClusterNodeInfo
operator|.
...
argument_list|()
expr_stmt|;
comment|// must acquire same id as before with matching machineId/instanceId
name|c1
operator|=
name|ClusterNodeInfo
operator|.
