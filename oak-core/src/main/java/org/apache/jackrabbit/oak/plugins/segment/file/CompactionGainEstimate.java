...
block|{
comment|/**      * The sampling rate of the compaction estimation process.      * For a value of {@code n} only a random sample containing      * every n-th segment is taken into account for estimating the      * compaction gain.      *<p>      * Defaults to 1.      */
specifier|public
specifier|static
specifier|final
name|int
name|UUID_SAMPLING_RATE
init|=
name|getInteger
argument_list|(
literal|"compaction.estimate.sampling.rate"
argument_list|,
literal|1
argument_list|)
decl_stmt|;
