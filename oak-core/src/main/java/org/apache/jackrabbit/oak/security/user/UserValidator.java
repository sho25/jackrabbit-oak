...
return|;
block|}
comment|/**      * Make sure user and group nodes are located underneath the configured path      * and that path consists of rep:authorizableFolder nodes.      *      * @param node           The node representing a user or group.      * @param pathConstraint The path constraint.      * @throws CommitFailedException If the hierarchy isn't valid.      */
specifier|private
specifier|static
name|void
name|assertHierarchy
