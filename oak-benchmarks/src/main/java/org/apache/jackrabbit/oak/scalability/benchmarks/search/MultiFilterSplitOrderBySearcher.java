...
begin_comment
comment|/**  * Splits the query in {@link org.apache.jackrabbit.oak.scalability.benchmarks.search.MultiFilterOrderBySearcher}  * into multiple queries and unions the results.  */
end_comment
...
name|RepositoryException
block|{
comment|// /jcr:root/LongevitySearchAssets/12345//element(*, ParentType)[(@viewed = 'true')] order
comment|// by @viewed descending
name|StringBuilder
name|statement
init|=
operator|new
