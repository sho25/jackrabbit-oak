...
name|query
init|=
literal|"select [jcr:path] from [nt:base] where isdescendantnode('/test') and contains(*, 'hello')"
decl_stmt|;
name|Iterator
argument_list|<
name|String
...
name|assertQuery
argument_list|(
literal|"SELECT * FROM [nt:unstructured] WHERE ISDESCENDANTNODE('/test') AND CONTAINS(foo, 'bar')"
argument_list|,
name|of
argument_list|(
literal|"/test/a"
...
name|assertQuery
argument_list|(
literal|"SELECT * FROM [nt:unstructured] WHERE ISDESCENDANTNODE('/test') AND NOT CONTAINS(foo, 'bar')"
argument_list|,
name|of
argument_list|(
literal|"/test/b"
...
name|assertQuery
argument_list|(
literal|"SELECT * FROM [nt:unstructured] WHERE ISDESCENDANTNODE('/test') AND CONTAINS(foo, 'bar cat')"
argument_list|,
name|of
argument_list|(
literal|"/test/d"
...
name|assertQuery
argument_list|(
literal|"SELECT * FROM [nt:unstructured] WHERE ISDESCENDANTNODE('/test') AND NOT CONTAINS(foo, 'bar cat')"
argument_list|,
name|of
argument_list|(
literal|"/test/c"
