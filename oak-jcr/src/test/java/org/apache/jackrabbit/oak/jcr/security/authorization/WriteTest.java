...
name|Exception
block|{
comment|/* create a child node below node at 'path' */
name|Node
name|n
init|=
name|superuser
...
block|}
comment|// add 'remove_child_nodes' at 'path
comment|// -> reorder must now succeed
name|allow
argument_list|(
name|path
argument_list|,
