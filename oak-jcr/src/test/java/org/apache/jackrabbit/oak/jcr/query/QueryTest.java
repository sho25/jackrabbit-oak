...
argument_list|()
decl_stmt|;
comment|// for union queries:
comment|// both subqueries use an index
name|assertTrue
argument_list|(
name|isValidQuery
argument_list|(
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] where ischildnode('/') or [jcr:uuid] = 1 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
comment|// no subquery uses an index
name|assertFalse
argument_list|(
name|isValidQuery
argument_list|(
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] where [x] = 1 or [y] = 2 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
comment|// first one does not, second one does
name|assertFalse
argument_list|(
name|isValidQuery
argument_list|(
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] where [jcr:uuid] = 1 or [x] = 2 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
comment|// first one does, second one does not
name|assertFalse
argument_list|(
name|isValidQuery
argument_list|(
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] where [x] = 2 or [jcr:uuid] = 1 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
comment|// queries that possibly use traversal (depending on the join order)
name|assertTrue
argument_list|(
name|isValidQuery
argument_list|(
...
literal|"xpath"
argument_list|,
literal|"/jcr:root/content//*/jcr:content[@jcr:uuid='1'] option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] as [a] inner join [nt:base] as [b] on ischildnode(b, a) "
operator|+
literal|"where [a].[jcr:uuid] = 1 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] as [a] inner join [nt:base] as [b] on ischildnode(a, b) "
operator|+
literal|"where [a].[jcr:uuid] = 1 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
comment|// union with joins
name|assertTrue
argument_list|(
name|isValidQuery
argument_list|(
...
literal|"select * from [nt:base] as [a] inner join [nt:base] as [b] on ischildnode(a, b) "
operator|+
literal|"where ischildnode([a], '/') or [a].[jcr:uuid] = 1 option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertFalse
...
literal|"xpath"
argument_list|,
literal|"//*[@test] option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertFalse
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] option(traversal fail)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
literal|"xpath"
argument_list|,
literal|"//*[@test] option(traversal ok)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
literal|"xpath"
argument_list|,
literal|"//*[@test] option(traversal warn)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] option(traversal ok)"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|JCR_SQL2
argument_list|,
literal|"select * from [nt:base] option(traversal warn)"
argument_list|)
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|relativeNotExistsProperty_New
parameter_list|()
throws|throws
name|Exception
block|{
...
name|query
init|=
literal|"/jcr:root/test//*[not(child/@prop)]"
decl_stmt|;
name|QueryResult
name|r
init|=
...
literal|"/test/two"
argument_list|,
literal|"/test/two/child"
argument_list|,
literal|"/test/one/child"
argument_list|)
decl_stmt|;
while|while
condition|(
...
name|assertTrue
argument_list|(
literal|"These paths not part of result: "
operator|+
name|expected
argument_list|,
name|expected
...
comment|// but the counter index is not always up to date, so we need a loop
for|for
control|(
name|int
name|i
...
break|break;
block|}
comment|// create a few nodes, in case there are not enough nodes
comment|// for the node counter index to be available
name|Node
name|testNode
init|=
name|session
...
argument_list|()
expr_stmt|;
comment|// wait for async indexing (the node counter index is async)
name|Thread
operator|.
name|sleep
argument_list|(
