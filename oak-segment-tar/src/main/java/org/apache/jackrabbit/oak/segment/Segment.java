...
return|;
block|}
comment|/**      * Determine the gc generation a segment from its data. Note that bulk segments don't have      * generations (i.e. stay at 0).      *      * @param data         the date of the segment      * @param segmentId    the id of the segment      * @return  the gc generation of this segment or {@link GCGeneration#NULL} if this is bulk segment.      */
annotation|@
name|Nonnull
specifier|public
specifier|static
