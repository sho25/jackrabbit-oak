...
name|write
argument_list|(
literal|"nodedef>name VARCHAR, label VARCHAR, type VARCHAR, wid VARCHAR, gc INT, t INT, size INT, head BOOLEAN\n"
argument_list|)
expr_stmt|;
for|for
control|(
...
name|println
argument_list|(
literal|"Error accessing segment "
operator|+
name|segment
operator|+
literal|": "
...
name|println
argument_list|(
literal|"Error head graph parsing: "
operator|+
name|e
argument_list|)
expr_stmt|;
