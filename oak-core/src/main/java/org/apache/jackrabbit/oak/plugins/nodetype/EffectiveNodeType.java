...
return|;
block|}
comment|/**      * Calculates the applicable definition for the child node with the      * specified name and node type.      *      * @param nodeName The internal oak name of the child node.      * @param nodeType The target node type of the child.      * @return the applicable definition for the child node with the specified      * name and primary type.      * @throws ConstraintViolationException If no matching definition can be found.      * @throws RepositoryException If another error occurs.      */
specifier|private
name|NodeDefinition
name|getDefinition
parameter_list|(
