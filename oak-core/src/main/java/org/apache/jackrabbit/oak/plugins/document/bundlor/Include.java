...
return|;
block|}
comment|/**      * Matches node name against pattern at given depth.      * Depth here would be 1 based with 0 for root depth      *      * @param nodeName nodeName to match      * @param depth depth in path      * @return true if nodeName matched against pattern at given depth      */
specifier|public
name|boolean
name|match
parameter_list|(
