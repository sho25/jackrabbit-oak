...
init|=
block|{
literal|"/parent/childB1"
block|,
literal|"/parent/}childB2"
block|,
literal|"/parent/{childB3}"
block|,
literal|"/parent/sub/childB4"
block|,
literal|"/parent/sub/}childB5"
block|,
literal|"/parent/sub/{childB6}"
block|,         }
decl_stmt|;
for|for
control|(
...
specifier|public
name|void
name|testIllegalBracketsInPaths
parameter_list|()
throws|throws
name|Exception
block|{
...
init|=
block|{
literal|"/parent/sub/{childB7"
block|,
literal|"/parent/sub/{childB7"
block|,
literal|"/parent/{"
block|,
literal|"/parent/{childA1"
block|,
literal|"/parent/{{childA2"
block|}
decl_stmt|;
for|for
control|(
...
name|assertEquals
argument_list|(
literal|"without local mappings"
argument_list|,
name|path
argument_list|,
name|noLocal
