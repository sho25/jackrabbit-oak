...
return|;
block|}
comment|/**      * Returns the Oak name for the given JCR name, or throws a      * {@link javax.jcr.RepositoryException} if the name is invalid or can      * otherwise not be mapped.      *      * @param jcrName JCR name      * @return Oak name      * @throws javax.jcr.RepositoryException if the name is invalid      */
annotation|@
name|Nonnull
specifier|public
name|String
