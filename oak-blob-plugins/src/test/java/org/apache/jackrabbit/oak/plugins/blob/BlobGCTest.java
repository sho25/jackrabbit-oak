...
name|info
argument_list|(
literal|"Starting gcWithConsistencyCheck()"
argument_list|)
expr_stmt|;
operator|(
operator|(
...
name|info
argument_list|(
literal|"Staring checkConsistencyGlobal()"
argument_list|)
expr_stmt|;
comment|// Setup a different cluster/repository sharing the blob store
name|MemoryBlobStoreNodeStore
...
specifier|public
name|void
name|checkConsistencyGlobalFailureOther
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"Staring checkConsistencyGlobalFailureOther()"
argument_list|)
expr_stmt|;
comment|// Setup a different cluster/repository sharing the blob store
name|MemoryBlobStoreNodeStore
...
specifier|public
name|void
name|checkConsistencyGlobalFailure
parameter_list|()
throws|throws
name|Exception
block|{
