...
name|QueryIndexProvider
block|{
comment|/**      * How often it should check for a new Solr index.      */
specifier|private
specifier|static
specifier|final
name|long
name|NO_INDEX_CACHE_TIMEOUT
init|=
name|TimeUnit
operator|.
name|SECONDS
...
argument_list|()
decl_stmt|;
comment|/**      * The last time when it checked for the existence of a Solr index AND could not find any.      */
specifier|private
specifier|volatile
name|long
...
name|queryIndexes
decl_stmt|;
comment|// Return immediately if there are not any Solr indexes and the cache timeout has not been exceeded
name|long
name|currentTime
init|=
name|System
