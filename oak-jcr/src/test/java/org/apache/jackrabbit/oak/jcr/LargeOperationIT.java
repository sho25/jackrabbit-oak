...
argument_list|)
decl_stmt|;
comment|/** Maximum quotient of non linearity allowed */
specifier|private
specifier|static
specifier|final
name|double
...
literal|1.2
decl_stmt|;
comment|/** Scales for running the tests against */
specifier|private
specifier|static
specifier|final
name|int
...
name|message
operator|+
literal|" The quotients between subsequent operations "
operator|+
literal|"should all be below "
operator|+
name|MAX_QUOTIENT
operator|+
literal|". Quotients: "
...
name|assertMaxQuotient
argument_list|(
literal|"Commit does not scale linearly."
argument_list|,
name|quotients
argument_list|)
expr_stmt|;
...
name|assertMaxQuotient
argument_list|(
literal|"Copy does not scale linearly."
argument_list|,
name|quotients
argument_list|)
expr_stmt|;
...
name|assertMaxQuotient
argument_list|(
literal|"Move does not scale linearly."
argument_list|,
name|quotients
argument_list|)
expr_stmt|;
...
name|assertMaxQuotient
argument_list|(
literal|"Adding siblings does not scale linearly."
argument_list|,
name|quotients
argument_list|)
expr_stmt|;
...
name|assertMaxQuotient
argument_list|(
literal|"Processing pending events does not scale linearly."
argument_list|,
name|quotients
argument_list|)
expr_stmt|;
