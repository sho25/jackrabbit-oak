...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, SIZE bigint, DATA varchar(16384), BDATA bytea)"
argument_list|)
expr_stmt|;
block|}
elseif|else
...
name|tableName
operator|+
literal|" (ID varchar(1000) not null primary key, MODIFIED bigint, HASBINARY smallint, MODCOUNT bigint, SIZE bigint, DATA varchar(16384), BDATA blob)"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|tableName
operator|+
literal|" set MODIFIED = ?, HASBINARY = ?, MODCOUNT = ?, SIZE = ?, DATA = ?, BDATA = ? where ID = ?"
decl_stmt|;
if|if
condition|(
name|oldmodcount
