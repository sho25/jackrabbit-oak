...
argument_list|)
expr_stmt|;
comment|// both revisions have same seenAt revision, must use
comment|// revision timestamp for comparison
name|assertTrue
argument_list|(
name|comp
operator|.
...
argument_list|)
expr_stmt|;
comment|// r0c2 happens before r0c1 because r2c2 is declared before r2c1
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// now there is a range for c2, but the revision is old (before purge
comment|// time, so it must be considered to be in the past
name|assertTrue
argument_list|(
name|comp
operator|.
...
argument_list|)
expr_stmt|;
comment|// same seen-at revision, but rev timestamp c2sync< c3sync
name|assertTrue
argument_list|(
name|comp
operator|.
...
argument_list|)
expr_stmt|;
comment|// older than first range, but after purge timestamp
comment|// -> must return seen-at of first range
name|assertEquals
argument_list|(
operator|new
name|Revision
...
argument_list|)
decl_stmt|;
comment|// some revisions from another cluster node
name|Revision
name|r1
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// null indicates older than earliest range
name|assertNull
argument_list|(
name|comp
operator|.
...
argument_list|)
expr_stmt|;
comment|// r2 is still seen at 0x02
name|assertEquals
argument_list|(
operator|new
name|Revision
...
argument_list|)
expr_stmt|;
comment|// now also r2 is considered old
name|assertNull
argument_list|(
name|comp
operator|.
...
specifier|public
name|void
name|seenAtBeforeFirstRangeAfterPurge
parameter_list|()
block|{
name|RevisionComparator
name|comp
...
argument_list|)
expr_stmt|;
comment|// simulate cluster node 2 is stopped
name|inactive
operator|.
name|put
argument_list|(
...
specifier|public
name|void
name|getMinimumTimestampSingleClusterId
parameter_list|()
block|{
name|Map
argument_list|<
