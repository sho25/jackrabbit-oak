...
expr_stmt|;
block|}
comment|/**      * Test if the ACL code prevents the creation of ACEs for administrative      * principals which have full access anyway.      *      * @since Oak 1.1.1      * @see<a href="https://issues.apache.org/jira/browse/OAK-2158">OAK-2158</a>      */
annotation|@
name|Test
specifier|public
name|void
...
name|fail
argument_list|(
literal|"Adding an ACE for an admin principal should fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
