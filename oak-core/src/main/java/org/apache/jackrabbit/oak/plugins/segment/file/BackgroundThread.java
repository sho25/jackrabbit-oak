...
expr_stmt|;
block|}
comment|/**      * Run a {@code task} in an regular {@code interval} in the background      * (i.e. {@link Thread#MIN_PRIORITY}.      * @param name       name of the thread      * @param interval   interval in milliseconds      * @param task       task to run      * @return  the {@code BackgroundThread} instance running {@code task}.      */
specifier|public
specifier|static
name|BackgroundThread
name|run
...
name|error
argument_list|(
literal|"Unhandled exception in background thread"
argument_list|,
name|e
argument_list|)
expr_stmt|;
