...
return|;
block|}
comment|/**      * Returns a map of all local property changes committed by the current      * cluster node.      *      * @return local changes committed by the current cluster node.      */
annotation|@
name|Nonnull
specifier|private
name|Map
