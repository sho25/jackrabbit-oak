...
condition|)
block|{
comment|// already purged
return|return
name|timestamp
return|;
block|}
comment|// go through all known cluster nodes
for|for
control|(
name|Map
operator|.
...
condition|)
block|{
comment|// range and revision is for current cluster node
comment|// no need to adjust timestamp
continue|continue;
block|}
name|List
argument_list|<
