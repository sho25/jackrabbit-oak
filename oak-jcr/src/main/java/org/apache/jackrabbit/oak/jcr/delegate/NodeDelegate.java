...
comment|// might also need to be removed, but it's probably best to let
comment|// the client take care of that before save(), as it's hard to tell
comment|// whether removing such items really is the right thing to do.
name|Tree
name|typeRoot
init|=
name|sessionDelegate
...
condition|)
block|{
comment|// TODO: Make lock properties reserved / see nt:unstructured
throw|throw
operator|new
name|LockException
argument_list|(
