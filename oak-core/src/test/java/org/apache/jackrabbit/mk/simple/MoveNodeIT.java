...
begin_comment
comment|/**  * Test moving nodes. These tests currently only work against the  * {@link SimpleKernelImpl} implementation as they assume a specific  * ordering of child nodes that isn't guaranteed by the  * {@link MicroKernel} contract.  */
end_comment
...
expr_stmt|;
comment|// } else {
comment|//     assertJournal("+\"/test2/copy\":{\"a\":{},\"b\":{},\"c\":{}}");
comment|// }
block|}
comment|// TODO fix test since it incorrectly expects a specific order of child nodes
annotation|@
