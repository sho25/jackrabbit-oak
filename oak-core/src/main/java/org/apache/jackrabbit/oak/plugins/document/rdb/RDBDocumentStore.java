...
literal|16384
decl_stmt|;
comment|// whether the ID column is a binary type
specifier|private
name|boolean
name|isIdBinary
init|=
...
argument_list|)
decl_stmt|;
comment|// value for modcount used to indicate that the cache entry isn't valid and
comment|// needs to be refetched
specifier|private
specifier|static
specifier|final
name|long
name|NEEDSCACHERELOAD
init|=
name|Long
operator|.
name|MAX_VALUE
...
specifier|final
name|boolean
name|NOCACHERELOADMARKERS
init|=
name|Boolean
operator|.
name|getBoolean
argument_list|(
literal|"org.apache.jackrabbit.oak.plugins.document.rdb.RDBDocumentStore.NOCACHERELOADMARKERS"
argument_list|)
decl_stmt|;
...
name|debug
argument_list|(
literal|"removing needs-reload cache entry for "
operator|+
name|id
argument_list|)
expr_stmt|;
...
name|IllegalStateException
argument_list|(
literal|"illegal modcount value for id "
operator|+
name|update
operator|.
name|getId
...
name|debug
argument_list|(
literal|"needs-reload-marker set for "
operator|+
name|entry
operator|.
name|getKey
