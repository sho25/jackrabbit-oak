...
block|}
block|}
comment|/**      * Default implementation ignores options and delegates to the {@link #writeBlob(InputStream)}      * method.      *      * @param in the input stream to write      * @param options the options to use      * @return      * @throws IOException      */
annotation|@
name|Override
specifier|public
name|String
