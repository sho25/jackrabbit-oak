...
specifier|public
name|void
name|childNodeEntryForMountIsFederated
parameter_list|()
block|{
name|ChildNodeEntry
name|libsNode
...
name|assertThat
argument_list|(
literal|"Property must be visible in federated store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Property must be removed from federated store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node must be added to federated store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node must be removed from the federated store"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node must be removed from the owning (federated) store"
argument_list|,
name|globalStore
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node apps must have no properties (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node /apps/child1 must exist (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertFalse
argument_list|(
literal|"Node tmp must have no properties (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"Node /tmp/build3 must exist (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"/multi-holder/oak:mount-temp should be visible from the federated store"
argument_list|,
name|holderNode
operator|.
name|hasChildNode
...
name|assertTrue
argument_list|(
literal|"/dst/src must exist (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
...
name|assertTrue
argument_list|(
literal|"/tmp/src must exist (federated store)"
argument_list|,
name|store
operator|.
name|getRoot
