...
begin_comment
comment|/**  * {@code NodeStore}-based implementation of the {@link ContentSession} interface.  */
end_comment
...
name|sessionName
decl_stmt|;
comment|/**      * Flag to indicate whether this session is still alive.      * Only accessed from synchronized methods.      */
specifier|private
name|boolean
name|live
init|=
