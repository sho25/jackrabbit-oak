...
block|}
decl_stmt|;
comment|/**      * The 'journal' collection contains documents with consolidated      * diffs for changes performed by a cluster node between two background      * updates.      */
specifier|public
specifier|static
specifier|final
name|Collection
...
block|}
decl_stmt|;
comment|/**      * The 'blobs' collection contains data from the blob store. The method      * {@link #newDocument(DocumentStore)} always throws an      * {@link UnsupportedOperationException} because blobs are not stored as      * {@link Document}s.      */
specifier|public
specifier|static
specifier|final
name|Collection
