...
name|label
operator|=
literal|"Time interval (in seconds) for actively removing deleted index blobs from blob store"
argument_list|,
name|description
operator|=
literal|"Index blobs are explicitly unique and don't require mark-sweep type collection."
operator|+
literal|"This is number of seconds for scheduling clean-up. -1 would disable the functionality."
operator|+
literal|"Cleanup implies purging index blobs marked as deleted earlier during some indexing cycle."
argument_list|)
specifier|private
specifier|static
specifier|final
name|String
name|PROP_NAME_DELETED_BLOB_COLLECTION_DEFAULT_INTERVAL
init|=
literal|"deletedBlobsCollectionInterval"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|info
argument_list|(
literal|"Active blob collector initialized at working dir: {}; deletion interval {} seconds;"
operator|+
literal|"minAge: {}"
argument_list|,
name|blobCollectorWorkingDir
...
name|info
argument_list|(
literal|"Active blob collector set to NOOP. deletionInterval: {} seconds; blobStore: {}"
argument_list|,
name|activeDeletionInterval
argument_list|,
name|blobStore
