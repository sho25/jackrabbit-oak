...
name|info
argument_list|(
literal|"creating new embedded solr server with config: {}"
argument_list|,
name|solrServerConfiguration
argument_list|)
expr_stmt|;
...
name|error
argument_list|(
literal|"cannot load core {}, shutting down embedded Solr.."
argument_list|,
name|coreName
argument_list|,
name|e
...
name|error
argument_list|(
literal|"could not shutdown embedded Solr"
argument_list|,
name|se
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"checking configuration at {}"
argument_list|,
name|solrHomePathFile
operator|.
...
name|IOException
argument_list|(
literal|"could not create nested core directory in solrHomePath/solrCoreName/conf"
argument_list|)
throw|;
block|}
name|String
...
name|IOException
argument_list|(
literal|"a non directory file with the specified name already exists for the given Solr core path'"
operator|+
name|solrCorePathFile
operator|.
name|getAbsolutePath
...
throw|;
block|}
comment|// clean data dir
name|File
name|solrDataPathFile
init|=
operator|new
name|File
argument_list|(
...
name|debug
argument_list|(
literal|"deleting stale lock files"
argument_list|)
expr_stmt|;
name|File
index|[]
...
argument_list|)
expr_stmt|;
comment|// remove eventaul previous lock files (e.g. due to ungraceful shutdown)
if|if
condition|(
name|locks
operator|.
...
name|warn
argument_list|(
literal|"could not stop JettySolrRunner {}"
argument_list|,
name|jettySolrRunner
argument_list|)
expr_stmt|;
