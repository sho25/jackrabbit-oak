...
return|;
block|}
comment|/**      * Applies an update to the nodes cache.      *<p>      * FIXME: ensure consistent cache update.      *      * @param<T> the document type.      * @param collection the document collection.      * @param oldDoc the old document or<code>null</code> if the update is for      *               a new document (insert).      * @param updateOp the update operation.      */
specifier|private
parameter_list|<
name|T
extends|extends
