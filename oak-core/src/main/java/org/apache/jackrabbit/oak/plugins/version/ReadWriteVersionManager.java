...
return|;
block|}
comment|/**      * Creates the root version in the given version history.      *      * @param vHistory the version history node.      * @param versionable the versionable node.      */
specifier|private
name|void
name|createRootVersion
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// incomplete frozen node on root-version (don't call create on versionable-state)
name|VersionableState
operator|.
name|fromVersion
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// set predecessors to base version for the root version
name|versionable
operator|.
name|setProperty
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a version in the given version history. If the given version      * history does not yet have a version, then a root version is created and      * the versionable node is in a checked out state. Otherwise a version is      * created and the versionable node is set to checked in.      *      * @param vHistory the version history node.      * @param versionable the versionable node.      * @throws CommitFailedException if creating the version fails. E.g. because      * the versionable node contains a OPV item with ABORT.      */
specifier|private
name|void
name|createVersion
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// clear predecessors for check-in
name|versionable
operator|.
name|setProperty
argument_list|(
