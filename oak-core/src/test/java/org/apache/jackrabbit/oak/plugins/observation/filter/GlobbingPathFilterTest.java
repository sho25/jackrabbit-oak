...
name|Ignore
argument_list|(
literal|"Manual test for OAK-5589"
argument_list|)
specifier|public
name|void
name|constructorPerformance
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// old version: 5000000 iterations took 33-34sec
comment|// new version: 5000000 iterations took 23-24sec -> ca 25-30% faster
block|}
block|}
end_class
