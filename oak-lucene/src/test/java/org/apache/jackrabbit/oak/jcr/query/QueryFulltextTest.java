...
name|xpath
init|=
literal|"/jcr:root//*[jcr:contains(@text, 'hello') or @id = '1']"
decl_stmt|;
name|Query
name|q
init|=
...
specifier|public
name|void
name|testSurrogateFulltext
parameter_list|()
throws|throws
name|Exception
block|{
name|String
name|surrogateString
init|=
literal|"壱\n"
operator|+
literal|"複数の文字\n"
