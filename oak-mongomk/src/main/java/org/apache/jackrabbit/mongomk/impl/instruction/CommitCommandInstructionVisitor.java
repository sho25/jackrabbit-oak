...
name|branchId
decl_stmt|;
comment|/**      * Creates {@code CommitCommandInstructionVisitor}      *      * @param nodeStore Node store.      * @param baseRevisionId the revision this commit is based on      */
specifier|public
name|CommitCommandInstructionVisitor
parameter_list|(
name|MongoNodeStore
...
return|;
block|}
comment|/**      * Recursively copies nodes from<code>srcNode</code> to      *<code>destPath</code>. This method takes existing nodes as well as      * staged nodes into account.      *      * @param srcNode the source node.      */
specifier|private
name|void
name|copy
parameter_list|(
