...
name|Committer
block|{
comment|/**      * Add nodes to the repository.      *       * @param mk      *            The microkernel that is performing the action.      * @param diff      *            The diff that is commited.All the nodes must be define by      *            their absolute path.      * @param nodesPerCommit      *            Number of nodes per commit.      */
specifier|public
name|void
name|addNodes
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Add an empty node to repository.      *       * @param mk      *            Microkernel that is performing the action.      * @param parentPath      * @param name      *            Name of the node.      */
specifier|public
name|void
name|addNode
parameter_list|(
