...
block|}
block|}
comment|/**      * Create 2 binary nodes with same content but not same reference. Reduce      * the max size if de-duplicated binaries under the binary length. Verify      * de-duplication capabilities of compaction.      */
annotation|@
name|Test
specifier|public
name|void
name|offlineCompactionBinC2
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// not expected to reduce the size too much, as the binaries are
comment|// above the threshold
name|assertSize
argument_list|(
literal|"with compacted binaries"
argument_list|,
