...
literal|100
decl_stmt|;
comment|/**      * A dummy subject used when no subject is provided in the constructor.      */
specifier|private
specifier|static
specifier|final
name|Subject
...
expr_stmt|;
block|}
comment|/**      * TODO remove constructor      *       * New instance bases on a given {@link NodeStore} and a workspace      * @param store  node store      * @param workspaceName  name of the workspace      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"UnusedParameters"
