...
parameter_list|()
function_decl|;
comment|/**          * Get the id of the node at the given path as it was before this change set.          * @param path  path to determine the id for          * @return  id for the item at {@code path} or {@code path} if the item doesn't exit.          */
annotation|@
name|Nonnull
specifier|public
name|String
...
return|;
block|}
comment|/**          * Get the id of the node at the given path as it is after this change set.          * @param path  path to determine the id for          * @return  id for the item at {@code path} or {@code path} if the item doesn't exit.          */
annotation|@
name|Nonnull
specifier|public
name|String
