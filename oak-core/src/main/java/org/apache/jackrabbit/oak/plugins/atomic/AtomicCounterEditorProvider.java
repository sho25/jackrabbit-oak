...
name|error
argument_list|(
literal|"InterruptedException white shutting down ScheduledExecutorService"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"ScheduledExecutorService not yet shutdown. Cancelling tasks and forcing quit."
argument_list|)
expr_stmt|;
block|}
name|ses
