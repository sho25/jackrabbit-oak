...
return|;
block|}
comment|/**      * This implementation delegates to {@link KernelRootBuilder#merge(CommitHook, PostCommitHook)}      * if {@code builder} is a {@link KernelNodeBuilder} instance. Otherwise it throws      * an {@code IllegalArgumentException}.      */
annotation|@
name|Override
specifier|public
name|NodeState
