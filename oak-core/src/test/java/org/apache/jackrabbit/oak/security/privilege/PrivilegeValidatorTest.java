...
name|fail
argument_list|(
literal|"modifying property in privilege store must fail."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"removing property from privilege store must fail."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"removing privilege from privilege store must fail."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"missing priv bits must be detected."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"unknown aggregate must be detected."
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"circular aggregate must be detected."
argument_list|)
expr_stmt|;
block|}
catch|catch
