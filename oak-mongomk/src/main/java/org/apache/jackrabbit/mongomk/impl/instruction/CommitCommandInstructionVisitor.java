...
name|branchId
decl_stmt|;
comment|/**      * Creates {@code CommitCommandInstructionVisitor}      *      * @param nodeStore Node store.      * @param headRevisionId Head revision.      */
specifier|public
name|CommitCommandInstructionVisitor
parameter_list|(
name|MongoNodeStore
...
throw|;
block|}
comment|// Fetch the node without its descendants.
name|FetchNodesAction
name|query
init|=
operator|new
