...
return|;
block|}
comment|/**      * This will simply load the file by blocks of lines, then sort them in-memory, and write the      * result to temporary files that have to be merged later. You can specify a bound on the number      * of temporary files that will be created.      *      * @param file      *            some flat file      * @param cmp      *            string comparator      * @param maxtmpfiles      *            maximal number of temporary files      * @param cs      *            character set to use (can use Charset.defaultCharset())      * @param tmpdirectory      *            location of the temporary files (set to null for default location)      * @param distinct      *            Pass<code>true</code> if duplicate lines should be discarded.      * @param numHeader      *            number of lines to preclude before sorting starts      * @param usegzip use gzip compression for the temporary files      * @param typeToString      *            function to map string to custom type. User for coverting line to custom type for the      *            purpose of sorting      * @param stringToType      *          function to map custom type to string. Used for storing sorted content back to file      * @return a list of temporary flat files      */
specifier|public
specifier|static
parameter_list|<
name|T
...
block|}
block|}
comment|/**      * This will simply load the file by blocks of lines, then sort them in-memory, and write the      * result to temporary files that have to be merged later. You can specify a bound on the number      * of temporary files that will be created.      *       *      * @param fbr      *            buffered read for file to be sorted      * @param cmp      *            string comparator      * @param maxtmpfiles      *            maximal number of temporary files      * @param cs      *            character set to use (can use Charset.defaultCharset())      * @param tmpdirectory      *            location of the temporary files (set to null for default location)      * @param distinct      *            Pass<code>true</code> if duplicate lines should be discarded.      * @param numHeader      *            number of lines to preclude before sorting starts      * @param usegzip use gzip compression for the temporary files      * @param typeToString      *            function to map string to custom type. User for coverting line to custom type for the      *            purpose of sorting      * @param stringToType      *          function to map custom type to string. Used for storing sorted content back to file      * @return a list of temporary flat files      */
specifier|private
specifier|static
parameter_list|<
name|T
...
return|;
block|}
comment|/**      * Sort a list and save it to a temporary file      *       * @return the file containing the sorted data      * @param tmplist      *            data to be sorted      * @param cmp  *            string comparator      * @param cs *            charset to use for output (can use Charset.defaultCharset())      * @param tmpdirectory *            location of the temporary files (set to null for default location)      * @param distinct      * @param typeToString      *        function to map string to custom type. User for coverting line to custom type for the      *        purpose of sorting      */
specifier|public
specifier|static
parameter_list|<
name|T
...
block|}
block|}
comment|/**      * This merges a bunch of temporary flat files and deletes them on success or error.      *       * @param files      *            The {@link List} of sorted {@link File}s to be merged.      * @param fbw      *            Buffered writer used to store the sorted content      * @param cmp      *            The {@link Comparator} to use to compare {@link String}s.      * @param cs      *            The {@link Charset} to be used for the byte to character conversion.      * @param distinct      *            Pass<code>true</code> if duplicate lines should be discarded. (elchetz@gmail.com)      * @param usegzip      *            assumes we used gzip compression for temporary files      * @param typeToString      *            function to map string to custom type. User for coverting line to custom type for the      *            purpose of sorting      * @param stringToType      *          function to map custom type to string. Used for storing sorted content back to file      * @since v0.1.4      */
specifier|public
specifier|static
parameter_list|<
name|T
